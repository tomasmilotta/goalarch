var Ed=Object.defineProperty;var Od=(t,e,n)=>e in t?Ed(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var Vr=(t,e,n)=>(Od(t,typeof e!="symbol"?e+"":e,n),n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerpolicy&&(o.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?o.credentials="include":s.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=n(s);fetch(s.href,o)}})();function Yo(t,e){const n=Object.create(null),i=t.split(",");for(let s=0;s<i.length;s++)n[i[s]]=!0;return e?s=>!!n[s.toLowerCase()]:s=>!!n[s]}function _s(t){if(se(t)){const e={};for(let n=0;n<t.length;n++){const i=t[n],s=Le(i)?Pd(i):_s(i);if(s)for(const o in s)e[o]=s[o]}return e}else{if(Le(t))return t;if(Se(t))return t}}const Ad=/;(?![^(]*\))/g,Rd=/:([^]+)/,Dd=/\/\*.*?\*\//gs;function Pd(t){const e={};return t.replace(Dd,"").split(Ad).forEach(n=>{if(n){const i=n.split(Rd);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function Wi(t){let e="";if(Le(t))e=t;else if(se(t))for(let n=0;n<t.length;n++){const i=Wi(t[n]);i&&(e+=i+" ")}else if(Se(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const Md="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Bd=Yo(Md);function bl(t){return!!t||t===""}const Dt=t=>Le(t)?t:t==null?"":se(t)||Se(t)&&(t.toString===wl||!ae(t.toString))?JSON.stringify(t,vl,2):String(t),vl=(t,e)=>e&&e.__v_isRef?vl(t,e.value):Vn(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[i,s])=>(n[`${i} =>`]=s,n),{})}:yl(e)?{[`Set(${e.size})`]:[...e.values()]}:Se(e)&&!se(e)&&!$l(e)?String(e):e,Ie={},Nn=[],Ct=()=>{},Fd=()=>!1,Ld=/^on[^a-z]/,Es=t=>Ld.test(t),Qo=t=>t.startsWith("onUpdate:"),je=Object.assign,Jo=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},Hd=Object.prototype.hasOwnProperty,ge=(t,e)=>Hd.call(t,e),se=Array.isArray,Vn=t=>Os(t)==="[object Map]",yl=t=>Os(t)==="[object Set]",ae=t=>typeof t=="function",Le=t=>typeof t=="string",Xo=t=>typeof t=="symbol",Se=t=>t!==null&&typeof t=="object",xl=t=>Se(t)&&ae(t.then)&&ae(t.catch),wl=Object.prototype.toString,Os=t=>wl.call(t),Nd=t=>Os(t).slice(8,-1),$l=t=>Os(t)==="[object Object]",Zo=t=>Le(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,cs=Yo(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),As=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},Vd=/-(\w)/g,Mt=As(t=>t.replace(Vd,(e,n)=>n?n.toUpperCase():"")),jd=/\B([A-Z])/g,ei=As(t=>t.replace(jd,"-$1").toLowerCase()),Rs=As(t=>t.charAt(0).toUpperCase()+t.slice(1)),Zs=As(t=>t?`on${Rs(t)}`:""),Ai=(t,e)=>!Object.is(t,e),Ks=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},ms=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},Ko=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let jr;const zd=()=>jr||(jr=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let lt;class Cl{constructor(e=!1){this.detached=e,this.active=!0,this.effects=[],this.cleanups=[],this.parent=lt,!e&&lt&&(this.index=(lt.scopes||(lt.scopes=[])).push(this)-1)}run(e){if(this.active){const n=lt;try{return lt=this,e()}finally{lt=n}}}on(){lt=this}off(){lt=this.parent}stop(e){if(this.active){let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.scopes)for(n=0,i=this.scopes.length;n<i;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0,this.active=!1}}}function kl(t){return new Cl(t)}function Ud(t,e=lt){e&&e.active&&e.effects.push(t)}function qd(){return lt}function Wd(t){lt&&lt.cleanups.push(t)}const er=t=>{const e=new Set(t);return e.w=0,e.n=0,e},Tl=t=>(t.w&an)>0,Sl=t=>(t.n&an)>0,Gd=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=an},Yd=t=>{const{deps:e}=t;if(e.length){let n=0;for(let i=0;i<e.length;i++){const s=e[i];Tl(s)&&!Sl(s)?s.delete(t):e[n++]=s,s.w&=~an,s.n&=~an}e.length=n}},So=new WeakMap;let xi=0,an=1;const Io=30;let yt;const Tn=Symbol(""),_o=Symbol("");class tr{constructor(e,n=null,i){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,Ud(this,i)}run(){if(!this.active)return this.fn();let e=yt,n=nn;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=yt,yt=this,nn=!0,an=1<<++xi,xi<=Io?Gd(this):zr(this),this.fn()}finally{xi<=Io&&Yd(this),an=1<<--xi,yt=this.parent,nn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){yt===this?this.deferStop=!0:this.active&&(zr(this),this.onStop&&this.onStop(),this.active=!1)}}function zr(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let nn=!0;const Il=[];function ti(){Il.push(nn),nn=!1}function ni(){const t=Il.pop();nn=t===void 0?!0:t}function ct(t,e,n){if(nn&&yt){let i=So.get(t);i||So.set(t,i=new Map);let s=i.get(n);s||i.set(n,s=er()),_l(s)}}function _l(t,e){let n=!1;xi<=Io?Sl(t)||(t.n|=an,n=!Tl(t)):n=!t.has(yt),n&&(t.add(yt),yt.deps.push(t))}function jt(t,e,n,i,s,o){const r=So.get(t);if(!r)return;let a=[];if(e==="clear")a=[...r.values()];else if(n==="length"&&se(t)){const l=Ko(i);r.forEach((c,d)=>{(d==="length"||d>=l)&&a.push(c)})}else switch(n!==void 0&&a.push(r.get(n)),e){case"add":se(t)?Zo(n)&&a.push(r.get("length")):(a.push(r.get(Tn)),Vn(t)&&a.push(r.get(_o)));break;case"delete":se(t)||(a.push(r.get(Tn)),Vn(t)&&a.push(r.get(_o)));break;case"set":Vn(t)&&a.push(r.get(Tn));break}if(a.length===1)a[0]&&Eo(a[0]);else{const l=[];for(const c of a)c&&l.push(...c);Eo(er(l))}}function Eo(t,e){const n=se(t)?t:[...t];for(const i of n)i.computed&&Ur(i);for(const i of n)i.computed||Ur(i)}function Ur(t,e){(t!==yt||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const Qd=Yo("__proto__,__v_isRef,__isVue"),El=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Xo)),Jd=nr(),Xd=nr(!1,!0),Zd=nr(!0),qr=Kd();function Kd(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const i=me(this);for(let o=0,r=this.length;o<r;o++)ct(i,"get",o+"");const s=i[e](...n);return s===-1||s===!1?i[e](...n.map(me)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){ti();const i=me(this)[e].apply(this,n);return ni(),i}}),t}function nr(t=!1,e=!1){return function(i,s,o){if(s==="__v_isReactive")return!t;if(s==="__v_isReadonly")return t;if(s==="__v_isShallow")return e;if(s==="__v_raw"&&o===(t?e?gu:Pl:e?Dl:Rl).get(i))return i;const r=se(i);if(!t&&r&&ge(qr,s))return Reflect.get(qr,s,o);const a=Reflect.get(i,s,o);return(Xo(s)?El.has(s):Qd(s))||(t||ct(i,"get",s),e)?a:Be(a)?r&&Zo(s)?a:a.value:Se(a)?t?Ml(a):ii(a):a}}const eu=Ol(),tu=Ol(!0);function Ol(t=!1){return function(n,i,s,o){let r=n[i];if(Wn(r)&&Be(r)&&!Be(s))return!1;if(!t&&(!bs(s)&&!Wn(s)&&(r=me(r),s=me(s)),!se(n)&&Be(r)&&!Be(s)))return r.value=s,!0;const a=se(n)&&Zo(i)?Number(i)<n.length:ge(n,i),l=Reflect.set(n,i,s,o);return n===me(o)&&(a?Ai(s,r)&&jt(n,"set",i,s):jt(n,"add",i,s)),l}}function nu(t,e){const n=ge(t,e);t[e];const i=Reflect.deleteProperty(t,e);return i&&n&&jt(t,"delete",e,void 0),i}function iu(t,e){const n=Reflect.has(t,e);return(!Xo(e)||!El.has(e))&&ct(t,"has",e),n}function su(t){return ct(t,"iterate",se(t)?"length":Tn),Reflect.ownKeys(t)}const Al={get:Jd,set:eu,deleteProperty:nu,has:iu,ownKeys:su},ou={get:Zd,set(t,e){return!0},deleteProperty(t,e){return!0}},ru=je({},Al,{get:Xd,set:tu}),ir=t=>t,Ds=t=>Reflect.getPrototypeOf(t);function Xi(t,e,n=!1,i=!1){t=t.__v_raw;const s=me(t),o=me(e);n||(e!==o&&ct(s,"get",e),ct(s,"get",o));const{has:r}=Ds(s),a=i?ir:n?rr:Ri;if(r.call(s,e))return a(t.get(e));if(r.call(s,o))return a(t.get(o));t!==s&&t.get(e)}function Zi(t,e=!1){const n=this.__v_raw,i=me(n),s=me(t);return e||(t!==s&&ct(i,"has",t),ct(i,"has",s)),t===s?n.has(t):n.has(t)||n.has(s)}function Ki(t,e=!1){return t=t.__v_raw,!e&&ct(me(t),"iterate",Tn),Reflect.get(t,"size",t)}function Wr(t){t=me(t);const e=me(this);return Ds(e).has.call(e,t)||(e.add(t),jt(e,"add",t,t)),this}function Gr(t,e){e=me(e);const n=me(this),{has:i,get:s}=Ds(n);let o=i.call(n,t);o||(t=me(t),o=i.call(n,t));const r=s.call(n,t);return n.set(t,e),o?Ai(e,r)&&jt(n,"set",t,e):jt(n,"add",t,e),this}function Yr(t){const e=me(this),{has:n,get:i}=Ds(e);let s=n.call(e,t);s||(t=me(t),s=n.call(e,t)),i&&i.call(e,t);const o=e.delete(t);return s&&jt(e,"delete",t,void 0),o}function Qr(){const t=me(this),e=t.size!==0,n=t.clear();return e&&jt(t,"clear",void 0,void 0),n}function es(t,e){return function(i,s){const o=this,r=o.__v_raw,a=me(r),l=e?ir:t?rr:Ri;return!t&&ct(a,"iterate",Tn),r.forEach((c,d)=>i.call(s,l(c),l(d),o))}}function ts(t,e,n){return function(...i){const s=this.__v_raw,o=me(s),r=Vn(o),a=t==="entries"||t===Symbol.iterator&&r,l=t==="keys"&&r,c=s[t](...i),d=n?ir:e?rr:Ri;return!e&&ct(o,"iterate",l?_o:Tn),{next(){const{value:u,done:f}=c.next();return f?{value:u,done:f}:{value:a?[d(u[0]),d(u[1])]:d(u),done:f}},[Symbol.iterator](){return this}}}}function Gt(t){return function(...e){return t==="delete"?!1:this}}function au(){const t={get(o){return Xi(this,o)},get size(){return Ki(this)},has:Zi,add:Wr,set:Gr,delete:Yr,clear:Qr,forEach:es(!1,!1)},e={get(o){return Xi(this,o,!1,!0)},get size(){return Ki(this)},has:Zi,add:Wr,set:Gr,delete:Yr,clear:Qr,forEach:es(!1,!0)},n={get(o){return Xi(this,o,!0)},get size(){return Ki(this,!0)},has(o){return Zi.call(this,o,!0)},add:Gt("add"),set:Gt("set"),delete:Gt("delete"),clear:Gt("clear"),forEach:es(!0,!1)},i={get(o){return Xi(this,o,!0,!0)},get size(){return Ki(this,!0)},has(o){return Zi.call(this,o,!0)},add:Gt("add"),set:Gt("set"),delete:Gt("delete"),clear:Gt("clear"),forEach:es(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(o=>{t[o]=ts(o,!1,!1),n[o]=ts(o,!0,!1),e[o]=ts(o,!1,!0),i[o]=ts(o,!0,!0)}),[t,n,e,i]}const[lu,cu,du,uu]=au();function sr(t,e){const n=e?t?uu:du:t?cu:lu;return(i,s,o)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?i:Reflect.get(ge(n,s)&&s in i?n:i,s,o)}const hu={get:sr(!1,!1)},fu={get:sr(!1,!0)},pu={get:sr(!0,!1)},Rl=new WeakMap,Dl=new WeakMap,Pl=new WeakMap,gu=new WeakMap;function mu(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function bu(t){return t.__v_skip||!Object.isExtensible(t)?0:mu(Nd(t))}function ii(t){return Wn(t)?t:or(t,!1,Al,hu,Rl)}function vu(t){return or(t,!1,ru,fu,Dl)}function Ml(t){return or(t,!0,ou,pu,Pl)}function or(t,e,n,i,s){if(!Se(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const o=s.get(t);if(o)return o;const r=bu(t);if(r===0)return t;const a=new Proxy(t,r===2?i:n);return s.set(t,a),a}function sn(t){return Wn(t)?sn(t.__v_raw):!!(t&&t.__v_isReactive)}function Wn(t){return!!(t&&t.__v_isReadonly)}function bs(t){return!!(t&&t.__v_isShallow)}function Bl(t){return sn(t)||Wn(t)}function me(t){const e=t&&t.__v_raw;return e?me(e):t}function Gn(t){return ms(t,"__v_skip",!0),t}const Ri=t=>Se(t)?ii(t):t,rr=t=>Se(t)?Ml(t):t;function Fl(t){nn&&yt&&(t=me(t),_l(t.dep||(t.dep=er())))}function Ll(t,e){t=me(t),t.dep&&Eo(t.dep)}function Be(t){return!!(t&&t.__v_isRef===!0)}function Di(t){return Hl(t,!1)}function yu(t){return Hl(t,!0)}function Hl(t,e){return Be(t)?t:new xu(t,e)}class xu{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:me(e),this._value=n?e:Ri(e)}get value(){return Fl(this),this._value}set value(e){const n=this.__v_isShallow||bs(e)||Wn(e);e=n?e:me(e),Ai(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:Ri(e),Ll(this))}}function $e(t){return Be(t)?t.value:t}const wu={get:(t,e,n)=>$e(Reflect.get(t,e,n)),set:(t,e,n,i)=>{const s=t[e];return Be(s)&&!Be(n)?(s.value=n,!0):Reflect.set(t,e,n,i)}};function Nl(t){return sn(t)?t:new Proxy(t,wu)}function $u(t){const e=se(t)?new Array(t.length):{};for(const n in t)e[n]=ku(t,n);return e}class Cu{constructor(e,n,i){this._object=e,this._key=n,this._defaultValue=i,this.__v_isRef=!0}get value(){const e=this._object[this._key];return e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}}function ku(t,e,n){const i=t[e];return Be(i)?i:new Cu(t,e,n)}var Vl;class Tu{constructor(e,n,i,s){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this[Vl]=!1,this._dirty=!0,this.effect=new tr(e,()=>{this._dirty||(this._dirty=!0,Ll(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=i}get value(){const e=me(this);return Fl(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}Vl="__v_isReadonly";function Su(t,e,n=!1){let i,s;const o=ae(t);return o?(i=t,s=Ct):(i=t.get,s=t.set),new Tu(i,s,o||!s,n)}function on(t,e,n,i){let s;try{s=i?t(...i):t()}catch(o){Ps(o,e,n)}return s}function gt(t,e,n,i){if(ae(t)){const o=on(t,e,n,i);return o&&xl(o)&&o.catch(r=>{Ps(r,e,n)}),o}const s=[];for(let o=0;o<t.length;o++)s.push(gt(t[o],e,n,i));return s}function Ps(t,e,n,i=!0){const s=e?e.vnode:null;if(e){let o=e.parent;const r=e.proxy,a=n;for(;o;){const c=o.ec;if(c){for(let d=0;d<c.length;d++)if(c[d](t,r,a)===!1)return}o=o.parent}const l=e.appContext.config.errorHandler;if(l){on(l,null,10,[t,r,a]);return}}Iu(t,n,s,i)}function Iu(t,e,n,i=!0){console.error(t)}let Pi=!1,Oo=!1;const qe=[];let Rt=0;const jn=[];let Lt=null,xn=0;const jl=Promise.resolve();let ar=null;function lr(t){const e=ar||jl;return t?e.then(this?t.bind(this):t):e}function _u(t){let e=Rt+1,n=qe.length;for(;e<n;){const i=e+n>>>1;Mi(qe[i])<t?e=i+1:n=i}return e}function cr(t){(!qe.length||!qe.includes(t,Pi&&t.allowRecurse?Rt+1:Rt))&&(t.id==null?qe.push(t):qe.splice(_u(t.id),0,t),zl())}function zl(){!Pi&&!Oo&&(Oo=!0,ar=jl.then(ql))}function Eu(t){const e=qe.indexOf(t);e>Rt&&qe.splice(e,1)}function Ou(t){se(t)?jn.push(...t):(!Lt||!Lt.includes(t,t.allowRecurse?xn+1:xn))&&jn.push(t),zl()}function Jr(t,e=Pi?Rt+1:0){for(;e<qe.length;e++){const n=qe[e];n&&n.pre&&(qe.splice(e,1),e--,n())}}function Ul(t){if(jn.length){const e=[...new Set(jn)];if(jn.length=0,Lt){Lt.push(...e);return}for(Lt=e,Lt.sort((n,i)=>Mi(n)-Mi(i)),xn=0;xn<Lt.length;xn++)Lt[xn]();Lt=null,xn=0}}const Mi=t=>t.id==null?1/0:t.id,Au=(t,e)=>{const n=Mi(t)-Mi(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function ql(t){Oo=!1,Pi=!0,qe.sort(Au);const e=Ct;try{for(Rt=0;Rt<qe.length;Rt++){const n=qe[Rt];n&&n.active!==!1&&on(n,null,14)}}finally{Rt=0,qe.length=0,Ul(),Pi=!1,ar=null,(qe.length||jn.length)&&ql()}}function Ru(t,e,...n){if(t.isUnmounted)return;const i=t.vnode.props||Ie;let s=n;const o=e.startsWith("update:"),r=o&&e.slice(7);if(r&&r in i){const d=`${r==="modelValue"?"model":r}Modifiers`,{number:u,trim:f}=i[d]||Ie;f&&(s=n.map(m=>Le(m)?m.trim():m)),u&&(s=n.map(Ko))}let a,l=i[a=Zs(e)]||i[a=Zs(Mt(e))];!l&&o&&(l=i[a=Zs(ei(e))]),l&&gt(l,t,6,s);const c=i[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,gt(c,t,6,s)}}function Wl(t,e,n=!1){const i=e.emitsCache,s=i.get(t);if(s!==void 0)return s;const o=t.emits;let r={},a=!1;if(!ae(t)){const l=c=>{const d=Wl(c,e,!0);d&&(a=!0,je(r,d))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!o&&!a?(Se(t)&&i.set(t,null),null):(se(o)?o.forEach(l=>r[l]=null):je(r,o),Se(t)&&i.set(t,r),r)}function Ms(t,e){return!t||!Es(e)?!1:(e=e.slice(2).replace(/Once$/,""),ge(t,e[0].toLowerCase()+e.slice(1))||ge(t,ei(e))||ge(t,e))}let pt=null,Bs=null;function vs(t){const e=pt;return pt=t,Bs=t&&t.type.__scopeId||null,e}function Du(t){Bs=t}function Pu(){Bs=null}function Gl(t,e=pt,n){if(!e||t._n)return t;const i=(...s)=>{i._d&&ra(-1);const o=vs(e);let r;try{r=t(...s)}finally{vs(o),i._d&&ra(1)}return r};return i._n=!0,i._c=!0,i._d=!0,i}function eo(t){const{type:e,vnode:n,proxy:i,withProxy:s,props:o,propsOptions:[r],slots:a,attrs:l,emit:c,render:d,renderCache:u,data:f,setupState:m,ctx:v,inheritAttrs:b}=t;let A,_;const F=vs(t);try{if(n.shapeFlag&4){const J=s||i;A=At(d.call(J,J,u,o,m,f,v)),_=l}else{const J=e;A=At(J.length>1?J(o,{attrs:l,slots:a,emit:c}):J(o,null)),_=e.props?l:Mu(l)}}catch(J){Ci.length=0,Ps(J,t,1),A=ke(kt)}let D=A;if(_&&b!==!1){const J=Object.keys(_),{shapeFlag:Y}=D;J.length&&Y&7&&(r&&J.some(Qo)&&(_=Bu(_,r)),D=ln(D,_))}return n.dirs&&(D=ln(D),D.dirs=D.dirs?D.dirs.concat(n.dirs):n.dirs),n.transition&&(D.transition=n.transition),A=D,vs(F),A}const Mu=t=>{let e;for(const n in t)(n==="class"||n==="style"||Es(n))&&((e||(e={}))[n]=t[n]);return e},Bu=(t,e)=>{const n={};for(const i in t)(!Qo(i)||!(i.slice(9)in e))&&(n[i]=t[i]);return n};function Fu(t,e,n){const{props:i,children:s,component:o}=t,{props:r,children:a,patchFlag:l}=e,c=o.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return i?Xr(i,r,c):!!r;if(l&8){const d=e.dynamicProps;for(let u=0;u<d.length;u++){const f=d[u];if(r[f]!==i[f]&&!Ms(c,f))return!0}}}else return(s||a)&&(!a||!a.$stable)?!0:i===r?!1:i?r?Xr(i,r,c):!0:!!r;return!1}function Xr(t,e,n){const i=Object.keys(e);if(i.length!==Object.keys(t).length)return!0;for(let s=0;s<i.length;s++){const o=i[s];if(e[o]!==t[o]&&!Ms(n,o))return!0}return!1}function Lu({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const Hu=t=>t.__isSuspense;function Nu(t,e){e&&e.pendingBranch?se(t)?e.effects.push(...t):e.effects.push(t):Ou(t)}function ds(t,e){if(Ve){let n=Ve.provides;const i=Ve.parent&&Ve.parent.provides;i===n&&(n=Ve.provides=Object.create(i)),n[t]=e}}function Pt(t,e,n=!1){const i=Ve||pt;if(i){const s=i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides;if(s&&t in s)return s[t];if(arguments.length>1)return n&&ae(e)?e.call(i.proxy):e}}const ns={};function wi(t,e,n){return Yl(t,e,n)}function Yl(t,e,{immediate:n,deep:i,flush:s,onTrack:o,onTrigger:r}=Ie){const a=Ve;let l,c=!1,d=!1;if(Be(t)?(l=()=>t.value,c=bs(t)):sn(t)?(l=()=>t,i=!0):se(t)?(d=!0,c=t.some(D=>sn(D)||bs(D)),l=()=>t.map(D=>{if(Be(D))return D.value;if(sn(D))return Fn(D);if(ae(D))return on(D,a,2)})):ae(t)?e?l=()=>on(t,a,2):l=()=>{if(!(a&&a.isUnmounted))return u&&u(),gt(t,a,3,[f])}:l=Ct,e&&i){const D=l;l=()=>Fn(D())}let u,f=D=>{u=_.onStop=()=>{on(D,a,4)}},m;if(Hi)if(f=Ct,e?n&&gt(e,a,3,[l(),d?[]:void 0,f]):l(),s==="sync"){const D=Ph();m=D.__watcherHandles||(D.__watcherHandles=[])}else return Ct;let v=d?new Array(t.length).fill(ns):ns;const b=()=>{if(!!_.active)if(e){const D=_.run();(i||c||(d?D.some((J,Y)=>Ai(J,v[Y])):Ai(D,v)))&&(u&&u(),gt(e,a,3,[D,v===ns?void 0:d&&v[0]===ns?[]:v,f]),v=D)}else _.run()};b.allowRecurse=!!e;let A;s==="sync"?A=b:s==="post"?A=()=>nt(b,a&&a.suspense):(b.pre=!0,a&&(b.id=a.uid),A=()=>cr(b));const _=new tr(l,A);e?n?b():v=_.run():s==="post"?nt(_.run.bind(_),a&&a.suspense):_.run();const F=()=>{_.stop(),a&&a.scope&&Jo(a.scope.effects,_)};return m&&m.push(F),F}function Vu(t,e,n){const i=this.proxy,s=Le(t)?t.includes(".")?Ql(i,t):()=>i[t]:t.bind(i,i);let o;ae(e)?o=e:(o=e.handler,n=e);const r=Ve;Yn(this);const a=Yl(s,o.bind(i),n);return r?Yn(r):Sn(),a}function Ql(t,e){const n=e.split(".");return()=>{let i=t;for(let s=0;s<n.length&&i;s++)i=i[n[s]];return i}}function Fn(t,e){if(!Se(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),Be(t))Fn(t.value,e);else if(se(t))for(let n=0;n<t.length;n++)Fn(t[n],e);else if(yl(t)||Vn(t))t.forEach(n=>{Fn(n,e)});else if($l(t))for(const n in t)Fn(t[n],e);return t}function Jl(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return ur(()=>{t.isMounted=!0}),ec(()=>{t.isUnmounting=!0}),t}const ut=[Function,Array],ju={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:ut,onEnter:ut,onAfterEnter:ut,onEnterCancelled:ut,onBeforeLeave:ut,onLeave:ut,onAfterLeave:ut,onLeaveCancelled:ut,onBeforeAppear:ut,onAppear:ut,onAfterAppear:ut,onAppearCancelled:ut},setup(t,{slots:e}){const n=gr(),i=Jl();let s;return()=>{const o=e.default&&dr(e.default(),!0);if(!o||!o.length)return;let r=o[0];if(o.length>1){for(const b of o)if(b.type!==kt){r=b;break}}const a=me(t),{mode:l}=a;if(i.isLeaving)return to(r);const c=Zr(r);if(!c)return to(r);const d=Bi(c,a,i,n);Fi(c,d);const u=n.subTree,f=u&&Zr(u);let m=!1;const{getTransitionKey:v}=c.type;if(v){const b=v();s===void 0?s=b:b!==s&&(s=b,m=!0)}if(f&&f.type!==kt&&(!wn(c,f)||m)){const b=Bi(f,a,i,n);if(Fi(f,b),l==="out-in")return i.isLeaving=!0,b.afterLeave=()=>{i.isLeaving=!1,n.update.active!==!1&&n.update()},to(r);l==="in-out"&&c.type!==kt&&(b.delayLeave=(A,_,F)=>{const D=Xl(i,f);D[String(f.key)]=f,A._leaveCb=()=>{_(),A._leaveCb=void 0,delete d.delayedLeave},d.delayedLeave=F})}return r}}},zu=ju;function Xl(t,e){const{leavingVNodes:n}=t;let i=n.get(e.type);return i||(i=Object.create(null),n.set(e.type,i)),i}function Bi(t,e,n,i){const{appear:s,mode:o,persisted:r=!1,onBeforeEnter:a,onEnter:l,onAfterEnter:c,onEnterCancelled:d,onBeforeLeave:u,onLeave:f,onAfterLeave:m,onLeaveCancelled:v,onBeforeAppear:b,onAppear:A,onAfterAppear:_,onAppearCancelled:F}=e,D=String(t.key),J=Xl(n,t),Y=(M,Q)=>{M&&gt(M,i,9,Q)},te=(M,Q)=>{const q=Q[1];Y(M,Q),se(M)?M.every(xe=>xe.length<=1)&&q():M.length<=1&&q()},ee={mode:o,persisted:r,beforeEnter(M){let Q=a;if(!n.isMounted)if(s)Q=b||a;else return;M._leaveCb&&M._leaveCb(!0);const q=J[D];q&&wn(t,q)&&q.el._leaveCb&&q.el._leaveCb(),Y(Q,[M])},enter(M){let Q=l,q=c,xe=d;if(!n.isMounted)if(s)Q=A||l,q=_||c,xe=F||d;else return;let z=!1;const L=M._enterCb=I=>{z||(z=!0,I?Y(xe,[M]):Y(q,[M]),ee.delayedLeave&&ee.delayedLeave(),M._enterCb=void 0)};Q?te(Q,[M,L]):L()},leave(M,Q){const q=String(t.key);if(M._enterCb&&M._enterCb(!0),n.isUnmounting)return Q();Y(u,[M]);let xe=!1;const z=M._leaveCb=L=>{xe||(xe=!0,Q(),L?Y(v,[M]):Y(m,[M]),M._leaveCb=void 0,J[q]===t&&delete J[q])};J[q]=t,f?te(f,[M,z]):z()},clone(M){return Bi(M,e,n,i)}};return ee}function to(t){if(Fs(t))return t=ln(t),t.children=null,t}function Zr(t){return Fs(t)?t.children?t.children[0]:void 0:t}function Fi(t,e){t.shapeFlag&6&&t.component?Fi(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function dr(t,e=!1,n){let i=[],s=0;for(let o=0;o<t.length;o++){let r=t[o];const a=n==null?r.key:String(n)+String(r.key!=null?r.key:o);r.type===ht?(r.patchFlag&128&&s++,i=i.concat(dr(r.children,e,a))):(e||r.type!==kt)&&i.push(a!=null?ln(r,{key:a}):r)}if(s>1)for(let o=0;o<i.length;o++)i[o].patchFlag=-2;return i}function un(t){return ae(t)?{setup:t,name:t.name}:t}const us=t=>!!t.type.__asyncLoader,Fs=t=>t.type.__isKeepAlive;function Uu(t,e){Zl(t,"a",e)}function qu(t,e){Zl(t,"da",e)}function Zl(t,e,n=Ve){const i=t.__wdc||(t.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return t()});if(Ls(e,i,n),n){let s=n.parent;for(;s&&s.parent;)Fs(s.parent.vnode)&&Wu(i,e,n,s),s=s.parent}}function Wu(t,e,n,i){const s=Ls(e,t,i,!0);tc(()=>{Jo(i[e],s)},n)}function Ls(t,e,n=Ve,i=!1){if(n){const s=n[t]||(n[t]=[]),o=e.__weh||(e.__weh=(...r)=>{if(n.isUnmounted)return;ti(),Yn(n);const a=gt(e,n,t,r);return Sn(),ni(),a});return i?s.unshift(o):s.push(o),o}}const Ut=t=>(e,n=Ve)=>(!Hi||t==="sp")&&Ls(t,(...i)=>e(...i),n),Gu=Ut("bm"),ur=Ut("m"),Yu=Ut("bu"),Kl=Ut("u"),ec=Ut("bum"),tc=Ut("um"),Qu=Ut("sp"),Ju=Ut("rtg"),Xu=Ut("rtc");function Zu(t,e=Ve){Ls("ec",t,e)}function gn(t,e,n,i){const s=t.dirs,o=e&&e.dirs;for(let r=0;r<s.length;r++){const a=s[r];o&&(a.oldValue=o[r].value);let l=a.dir[i];l&&(ti(),gt(l,n,8,[t.el,a,t,e]),ni())}}const nc="components";function Ku(t,e){return th(nc,t,!0,e)||t}const eh=Symbol();function th(t,e,n=!0,i=!1){const s=pt||Ve;if(s){const o=s.type;if(t===nc){const a=Ah(o,!1);if(a&&(a===e||a===Mt(e)||a===Rs(Mt(e))))return o}const r=Kr(s[t]||o[t],e)||Kr(s.appContext[t],e);return!r&&i?o:r}}function Kr(t,e){return t&&(t[e]||t[Mt(e)]||t[Rs(Mt(e))])}function nh(t,e,n,i){let s;const o=n&&n[i];if(se(t)||Le(t)){s=new Array(t.length);for(let r=0,a=t.length;r<a;r++)s[r]=e(t[r],r,void 0,o&&o[r])}else if(typeof t=="number"){s=new Array(t);for(let r=0;r<t;r++)s[r]=e(r+1,r,void 0,o&&o[r])}else if(Se(t))if(t[Symbol.iterator])s=Array.from(t,(r,a)=>e(r,a,void 0,o&&o[a]));else{const r=Object.keys(t);s=new Array(r.length);for(let a=0,l=r.length;a<l;a++){const c=r[a];s[a]=e(t[c],c,a,o&&o[a])}}else s=[];return n&&(n[i]=s),s}const Ao=t=>t?pc(t)?mr(t)||t.proxy:Ao(t.parent):null,$i=je(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Ao(t.parent),$root:t=>Ao(t.root),$emit:t=>t.emit,$options:t=>hr(t),$forceUpdate:t=>t.f||(t.f=()=>cr(t.update)),$nextTick:t=>t.n||(t.n=lr.bind(t.proxy)),$watch:t=>Vu.bind(t)}),no=(t,e)=>t!==Ie&&!t.__isScriptSetup&&ge(t,e),ih={get({_:t},e){const{ctx:n,setupState:i,data:s,props:o,accessCache:r,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const m=r[e];if(m!==void 0)switch(m){case 1:return i[e];case 2:return s[e];case 4:return n[e];case 3:return o[e]}else{if(no(i,e))return r[e]=1,i[e];if(s!==Ie&&ge(s,e))return r[e]=2,s[e];if((c=t.propsOptions[0])&&ge(c,e))return r[e]=3,o[e];if(n!==Ie&&ge(n,e))return r[e]=4,n[e];Ro&&(r[e]=0)}}const d=$i[e];let u,f;if(d)return e==="$attrs"&&ct(t,"get",e),d(t);if((u=a.__cssModules)&&(u=u[e]))return u;if(n!==Ie&&ge(n,e))return r[e]=4,n[e];if(f=l.config.globalProperties,ge(f,e))return f[e]},set({_:t},e,n){const{data:i,setupState:s,ctx:o}=t;return no(s,e)?(s[e]=n,!0):i!==Ie&&ge(i,e)?(i[e]=n,!0):ge(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(o[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:i,appContext:s,propsOptions:o}},r){let a;return!!n[r]||t!==Ie&&ge(t,r)||no(e,r)||(a=o[0])&&ge(a,r)||ge(i,r)||ge($i,r)||ge(s.config.globalProperties,r)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:ge(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};let Ro=!0;function sh(t){const e=hr(t),n=t.proxy,i=t.ctx;Ro=!1,e.beforeCreate&&ea(e.beforeCreate,t,"bc");const{data:s,computed:o,methods:r,watch:a,provide:l,inject:c,created:d,beforeMount:u,mounted:f,beforeUpdate:m,updated:v,activated:b,deactivated:A,beforeDestroy:_,beforeUnmount:F,destroyed:D,unmounted:J,render:Y,renderTracked:te,renderTriggered:ee,errorCaptured:M,serverPrefetch:Q,expose:q,inheritAttrs:xe,components:z,directives:L,filters:I}=e;if(c&&oh(c,i,null,t.appContext.config.unwrapInjectedRef),r)for(const S in r){const N=r[S];ae(N)&&(i[S]=N.bind(n))}if(s){const S=s.call(n,n);Se(S)&&(t.data=ii(S))}if(Ro=!0,o)for(const S in o){const N=o[S],X=ae(N)?N.bind(n,n):ae(N.get)?N.get.bind(n,n):Ct,ce=!ae(N)&&ae(N.set)?N.set.bind(n):Ct,be=Me({get:X,set:ce});Object.defineProperty(i,S,{enumerable:!0,configurable:!0,get:()=>be.value,set:le=>be.value=le})}if(a)for(const S in a)ic(a[S],i,n,S);if(l){const S=ae(l)?l.call(n):l;Reflect.ownKeys(S).forEach(N=>{ds(N,S[N])})}d&&ea(d,t,"c");function V(S,N){se(N)?N.forEach(X=>S(X.bind(n))):N&&S(N.bind(n))}if(V(Gu,u),V(ur,f),V(Yu,m),V(Kl,v),V(Uu,b),V(qu,A),V(Zu,M),V(Xu,te),V(Ju,ee),V(ec,F),V(tc,J),V(Qu,Q),se(q))if(q.length){const S=t.exposed||(t.exposed={});q.forEach(N=>{Object.defineProperty(S,N,{get:()=>n[N],set:X=>n[N]=X})})}else t.exposed||(t.exposed={});Y&&t.render===Ct&&(t.render=Y),xe!=null&&(t.inheritAttrs=xe),z&&(t.components=z),L&&(t.directives=L)}function oh(t,e,n=Ct,i=!1){se(t)&&(t=Do(t));for(const s in t){const o=t[s];let r;Se(o)?"default"in o?r=Pt(o.from||s,o.default,!0):r=Pt(o.from||s):r=Pt(o),Be(r)&&i?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>r.value,set:a=>r.value=a}):e[s]=r}}function ea(t,e,n){gt(se(t)?t.map(i=>i.bind(e.proxy)):t.bind(e.proxy),e,n)}function ic(t,e,n,i){const s=i.includes(".")?Ql(n,i):()=>n[i];if(Le(t)){const o=e[t];ae(o)&&wi(s,o)}else if(ae(t))wi(s,t.bind(n));else if(Se(t))if(se(t))t.forEach(o=>ic(o,e,n,i));else{const o=ae(t.handler)?t.handler.bind(n):e[t.handler];ae(o)&&wi(s,o,t)}}function hr(t){const e=t.type,{mixins:n,extends:i}=e,{mixins:s,optionsCache:o,config:{optionMergeStrategies:r}}=t.appContext,a=o.get(e);let l;return a?l=a:!s.length&&!n&&!i?l=e:(l={},s.length&&s.forEach(c=>ys(l,c,r,!0)),ys(l,e,r)),Se(e)&&o.set(e,l),l}function ys(t,e,n,i=!1){const{mixins:s,extends:o}=e;o&&ys(t,o,n,!0),s&&s.forEach(r=>ys(t,r,n,!0));for(const r in e)if(!(i&&r==="expose")){const a=rh[r]||n&&n[r];t[r]=a?a(t[r],e[r]):e[r]}return t}const rh={data:ta,props:yn,emits:yn,methods:yn,computed:yn,beforeCreate:Je,created:Je,beforeMount:Je,mounted:Je,beforeUpdate:Je,updated:Je,beforeDestroy:Je,beforeUnmount:Je,destroyed:Je,unmounted:Je,activated:Je,deactivated:Je,errorCaptured:Je,serverPrefetch:Je,components:yn,directives:yn,watch:lh,provide:ta,inject:ah};function ta(t,e){return e?t?function(){return je(ae(t)?t.call(this,this):t,ae(e)?e.call(this,this):e)}:e:t}function ah(t,e){return yn(Do(t),Do(e))}function Do(t){if(se(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function Je(t,e){return t?[...new Set([].concat(t,e))]:e}function yn(t,e){return t?je(je(Object.create(null),t),e):e}function lh(t,e){if(!t)return e;if(!e)return t;const n=je(Object.create(null),t);for(const i in e)n[i]=Je(t[i],e[i]);return n}function ch(t,e,n,i=!1){const s={},o={};ms(o,Ns,1),t.propsDefaults=Object.create(null),sc(t,e,s,o);for(const r in t.propsOptions[0])r in s||(s[r]=void 0);n?t.props=i?s:vu(s):t.type.props?t.props=s:t.props=o,t.attrs=o}function dh(t,e,n,i){const{props:s,attrs:o,vnode:{patchFlag:r}}=t,a=me(s),[l]=t.propsOptions;let c=!1;if((i||r>0)&&!(r&16)){if(r&8){const d=t.vnode.dynamicProps;for(let u=0;u<d.length;u++){let f=d[u];if(Ms(t.emitsOptions,f))continue;const m=e[f];if(l)if(ge(o,f))m!==o[f]&&(o[f]=m,c=!0);else{const v=Mt(f);s[v]=Po(l,a,v,m,t,!1)}else m!==o[f]&&(o[f]=m,c=!0)}}}else{sc(t,e,s,o)&&(c=!0);let d;for(const u in a)(!e||!ge(e,u)&&((d=ei(u))===u||!ge(e,d)))&&(l?n&&(n[u]!==void 0||n[d]!==void 0)&&(s[u]=Po(l,a,u,void 0,t,!0)):delete s[u]);if(o!==a)for(const u in o)(!e||!ge(e,u)&&!0)&&(delete o[u],c=!0)}c&&jt(t,"set","$attrs")}function sc(t,e,n,i){const[s,o]=t.propsOptions;let r=!1,a;if(e)for(let l in e){if(cs(l))continue;const c=e[l];let d;s&&ge(s,d=Mt(l))?!o||!o.includes(d)?n[d]=c:(a||(a={}))[d]=c:Ms(t.emitsOptions,l)||(!(l in i)||c!==i[l])&&(i[l]=c,r=!0)}if(o){const l=me(n),c=a||Ie;for(let d=0;d<o.length;d++){const u=o[d];n[u]=Po(s,l,u,c[u],t,!ge(c,u))}}return r}function Po(t,e,n,i,s,o){const r=t[n];if(r!=null){const a=ge(r,"default");if(a&&i===void 0){const l=r.default;if(r.type!==Function&&ae(l)){const{propsDefaults:c}=s;n in c?i=c[n]:(Yn(s),i=c[n]=l.call(null,e),Sn())}else i=l}r[0]&&(o&&!a?i=!1:r[1]&&(i===""||i===ei(n))&&(i=!0))}return i}function oc(t,e,n=!1){const i=e.propsCache,s=i.get(t);if(s)return s;const o=t.props,r={},a=[];let l=!1;if(!ae(t)){const d=u=>{l=!0;const[f,m]=oc(u,e,!0);je(r,f),m&&a.push(...m)};!n&&e.mixins.length&&e.mixins.forEach(d),t.extends&&d(t.extends),t.mixins&&t.mixins.forEach(d)}if(!o&&!l)return Se(t)&&i.set(t,Nn),Nn;if(se(o))for(let d=0;d<o.length;d++){const u=Mt(o[d]);na(u)&&(r[u]=Ie)}else if(o)for(const d in o){const u=Mt(d);if(na(u)){const f=o[d],m=r[u]=se(f)||ae(f)?{type:f}:Object.assign({},f);if(m){const v=oa(Boolean,m.type),b=oa(String,m.type);m[0]=v>-1,m[1]=b<0||v<b,(v>-1||ge(m,"default"))&&a.push(u)}}}const c=[r,a];return Se(t)&&i.set(t,c),c}function na(t){return t[0]!=="$"}function ia(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function sa(t,e){return ia(t)===ia(e)}function oa(t,e){return se(e)?e.findIndex(n=>sa(n,t)):ae(e)&&sa(e,t)?0:-1}const rc=t=>t[0]==="_"||t==="$stable",fr=t=>se(t)?t.map(At):[At(t)],uh=(t,e,n)=>{if(e._n)return e;const i=Gl((...s)=>fr(e(...s)),n);return i._c=!1,i},ac=(t,e,n)=>{const i=t._ctx;for(const s in t){if(rc(s))continue;const o=t[s];if(ae(o))e[s]=uh(s,o,i);else if(o!=null){const r=fr(o);e[s]=()=>r}}},lc=(t,e)=>{const n=fr(e);t.slots.default=()=>n},hh=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=me(e),ms(e,"_",n)):ac(e,t.slots={})}else t.slots={},e&&lc(t,e);ms(t.slots,Ns,1)},fh=(t,e,n)=>{const{vnode:i,slots:s}=t;let o=!0,r=Ie;if(i.shapeFlag&32){const a=e._;a?n&&a===1?o=!1:(je(s,e),!n&&a===1&&delete s._):(o=!e.$stable,ac(e,s)),r=e}else e&&(lc(t,e),r={default:1});if(o)for(const a in s)!rc(a)&&!(a in r)&&delete s[a]};function cc(){return{app:null,config:{isNativeTag:Fd,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let ph=0;function gh(t,e){return function(i,s=null){ae(i)||(i=Object.assign({},i)),s!=null&&!Se(s)&&(s=null);const o=cc(),r=new Set;let a=!1;const l=o.app={_uid:ph++,_component:i,_props:s,_container:null,_context:o,_instance:null,version:Mh,get config(){return o.config},set config(c){},use(c,...d){return r.has(c)||(c&&ae(c.install)?(r.add(c),c.install(l,...d)):ae(c)&&(r.add(c),c(l,...d))),l},mixin(c){return o.mixins.includes(c)||o.mixins.push(c),l},component(c,d){return d?(o.components[c]=d,l):o.components[c]},directive(c,d){return d?(o.directives[c]=d,l):o.directives[c]},mount(c,d,u){if(!a){const f=ke(i,s);return f.appContext=o,d&&e?e(f,c):t(f,c,u),a=!0,l._container=c,c.__vue_app__=l,mr(f.component)||f.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,d){return o.provides[c]=d,l}};return l}}function Mo(t,e,n,i,s=!1){if(se(t)){t.forEach((f,m)=>Mo(f,e&&(se(e)?e[m]:e),n,i,s));return}if(us(i)&&!s)return;const o=i.shapeFlag&4?mr(i.component)||i.component.proxy:i.el,r=s?null:o,{i:a,r:l}=t,c=e&&e.r,d=a.refs===Ie?a.refs={}:a.refs,u=a.setupState;if(c!=null&&c!==l&&(Le(c)?(d[c]=null,ge(u,c)&&(u[c]=null)):Be(c)&&(c.value=null)),ae(l))on(l,a,12,[r,d]);else{const f=Le(l),m=Be(l);if(f||m){const v=()=>{if(t.f){const b=f?ge(u,l)?u[l]:d[l]:l.value;s?se(b)&&Jo(b,o):se(b)?b.includes(o)||b.push(o):f?(d[l]=[o],ge(u,l)&&(u[l]=d[l])):(l.value=[o],t.k&&(d[t.k]=l.value))}else f?(d[l]=r,ge(u,l)&&(u[l]=r)):m&&(l.value=r,t.k&&(d[t.k]=r))};r?(v.id=-1,nt(v,n)):v()}}}const nt=Nu;function mh(t){return bh(t)}function bh(t,e){const n=zd();n.__VUE__=!0;const{insert:i,remove:s,patchProp:o,createElement:r,createText:a,createComment:l,setText:c,setElementText:d,parentNode:u,nextSibling:f,setScopeId:m=Ct,insertStaticContent:v}=t,b=(h,p,y,w=null,C=null,O=null,H=!1,E=null,P=!!p.dynamicChildren)=>{if(h===p)return;h&&!wn(h,p)&&(w=R(h),le(h,C,O,!0),h=null),p.patchFlag===-2&&(P=!1,p.dynamicChildren=null);const{type:k,ref:Z,shapeFlag:G}=p;switch(k){case Hs:A(h,p,y,w);break;case kt:_(h,p,y,w);break;case io:h==null&&F(p,y,w,H);break;case ht:z(h,p,y,w,C,O,H,E,P);break;default:G&1?Y(h,p,y,w,C,O,H,E,P):G&6?L(h,p,y,w,C,O,H,E,P):(G&64||G&128)&&k.process(h,p,y,w,C,O,H,E,P,ne)}Z!=null&&C&&Mo(Z,h&&h.ref,O,p||h,!p)},A=(h,p,y,w)=>{if(h==null)i(p.el=a(p.children),y,w);else{const C=p.el=h.el;p.children!==h.children&&c(C,p.children)}},_=(h,p,y,w)=>{h==null?i(p.el=l(p.children||""),y,w):p.el=h.el},F=(h,p,y,w)=>{[h.el,h.anchor]=v(h.children,p,y,w,h.el,h.anchor)},D=({el:h,anchor:p},y,w)=>{let C;for(;h&&h!==p;)C=f(h),i(h,y,w),h=C;i(p,y,w)},J=({el:h,anchor:p})=>{let y;for(;h&&h!==p;)y=f(h),s(h),h=y;s(p)},Y=(h,p,y,w,C,O,H,E,P)=>{H=H||p.type==="svg",h==null?te(p,y,w,C,O,H,E,P):Q(h,p,C,O,H,E,P)},te=(h,p,y,w,C,O,H,E)=>{let P,k;const{type:Z,props:G,shapeFlag:K,transition:oe,dirs:de}=h;if(P=h.el=r(h.type,O,G&&G.is,G),K&8?d(P,h.children):K&16&&M(h.children,P,null,w,C,O&&Z!=="foreignObject",H,E),de&&gn(h,null,w,"created"),G){for(const Ce in G)Ce!=="value"&&!cs(Ce)&&o(P,Ce,null,G[Ce],O,h.children,w,C,B);"value"in G&&o(P,"value",null,G.value),(k=G.onVnodeBeforeMount)&&Ot(k,w,h)}ee(P,h,h.scopeId,H,w),de&&gn(h,null,w,"beforeMount");const Te=(!C||C&&!C.pendingBranch)&&oe&&!oe.persisted;Te&&oe.beforeEnter(P),i(P,p,y),((k=G&&G.onVnodeMounted)||Te||de)&&nt(()=>{k&&Ot(k,w,h),Te&&oe.enter(P),de&&gn(h,null,w,"mounted")},C)},ee=(h,p,y,w,C)=>{if(y&&m(h,y),w)for(let O=0;O<w.length;O++)m(h,w[O]);if(C){let O=C.subTree;if(p===O){const H=C.vnode;ee(h,H,H.scopeId,H.slotScopeIds,C.parent)}}},M=(h,p,y,w,C,O,H,E,P=0)=>{for(let k=P;k<h.length;k++){const Z=h[k]=E?Zt(h[k]):At(h[k]);b(null,Z,p,y,w,C,O,H,E)}},Q=(h,p,y,w,C,O,H)=>{const E=p.el=h.el;let{patchFlag:P,dynamicChildren:k,dirs:Z}=p;P|=h.patchFlag&16;const G=h.props||Ie,K=p.props||Ie;let oe;y&&mn(y,!1),(oe=K.onVnodeBeforeUpdate)&&Ot(oe,y,p,h),Z&&gn(p,h,y,"beforeUpdate"),y&&mn(y,!0);const de=C&&p.type!=="foreignObject";if(k?q(h.dynamicChildren,k,E,y,w,de,O):H||N(h,p,E,null,y,w,de,O,!1),P>0){if(P&16)xe(E,p,G,K,y,w,C);else if(P&2&&G.class!==K.class&&o(E,"class",null,K.class,C),P&4&&o(E,"style",G.style,K.style,C),P&8){const Te=p.dynamicProps;for(let Ce=0;Ce<Te.length;Ce++){const Fe=Te[Ce],vt=G[Fe],Rn=K[Fe];(Rn!==vt||Fe==="value")&&o(E,Fe,vt,Rn,C,h.children,y,w,B)}}P&1&&h.children!==p.children&&d(E,p.children)}else!H&&k==null&&xe(E,p,G,K,y,w,C);((oe=K.onVnodeUpdated)||Z)&&nt(()=>{oe&&Ot(oe,y,p,h),Z&&gn(p,h,y,"updated")},w)},q=(h,p,y,w,C,O,H)=>{for(let E=0;E<p.length;E++){const P=h[E],k=p[E],Z=P.el&&(P.type===ht||!wn(P,k)||P.shapeFlag&70)?u(P.el):y;b(P,k,Z,null,w,C,O,H,!0)}},xe=(h,p,y,w,C,O,H)=>{if(y!==w){if(y!==Ie)for(const E in y)!cs(E)&&!(E in w)&&o(h,E,y[E],null,H,p.children,C,O,B);for(const E in w){if(cs(E))continue;const P=w[E],k=y[E];P!==k&&E!=="value"&&o(h,E,k,P,H,p.children,C,O,B)}"value"in w&&o(h,"value",y.value,w.value)}},z=(h,p,y,w,C,O,H,E,P)=>{const k=p.el=h?h.el:a(""),Z=p.anchor=h?h.anchor:a("");let{patchFlag:G,dynamicChildren:K,slotScopeIds:oe}=p;oe&&(E=E?E.concat(oe):oe),h==null?(i(k,y,w),i(Z,y,w),M(p.children,y,Z,C,O,H,E,P)):G>0&&G&64&&K&&h.dynamicChildren?(q(h.dynamicChildren,K,y,C,O,H,E),(p.key!=null||C&&p===C.subTree)&&dc(h,p,!0)):N(h,p,y,Z,C,O,H,E,P)},L=(h,p,y,w,C,O,H,E,P)=>{p.slotScopeIds=E,h==null?p.shapeFlag&512?C.ctx.activate(p,y,w,H,P):I(p,y,w,C,O,H,P):T(h,p,P)},I=(h,p,y,w,C,O,H)=>{const E=h.component=Sh(h,w,C);if(Fs(h)&&(E.ctx.renderer=ne),Ih(E),E.asyncDep){if(C&&C.registerDep(E,V),!h.el){const P=E.subTree=ke(kt);_(null,P,p,y)}return}V(E,h,p,y,C,O,H)},T=(h,p,y)=>{const w=p.component=h.component;if(Fu(h,p,y))if(w.asyncDep&&!w.asyncResolved){S(w,p,y);return}else w.next=p,Eu(w.update),w.update();else p.el=h.el,w.vnode=p},V=(h,p,y,w,C,O,H)=>{const E=()=>{if(h.isMounted){let{next:Z,bu:G,u:K,parent:oe,vnode:de}=h,Te=Z,Ce;mn(h,!1),Z?(Z.el=de.el,S(h,Z,H)):Z=de,G&&Ks(G),(Ce=Z.props&&Z.props.onVnodeBeforeUpdate)&&Ot(Ce,oe,Z,de),mn(h,!0);const Fe=eo(h),vt=h.subTree;h.subTree=Fe,b(vt,Fe,u(vt.el),R(vt),h,C,O),Z.el=Fe.el,Te===null&&Lu(h,Fe.el),K&&nt(K,C),(Ce=Z.props&&Z.props.onVnodeUpdated)&&nt(()=>Ot(Ce,oe,Z,de),C)}else{let Z;const{el:G,props:K}=p,{bm:oe,m:de,parent:Te}=h,Ce=us(p);if(mn(h,!1),oe&&Ks(oe),!Ce&&(Z=K&&K.onVnodeBeforeMount)&&Ot(Z,Te,p),mn(h,!0),G&&re){const Fe=()=>{h.subTree=eo(h),re(G,h.subTree,h,C,null)};Ce?p.type.__asyncLoader().then(()=>!h.isUnmounted&&Fe()):Fe()}else{const Fe=h.subTree=eo(h);b(null,Fe,y,w,h,C,O),p.el=Fe.el}if(de&&nt(de,C),!Ce&&(Z=K&&K.onVnodeMounted)){const Fe=p;nt(()=>Ot(Z,Te,Fe),C)}(p.shapeFlag&256||Te&&us(Te.vnode)&&Te.vnode.shapeFlag&256)&&h.a&&nt(h.a,C),h.isMounted=!0,p=y=w=null}},P=h.effect=new tr(E,()=>cr(k),h.scope),k=h.update=()=>P.run();k.id=h.uid,mn(h,!0),k()},S=(h,p,y)=>{p.component=h;const w=h.vnode.props;h.vnode=p,h.next=null,dh(h,p.props,w,y),fh(h,p.children,y),ti(),Jr(),ni()},N=(h,p,y,w,C,O,H,E,P=!1)=>{const k=h&&h.children,Z=h?h.shapeFlag:0,G=p.children,{patchFlag:K,shapeFlag:oe}=p;if(K>0){if(K&128){ce(k,G,y,w,C,O,H,E,P);return}else if(K&256){X(k,G,y,w,C,O,H,E,P);return}}oe&8?(Z&16&&B(k,C,O),G!==k&&d(y,G)):Z&16?oe&16?ce(k,G,y,w,C,O,H,E,P):B(k,C,O,!0):(Z&8&&d(y,""),oe&16&&M(G,y,w,C,O,H,E,P))},X=(h,p,y,w,C,O,H,E,P)=>{h=h||Nn,p=p||Nn;const k=h.length,Z=p.length,G=Math.min(k,Z);let K;for(K=0;K<G;K++){const oe=p[K]=P?Zt(p[K]):At(p[K]);b(h[K],oe,y,null,C,O,H,E,P)}k>Z?B(h,C,O,!0,!1,G):M(p,y,w,C,O,H,E,P,G)},ce=(h,p,y,w,C,O,H,E,P)=>{let k=0;const Z=p.length;let G=h.length-1,K=Z-1;for(;k<=G&&k<=K;){const oe=h[k],de=p[k]=P?Zt(p[k]):At(p[k]);if(wn(oe,de))b(oe,de,y,null,C,O,H,E,P);else break;k++}for(;k<=G&&k<=K;){const oe=h[G],de=p[K]=P?Zt(p[K]):At(p[K]);if(wn(oe,de))b(oe,de,y,null,C,O,H,E,P);else break;G--,K--}if(k>G){if(k<=K){const oe=K+1,de=oe<Z?p[oe].el:w;for(;k<=K;)b(null,p[k]=P?Zt(p[k]):At(p[k]),y,de,C,O,H,E,P),k++}}else if(k>K)for(;k<=G;)le(h[k],C,O,!0),k++;else{const oe=k,de=k,Te=new Map;for(k=de;k<=K;k++){const at=p[k]=P?Zt(p[k]):At(p[k]);at.key!=null&&Te.set(at.key,k)}let Ce,Fe=0;const vt=K-de+1;let Rn=!1,Lr=0;const hi=new Array(vt);for(k=0;k<vt;k++)hi[k]=0;for(k=oe;k<=G;k++){const at=h[k];if(Fe>=vt){le(at,C,O,!0);continue}let Et;if(at.key!=null)Et=Te.get(at.key);else for(Ce=de;Ce<=K;Ce++)if(hi[Ce-de]===0&&wn(at,p[Ce])){Et=Ce;break}Et===void 0?le(at,C,O,!0):(hi[Et-de]=k+1,Et>=Lr?Lr=Et:Rn=!0,b(at,p[Et],y,null,C,O,H,E,P),Fe++)}const Hr=Rn?vh(hi):Nn;for(Ce=Hr.length-1,k=vt-1;k>=0;k--){const at=de+k,Et=p[at],Nr=at+1<Z?p[at+1].el:w;hi[k]===0?b(null,Et,y,Nr,C,O,H,E,P):Rn&&(Ce<0||k!==Hr[Ce]?be(Et,y,Nr,2):Ce--)}}},be=(h,p,y,w,C=null)=>{const{el:O,type:H,transition:E,children:P,shapeFlag:k}=h;if(k&6){be(h.component.subTree,p,y,w);return}if(k&128){h.suspense.move(p,y,w);return}if(k&64){H.move(h,p,y,ne);return}if(H===ht){i(O,p,y);for(let G=0;G<P.length;G++)be(P[G],p,y,w);i(h.anchor,p,y);return}if(H===io){D(h,p,y);return}if(w!==2&&k&1&&E)if(w===0)E.beforeEnter(O),i(O,p,y),nt(()=>E.enter(O),C);else{const{leave:G,delayLeave:K,afterLeave:oe}=E,de=()=>i(O,p,y),Te=()=>{G(O,()=>{de(),oe&&oe()})};K?K(O,de,Te):Te()}else i(O,p,y)},le=(h,p,y,w=!1,C=!1)=>{const{type:O,props:H,ref:E,children:P,dynamicChildren:k,shapeFlag:Z,patchFlag:G,dirs:K}=h;if(E!=null&&Mo(E,null,y,h,!0),Z&256){p.ctx.deactivate(h);return}const oe=Z&1&&K,de=!us(h);let Te;if(de&&(Te=H&&H.onVnodeBeforeUnmount)&&Ot(Te,p,h),Z&6)x(h.component,y,w);else{if(Z&128){h.suspense.unmount(y,w);return}oe&&gn(h,null,p,"beforeUnmount"),Z&64?h.type.remove(h,p,y,C,ne,w):k&&(O!==ht||G>0&&G&64)?B(k,p,y,!1,!0):(O===ht&&G&384||!C&&Z&16)&&B(P,p,y),w&&Ae(h)}(de&&(Te=H&&H.onVnodeUnmounted)||oe)&&nt(()=>{Te&&Ot(Te,p,h),oe&&gn(h,null,p,"unmounted")},y)},Ae=h=>{const{type:p,el:y,anchor:w,transition:C}=h;if(p===ht){rt(y,w);return}if(p===io){J(h);return}const O=()=>{s(y),C&&!C.persisted&&C.afterLeave&&C.afterLeave()};if(h.shapeFlag&1&&C&&!C.persisted){const{leave:H,delayLeave:E}=C,P=()=>H(y,O);E?E(h.el,O,P):P()}else O()},rt=(h,p)=>{let y;for(;h!==p;)y=f(h),s(h),h=y;s(p)},x=(h,p,y)=>{const{bum:w,scope:C,update:O,subTree:H,um:E}=h;w&&Ks(w),C.stop(),O&&(O.active=!1,le(H,h,p,y)),E&&nt(E,p),nt(()=>{h.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&h.asyncDep&&!h.asyncResolved&&h.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},B=(h,p,y,w=!1,C=!1,O=0)=>{for(let H=O;H<h.length;H++)le(h[H],p,y,w,C)},R=h=>h.shapeFlag&6?R(h.component.subTree):h.shapeFlag&128?h.suspense.next():f(h.anchor||h.el),W=(h,p,y)=>{h==null?p._vnode&&le(p._vnode,null,null,!0):b(p._vnode||null,h,p,null,null,null,y),Jr(),Ul(),p._vnode=h},ne={p:b,um:le,m:be,r:Ae,mt:I,mc:M,pc:N,pbc:q,n:R,o:t};let ve,re;return e&&([ve,re]=e(ne)),{render:W,hydrate:ve,createApp:gh(W,ve)}}function mn({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function dc(t,e,n=!1){const i=t.children,s=e.children;if(se(i)&&se(s))for(let o=0;o<i.length;o++){const r=i[o];let a=s[o];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=s[o]=Zt(s[o]),a.el=r.el),n||dc(r,a)),a.type===Hs&&(a.el=r.el)}}function vh(t){const e=t.slice(),n=[0];let i,s,o,r,a;const l=t.length;for(i=0;i<l;i++){const c=t[i];if(c!==0){if(s=n[n.length-1],t[s]<c){e[i]=s,n.push(i);continue}for(o=0,r=n.length-1;o<r;)a=o+r>>1,t[n[a]]<c?o=a+1:r=a;c<t[n[o]]&&(o>0&&(e[i]=n[o-1]),n[o]=i)}}for(o=n.length,r=n[o-1];o-- >0;)n[o]=r,r=e[r];return n}const yh=t=>t.__isTeleport,ht=Symbol(void 0),Hs=Symbol(void 0),kt=Symbol(void 0),io=Symbol(void 0),Ci=[];let $t=null;function Ne(t=!1){Ci.push($t=t?null:[])}function xh(){Ci.pop(),$t=Ci[Ci.length-1]||null}let Li=1;function ra(t){Li+=t}function uc(t){return t.dynamicChildren=Li>0?$t||Nn:null,xh(),Li>0&&$t&&$t.push(t),t}function Ue(t,e,n,i,s,o){return uc(fe(t,e,n,i,s,o,!0))}function hc(t,e,n,i,s){return uc(ke(t,e,n,i,s,!0))}function Bo(t){return t?t.__v_isVNode===!0:!1}function wn(t,e){return t.type===e.type&&t.key===e.key}const Ns="__vInternal",fc=({key:t})=>t??null,hs=({ref:t,ref_key:e,ref_for:n})=>t!=null?Le(t)||Be(t)||ae(t)?{i:pt,r:t,k:e,f:!!n}:t:null;function fe(t,e=null,n=null,i=0,s=null,o=t===ht?0:1,r=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&fc(e),ref:e&&hs(e),scopeId:Bs,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:pt};return a?(pr(l,n),o&128&&t.normalize(l)):n&&(l.shapeFlag|=Le(n)?8:16),Li>0&&!r&&$t&&(l.patchFlag>0||o&6)&&l.patchFlag!==32&&$t.push(l),l}const ke=wh;function wh(t,e=null,n=null,i=0,s=null,o=!1){if((!t||t===eh)&&(t=kt),Bo(t)){const a=ln(t,e,!0);return n&&pr(a,n),Li>0&&!o&&$t&&(a.shapeFlag&6?$t[$t.indexOf(t)]=a:$t.push(a)),a.patchFlag|=-2,a}if(Rh(t)&&(t=t.__vccOpts),e){e=$h(e);let{class:a,style:l}=e;a&&!Le(a)&&(e.class=Wi(a)),Se(l)&&(Bl(l)&&!se(l)&&(l=je({},l)),e.style=_s(l))}const r=Le(t)?1:Hu(t)?128:yh(t)?64:Se(t)?4:ae(t)?2:0;return fe(t,e,n,i,s,r,o,!0)}function $h(t){return t?Bl(t)||Ns in t?je({},t):t:null}function ln(t,e,n=!1){const{props:i,ref:s,patchFlag:o,children:r}=t,a=e?Ch(i||{},e):i;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&fc(a),ref:e&&e.ref?n&&s?se(s)?s.concat(hs(e)):[s,hs(e)]:hs(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:r,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==ht?o===-1?16:o|16:o,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&ln(t.ssContent),ssFallback:t.ssFallback&&ln(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx}}function xs(t=" ",e=0){return ke(Hs,null,t,e)}function tn(t="",e=!1){return e?(Ne(),hc(kt,null,t)):ke(kt,null,t)}function At(t){return t==null||typeof t=="boolean"?ke(kt):se(t)?ke(ht,null,t.slice()):typeof t=="object"?Zt(t):ke(Hs,null,String(t))}function Zt(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:ln(t)}function pr(t,e){let n=0;const{shapeFlag:i}=t;if(e==null)e=null;else if(se(e))n=16;else if(typeof e=="object")if(i&65){const s=e.default;s&&(s._c&&(s._d=!1),pr(t,s()),s._c&&(s._d=!0));return}else{n=32;const s=e._;!s&&!(Ns in e)?e._ctx=pt:s===3&&pt&&(pt.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else ae(e)?(e={default:e,_ctx:pt},n=32):(e=String(e),i&64?(n=16,e=[xs(e)]):n=8);t.children=e,t.shapeFlag|=n}function Ch(...t){const e={};for(let n=0;n<t.length;n++){const i=t[n];for(const s in i)if(s==="class")e.class!==i.class&&(e.class=Wi([e.class,i.class]));else if(s==="style")e.style=_s([e.style,i.style]);else if(Es(s)){const o=e[s],r=i[s];r&&o!==r&&!(se(o)&&o.includes(r))&&(e[s]=o?[].concat(o,r):r)}else s!==""&&(e[s]=i[s])}return e}function Ot(t,e,n,i=null){gt(t,e,7,[n,i])}const kh=cc();let Th=0;function Sh(t,e,n){const i=t.type,s=(e?e.appContext:t.appContext)||kh,o={uid:Th++,vnode:t,type:i,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,scope:new Cl(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:oc(i,s),emitsOptions:Wl(i,s),emit:null,emitted:null,propsDefaults:Ie,inheritAttrs:i.inheritAttrs,ctx:Ie,data:Ie,props:Ie,attrs:Ie,slots:Ie,refs:Ie,setupState:Ie,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=e?e.root:o,o.emit=Ru.bind(null,o),t.ce&&t.ce(o),o}let Ve=null;const gr=()=>Ve||pt,Yn=t=>{Ve=t,t.scope.on()},Sn=()=>{Ve&&Ve.scope.off(),Ve=null};function pc(t){return t.vnode.shapeFlag&4}let Hi=!1;function Ih(t,e=!1){Hi=e;const{props:n,children:i}=t.vnode,s=pc(t);ch(t,n,s,e),hh(t,i);const o=s?_h(t,e):void 0;return Hi=!1,o}function _h(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=Gn(new Proxy(t.ctx,ih));const{setup:i}=n;if(i){const s=t.setupContext=i.length>1?Oh(t):null;Yn(t),ti();const o=on(i,t,0,[t.props,s]);if(ni(),Sn(),xl(o)){if(o.then(Sn,Sn),e)return o.then(r=>{aa(t,r,e)}).catch(r=>{Ps(r,t,0)});t.asyncDep=o}else aa(t,o,e)}else gc(t,e)}function aa(t,e,n){ae(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Se(e)&&(t.setupState=Nl(e)),gc(t,n)}let la;function gc(t,e,n){const i=t.type;if(!t.render){if(!e&&la&&!i.render){const s=i.template||hr(t).template;if(s){const{isCustomElement:o,compilerOptions:r}=t.appContext.config,{delimiters:a,compilerOptions:l}=i,c=je(je({isCustomElement:o,delimiters:a},r),l);i.render=la(s,c)}}t.render=i.render||Ct}Yn(t),ti(),sh(t),ni(),Sn()}function Eh(t){return new Proxy(t.attrs,{get(e,n){return ct(t,"get","$attrs"),e[n]}})}function Oh(t){const e=i=>{t.exposed=i||{}};let n;return{get attrs(){return n||(n=Eh(t))},slots:t.slots,emit:t.emit,expose:e}}function mr(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(Nl(Gn(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in $i)return $i[n](t)},has(e,n){return n in e||n in $i}}))}function Ah(t,e=!0){return ae(t)?t.displayName||t.name:t.name||e&&t.__name}function Rh(t){return ae(t)&&"__vccOpts"in t}const Me=(t,e)=>Su(t,e,Hi);function mc(t,e,n){const i=arguments.length;return i===2?Se(e)&&!se(e)?Bo(e)?ke(t,null,[e]):ke(t,e):ke(t,null,e):(i>3?n=Array.prototype.slice.call(arguments,2):i===3&&Bo(n)&&(n=[n]),ke(t,e,n))}const Dh=Symbol(""),Ph=()=>Pt(Dh),Mh="3.2.45",Bh="http://www.w3.org/2000/svg",$n=typeof document<"u"?document:null,ca=$n&&$n.createElement("template"),Fh={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,i)=>{const s=e?$n.createElementNS(Bh,t):$n.createElement(t,n?{is:n}:void 0);return t==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:t=>$n.createTextNode(t),createComment:t=>$n.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>$n.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,i,s,o){const r=n?n.previousSibling:e.lastChild;if(s&&(s===o||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),n),!(s===o||!(s=s.nextSibling)););else{ca.innerHTML=i?`<svg>${t}</svg>`:t;const a=ca.content;if(i){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[r?r.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function Lh(t,e,n){const i=t._vtc;i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function Hh(t,e,n){const i=t.style,s=Le(n);if(n&&!s){for(const o in n)Fo(i,o,n[o]);if(e&&!Le(e))for(const o in e)n[o]==null&&Fo(i,o,"")}else{const o=i.display;s?e!==n&&(i.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(i.display=o)}}const da=/\s*!important$/;function Fo(t,e,n){if(se(n))n.forEach(i=>Fo(t,e,i));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const i=Nh(t,e);da.test(n)?t.setProperty(ei(i),n.replace(da,""),"important"):t[i]=n}}const ua=["Webkit","Moz","ms"],so={};function Nh(t,e){const n=so[e];if(n)return n;let i=Mt(e);if(i!=="filter"&&i in t)return so[e]=i;i=Rs(i);for(let s=0;s<ua.length;s++){const o=ua[s]+i;if(o in t)return so[e]=o}return e}const ha="http://www.w3.org/1999/xlink";function Vh(t,e,n,i,s){if(i&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(ha,e.slice(6,e.length)):t.setAttributeNS(ha,e,n);else{const o=Bd(e);n==null||o&&!bl(n)?t.removeAttribute(e):t.setAttribute(e,o?"":n)}}function jh(t,e,n,i,s,o,r){if(e==="innerHTML"||e==="textContent"){i&&r(i,s,o),t[e]=n??"";return}if(e==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=n;const l=n??"";(t.value!==l||t.tagName==="OPTION")&&(t.value=l),n==null&&t.removeAttribute(e);return}let a=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=bl(n):n==null&&l==="string"?(n="",a=!0):l==="number"&&(n=0,a=!0)}try{t[e]=n}catch{}a&&t.removeAttribute(e)}function zh(t,e,n,i){t.addEventListener(e,n,i)}function Uh(t,e,n,i){t.removeEventListener(e,n,i)}function qh(t,e,n,i,s=null){const o=t._vei||(t._vei={}),r=o[e];if(i&&r)r.value=i;else{const[a,l]=Wh(e);if(i){const c=o[e]=Qh(i,s);zh(t,a,c,l)}else r&&(Uh(t,a,r,l),o[e]=void 0)}}const fa=/(?:Once|Passive|Capture)$/;function Wh(t){let e;if(fa.test(t)){e={};let i;for(;i=t.match(fa);)t=t.slice(0,t.length-i[0].length),e[i[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):ei(t.slice(2)),e]}let oo=0;const Gh=Promise.resolve(),Yh=()=>oo||(Gh.then(()=>oo=0),oo=Date.now());function Qh(t,e){const n=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=n.attached)return;gt(Jh(i,n.value),e,5,[i])};return n.value=t,n.attached=Yh(),n}function Jh(t,e){if(se(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(i=>s=>!s._stopped&&i&&i(s))}else return e}const pa=/^on[a-z]/,Xh=(t,e,n,i,s=!1,o,r,a,l)=>{e==="class"?Lh(t,i,s):e==="style"?Hh(t,n,i):Es(e)?Qo(e)||qh(t,e,n,i,r):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Zh(t,e,i,s))?jh(t,e,i,o,r,a,l):(e==="true-value"?t._trueValue=i:e==="false-value"&&(t._falseValue=i),Vh(t,e,i,s))};function Zh(t,e,n,i){return i?!!(e==="innerHTML"||e==="textContent"||e in t&&pa.test(e)&&ae(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||pa.test(e)&&Le(n)?!1:e in t}const Yt="transition",fi="animation",bc={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Kh=je({},zu.props,bc),bn=(t,e=[])=>{se(t)?t.forEach(n=>n(...e)):t&&t(...e)},ga=t=>t?se(t)?t.some(e=>e.length>1):t.length>1:!1;function ef(t){const e={};for(const z in t)z in bc||(e[z]=t[z]);if(t.css===!1)return e;const{name:n="v",type:i,duration:s,enterFromClass:o=`${n}-enter-from`,enterActiveClass:r=`${n}-enter-active`,enterToClass:a=`${n}-enter-to`,appearFromClass:l=o,appearActiveClass:c=r,appearToClass:d=a,leaveFromClass:u=`${n}-leave-from`,leaveActiveClass:f=`${n}-leave-active`,leaveToClass:m=`${n}-leave-to`}=t,v=tf(s),b=v&&v[0],A=v&&v[1],{onBeforeEnter:_,onEnter:F,onEnterCancelled:D,onLeave:J,onLeaveCancelled:Y,onBeforeAppear:te=_,onAppear:ee=F,onAppearCancelled:M=D}=e,Q=(z,L,I)=>{Xt(z,L?d:a),Xt(z,L?c:r),I&&I()},q=(z,L)=>{z._isLeaving=!1,Xt(z,u),Xt(z,m),Xt(z,f),L&&L()},xe=z=>(L,I)=>{const T=z?ee:F,V=()=>Q(L,z,I);bn(T,[L,V]),ma(()=>{Xt(L,z?l:o),Ft(L,z?d:a),ga(T)||ba(L,i,b,V)})};return je(e,{onBeforeEnter(z){bn(_,[z]),Ft(z,o),Ft(z,r)},onBeforeAppear(z){bn(te,[z]),Ft(z,l),Ft(z,c)},onEnter:xe(!1),onAppear:xe(!0),onLeave(z,L){z._isLeaving=!0;const I=()=>q(z,L);Ft(z,u),yc(),Ft(z,f),ma(()=>{!z._isLeaving||(Xt(z,u),Ft(z,m),ga(J)||ba(z,i,A,I))}),bn(J,[z,I])},onEnterCancelled(z){Q(z,!1),bn(D,[z])},onAppearCancelled(z){Q(z,!0),bn(M,[z])},onLeaveCancelled(z){q(z),bn(Y,[z])}})}function tf(t){if(t==null)return null;if(Se(t))return[ro(t.enter),ro(t.leave)];{const e=ro(t);return[e,e]}}function ro(t){return Ko(t)}function Ft(t,e){e.split(/\s+/).forEach(n=>n&&t.classList.add(n)),(t._vtc||(t._vtc=new Set)).add(e)}function Xt(t,e){e.split(/\s+/).forEach(i=>i&&t.classList.remove(i));const{_vtc:n}=t;n&&(n.delete(e),n.size||(t._vtc=void 0))}function ma(t){requestAnimationFrame(()=>{requestAnimationFrame(t)})}let nf=0;function ba(t,e,n,i){const s=t._endId=++nf,o=()=>{s===t._endId&&i()};if(n)return setTimeout(o,n);const{type:r,timeout:a,propCount:l}=vc(t,e);if(!r)return i();const c=r+"end";let d=0;const u=()=>{t.removeEventListener(c,f),o()},f=m=>{m.target===t&&++d>=l&&u()};setTimeout(()=>{d<l&&u()},a+1),t.addEventListener(c,f)}function vc(t,e){const n=window.getComputedStyle(t),i=v=>(n[v]||"").split(", "),s=i(`${Yt}Delay`),o=i(`${Yt}Duration`),r=va(s,o),a=i(`${fi}Delay`),l=i(`${fi}Duration`),c=va(a,l);let d=null,u=0,f=0;e===Yt?r>0&&(d=Yt,u=r,f=o.length):e===fi?c>0&&(d=fi,u=c,f=l.length):(u=Math.max(r,c),d=u>0?r>c?Yt:fi:null,f=d?d===Yt?o.length:l.length:0);const m=d===Yt&&/\b(transform|all)(,|$)/.test(i(`${Yt}Property`).toString());return{type:d,timeout:u,propCount:f,hasTransform:m}}function va(t,e){for(;t.length<e.length;)t=t.concat(t);return Math.max(...e.map((n,i)=>ya(n)+ya(t[i])))}function ya(t){return Number(t.slice(0,-1).replace(",","."))*1e3}function yc(){return document.body.offsetHeight}const xc=new WeakMap,wc=new WeakMap,sf={name:"TransitionGroup",props:je({},Kh,{tag:String,moveClass:String}),setup(t,{slots:e}){const n=gr(),i=Jl();let s,o;return Kl(()=>{if(!s.length)return;const r=t.moveClass||`${t.name||"v"}-move`;if(!cf(s[0].el,n.vnode.el,r))return;s.forEach(rf),s.forEach(af);const a=s.filter(lf);yc(),a.forEach(l=>{const c=l.el,d=c.style;Ft(c,r),d.transform=d.webkitTransform=d.transitionDuration="";const u=c._moveCb=f=>{f&&f.target!==c||(!f||/transform$/.test(f.propertyName))&&(c.removeEventListener("transitionend",u),c._moveCb=null,Xt(c,r))};c.addEventListener("transitionend",u)})}),()=>{const r=me(t),a=ef(r);let l=r.tag||ht;s=o,o=e.default?dr(e.default()):[];for(let c=0;c<o.length;c++){const d=o[c];d.key!=null&&Fi(d,Bi(d,a,i,n))}if(s)for(let c=0;c<s.length;c++){const d=s[c];Fi(d,Bi(d,a,i,n)),xc.set(d,d.el.getBoundingClientRect())}return ke(l,null,o)}}},of=sf;function rf(t){const e=t.el;e._moveCb&&e._moveCb(),e._enterCb&&e._enterCb()}function af(t){wc.set(t,t.el.getBoundingClientRect())}function lf(t){const e=xc.get(t),n=wc.get(t),i=e.left-n.left,s=e.top-n.top;if(i||s){const o=t.el.style;return o.transform=o.webkitTransform=`translate(${i}px,${s}px)`,o.transitionDuration="0s",t}}function cf(t,e,n){const i=t.cloneNode();t._vtc&&t._vtc.forEach(r=>{r.split(/\s+/).forEach(a=>a&&i.classList.remove(a))}),n.split(/\s+/).forEach(r=>r&&i.classList.add(r)),i.style.display="none";const s=e.nodeType===1?e:e.parentNode;s.appendChild(i);const{hasTransform:o}=vc(i);return s.removeChild(i),o}const df=je({patchProp:Xh},Fh);let xa;function uf(){return xa||(xa=mh(df))}const hf=(...t)=>{const e=uf().createApp(...t),{mount:n}=e;return e.mount=i=>{const s=ff(i);if(!s)return;const o=e._component;!ae(o)&&!o.render&&!o.template&&(o.template=s.innerHTML),s.innerHTML="";const r=n(s,!1,s instanceof SVGElement);return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),r},e};function ff(t){return Le(t)?document.querySelector(t):t}var pf=!1;let $c;const Vs=t=>$c=t,Cc=Symbol();function Lo(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var ki;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(ki||(ki={}));function gf(){const t=kl(!0),e=t.run(()=>Di({}));let n=[],i=[];const s=Gn({install(o){Vs(s),s._a=o,o.provide(Cc,s),o.config.globalProperties.$pinia=s,i.forEach(r=>n.push(r)),i=[]},use(o){return!this._a&&!pf?i.push(o):n.push(o),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return s}const kc=()=>{};function wa(t,e,n,i=kc){t.push(e);const s=()=>{const o=t.indexOf(e);o>-1&&(t.splice(o,1),i())};return!n&&qd()&&Wd(s),s}function Dn(t,...e){t.slice().forEach(n=>{n(...e)})}function Ho(t,e){t instanceof Map&&e instanceof Map&&e.forEach((n,i)=>t.set(i,n)),t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const i=e[n],s=t[n];Lo(s)&&Lo(i)&&t.hasOwnProperty(n)&&!Be(i)&&!sn(i)?t[n]=Ho(s,i):t[n]=i}return t}const mf=Symbol();function bf(t){return!Lo(t)||!t.hasOwnProperty(mf)}const{assign:Kt}=Object;function vf(t){return!!(Be(t)&&t.effect)}function yf(t,e,n,i){const{state:s,actions:o,getters:r}=e,a=n.state.value[t];let l;function c(){a||(n.state.value[t]=s?s():{});const d=$u(n.state.value[t]);return Kt(d,o,Object.keys(r||{}).reduce((u,f)=>(u[f]=Gn(Me(()=>{Vs(n);const m=n._s.get(t);return r[f].call(m,m)})),u),{}))}return l=Tc(t,c,e,n,i,!0),l.$reset=function(){const u=s?s():{};this.$patch(f=>{Kt(f,u)})},l}function Tc(t,e,n={},i,s,o){let r;const a=Kt({actions:{}},n),l={deep:!0};let c,d,u=Gn([]),f=Gn([]),m;const v=i.state.value[t];!o&&!v&&(i.state.value[t]={}),Di({});let b;function A(ee){let M;c=d=!1,typeof ee=="function"?(ee(i.state.value[t]),M={type:ki.patchFunction,storeId:t,events:m}):(Ho(i.state.value[t],ee),M={type:ki.patchObject,payload:ee,storeId:t,events:m});const Q=b=Symbol();lr().then(()=>{b===Q&&(c=!0)}),d=!0,Dn(u,M,i.state.value[t])}const _=kc;function F(){r.stop(),u=[],f=[],i._s.delete(t)}function D(ee,M){return function(){Vs(i);const Q=Array.from(arguments),q=[],xe=[];function z(T){q.push(T)}function L(T){xe.push(T)}Dn(f,{args:Q,name:ee,store:Y,after:z,onError:L});let I;try{I=M.apply(this&&this.$id===t?this:Y,Q)}catch(T){throw Dn(xe,T),T}return I instanceof Promise?I.then(T=>(Dn(q,T),T)).catch(T=>(Dn(xe,T),Promise.reject(T))):(Dn(q,I),I)}}const J={_p:i,$id:t,$onAction:wa.bind(null,f),$patch:A,$reset:_,$subscribe(ee,M={}){const Q=wa(u,ee,M.detached,()=>q()),q=r.run(()=>wi(()=>i.state.value[t],xe=>{(M.flush==="sync"?d:c)&&ee({storeId:t,type:ki.direct,events:m},xe)},Kt({},l,M)));return Q},$dispose:F},Y=ii(J);i._s.set(t,Y);const te=i._e.run(()=>(r=kl(),r.run(()=>e())));for(const ee in te){const M=te[ee];if(Be(M)&&!vf(M)||sn(M))o||(v&&bf(M)&&(Be(M)?M.value=v[ee]:Ho(M,v[ee])),i.state.value[t][ee]=M);else if(typeof M=="function"){const Q=D(ee,M);te[ee]=Q,a.actions[ee]=M}}return Kt(Y,te),Kt(me(Y),te),Object.defineProperty(Y,"$state",{get:()=>i.state.value[t],set:ee=>{A(M=>{Kt(M,ee)})}}),i._p.forEach(ee=>{Kt(Y,r.run(()=>ee({store:Y,app:i._a,pinia:i,options:a})))}),v&&o&&n.hydrate&&n.hydrate(Y.$state,v),c=!0,d=!0,Y}function Sc(t,e,n){let i,s;const o=typeof e=="function";typeof t=="string"?(i=t,s=o?n:e):(s=t,i=t.id);function r(a,l){const c=gr();return a=a||c&&Pt(Cc,null),a&&Vs(a),a=$c,a._s.has(i)||(o?Tc(i,e,s,a):yf(i,s,a)),a._s.get(i)}return r.$id=i,r}const Nt=un({__name:"CodeIcon",props:{icon:null},setup(t){return(e,n)=>(Ne(),Ue("span",{class:Wi(["codicon",`codicon-${t.icon}`])},null,2))}}),si=Sc("app",{state:()=>({workspaceOpen:!1,clientVersion:"",notifications:[]})});class xf{constructor(){Vr(this,"vsCodeApi");typeof acquireVsCodeApi=="function"&&(this.vsCodeApi=acquireVsCodeApi())}postMessage(e,n){this.vsCodeApi?this.vsCodeApi.postMessage({command:e,data:n}):window.parent.postMessage({command:e,data:n},"*")}getState(){if(this.vsCodeApi)return this.vsCodeApi.getState();{const e=localStorage.getItem("vscodeState");return e?JSON.parse(e):void 0}}setState(e){return this.vsCodeApi?this.vsCodeApi.setState(e):(localStorage.setItem("vscodeState",JSON.stringify(e)),e)}}const xt=new xf,cn=function(){if(typeof globalThis<"u")return globalThis;if(typeof global<"u")return global;if(typeof self<"u")return self;if(typeof window<"u")return window;try{return new Function("return this")()}catch{return{}}}();cn.trustedTypes===void 0&&(cn.trustedTypes={createPolicy:(t,e)=>e});const Ic={configurable:!1,enumerable:!1,writable:!1};cn.FAST===void 0&&Reflect.defineProperty(cn,"FAST",Object.assign({value:Object.create(null)},Ic));const Ni=cn.FAST;if(Ni.getById===void 0){const t=Object.create(null);Reflect.defineProperty(Ni,"getById",Object.assign({value(e,n){let i=t[e];return i===void 0&&(i=n?t[e]=n():null),i}},Ic))}const In=Object.freeze([]);function _c(){const t=new WeakMap;return function(e){let n=t.get(e);if(n===void 0){let i=Reflect.getPrototypeOf(e);for(;n===void 0&&i!==null;)n=t.get(i),i=Reflect.getPrototypeOf(i);n=n===void 0?[]:n.slice(0),t.set(e,n)}return n}}const ao=cn.FAST.getById(1,()=>{const t=[],e=[];function n(){if(e.length)throw e.shift()}function i(r){try{r.call()}catch(a){e.push(a),setTimeout(n,0)}}function s(){let a=0;for(;a<t.length;)if(i(t[a]),a++,a>1024){for(let l=0,c=t.length-a;l<c;l++)t[l]=t[l+a];t.length-=a,a=0}t.length=0}function o(r){t.length<1&&cn.requestAnimationFrame(s),t.push(r)}return Object.freeze({enqueue:o,process:s})}),Ec=cn.trustedTypes.createPolicy("fast-html",{createHTML:t=>t});let lo=Ec;const Ti=`fast-${Math.random().toString(36).substring(2,8)}`,Oc=`${Ti}{`,br=`}${Ti}`,he=Object.freeze({supportsAdoptedStyleSheets:Array.isArray(document.adoptedStyleSheets)&&"replace"in CSSStyleSheet.prototype,setHTMLPolicy(t){if(lo!==Ec)throw new Error("The HTML policy can only be set once.");lo=t},createHTML(t){return lo.createHTML(t)},isMarker(t){return t&&t.nodeType===8&&t.data.startsWith(Ti)},extractDirectiveIndexFromMarker(t){return parseInt(t.data.replace(`${Ti}:`,""))},createInterpolationPlaceholder(t){return`${Oc}${t}${br}`},createCustomAttributePlaceholder(t,e){return`${t}="${this.createInterpolationPlaceholder(e)}"`},createBlockPlaceholder(t){return`<!--${Ti}:${t}-->`},queueUpdate:ao.enqueue,processUpdates:ao.process,nextUpdate(){return new Promise(ao.enqueue)},setAttribute(t,e,n){n==null?t.removeAttribute(e):t.setAttribute(e,n)},setBooleanAttribute(t,e,n){n?t.setAttribute(e,""):t.removeAttribute(e)},removeChildNodes(t){for(let e=t.firstChild;e!==null;e=t.firstChild)t.removeChild(e)},createTemplateWalker(t){return document.createTreeWalker(t,133,null,!1)}});class ws{constructor(e,n){this.sub1=void 0,this.sub2=void 0,this.spillover=void 0,this.source=e,this.sub1=n}has(e){return this.spillover===void 0?this.sub1===e||this.sub2===e:this.spillover.indexOf(e)!==-1}subscribe(e){const n=this.spillover;if(n===void 0){if(this.has(e))return;if(this.sub1===void 0){this.sub1=e;return}if(this.sub2===void 0){this.sub2=e;return}this.spillover=[this.sub1,this.sub2,e],this.sub1=void 0,this.sub2=void 0}else n.indexOf(e)===-1&&n.push(e)}unsubscribe(e){const n=this.spillover;if(n===void 0)this.sub1===e?this.sub1=void 0:this.sub2===e&&(this.sub2=void 0);else{const i=n.indexOf(e);i!==-1&&n.splice(i,1)}}notify(e){const n=this.spillover,i=this.source;if(n===void 0){const s=this.sub1,o=this.sub2;s!==void 0&&s.handleChange(i,e),o!==void 0&&o.handleChange(i,e)}else for(let s=0,o=n.length;s<o;++s)n[s].handleChange(i,e)}}class Ac{constructor(e){this.subscribers={},this.sourceSubscribers=null,this.source=e}notify(e){var n;const i=this.subscribers[e];i!==void 0&&i.notify(e),(n=this.sourceSubscribers)===null||n===void 0||n.notify(e)}subscribe(e,n){var i;if(n){let s=this.subscribers[n];s===void 0&&(this.subscribers[n]=s=new ws(this.source)),s.subscribe(e)}else this.sourceSubscribers=(i=this.sourceSubscribers)!==null&&i!==void 0?i:new ws(this.source),this.sourceSubscribers.subscribe(e)}unsubscribe(e,n){var i;if(n){const s=this.subscribers[n];s!==void 0&&s.unsubscribe(e)}else(i=this.sourceSubscribers)===null||i===void 0||i.unsubscribe(e)}}const ue=Ni.getById(2,()=>{const t=/(:|&&|\|\||if)/,e=new WeakMap,n=he.queueUpdate;let i,s=c=>{throw new Error("Must call enableArrayObservation before observing arrays.")};function o(c){let d=c.$fastController||e.get(c);return d===void 0&&(Array.isArray(c)?d=s(c):e.set(c,d=new Ac(c))),d}const r=_c();class a{constructor(d){this.name=d,this.field=`_${d}`,this.callback=`${d}Changed`}getValue(d){return i!==void 0&&i.watch(d,this.name),d[this.field]}setValue(d,u){const f=this.field,m=d[f];if(m!==u){d[f]=u;const v=d[this.callback];typeof v=="function"&&v.call(d,m,u),o(d).notify(this.name)}}}class l extends ws{constructor(d,u,f=!1){super(d,u),this.binding=d,this.isVolatileBinding=f,this.needsRefresh=!0,this.needsQueue=!0,this.first=this,this.last=null,this.propertySource=void 0,this.propertyName=void 0,this.notifier=void 0,this.next=void 0}observe(d,u){this.needsRefresh&&this.last!==null&&this.disconnect();const f=i;i=this.needsRefresh?this:void 0,this.needsRefresh=this.isVolatileBinding;const m=this.binding(d,u);return i=f,m}disconnect(){if(this.last!==null){let d=this.first;for(;d!==void 0;)d.notifier.unsubscribe(this,d.propertyName),d=d.next;this.last=null,this.needsRefresh=this.needsQueue=!0}}watch(d,u){const f=this.last,m=o(d),v=f===null?this.first:{};if(v.propertySource=d,v.propertyName=u,v.notifier=m,m.subscribe(this,u),f!==null){if(!this.needsRefresh){let b;i=void 0,b=f.propertySource[f.propertyName],i=this,d===b&&(this.needsRefresh=!0)}f.next=v}this.last=v}handleChange(){this.needsQueue&&(this.needsQueue=!1,n(this))}call(){this.last!==null&&(this.needsQueue=!0,this.notify(this))}records(){let d=this.first;return{next:()=>{const u=d;return u===void 0?{value:void 0,done:!0}:(d=d.next,{value:u,done:!1})},[Symbol.iterator]:function(){return this}}}}return Object.freeze({setArrayObserverFactory(c){s=c},getNotifier:o,track(c,d){i!==void 0&&i.watch(c,d)},trackVolatile(){i!==void 0&&(i.needsRefresh=!0)},notify(c,d){o(c).notify(d)},defineProperty(c,d){typeof d=="string"&&(d=new a(d)),r(c).push(d),Reflect.defineProperty(c,d.name,{enumerable:!0,get:function(){return d.getValue(this)},set:function(u){d.setValue(this,u)}})},getAccessors:r,binding(c,d,u=this.isVolatileBinding(c)){return new l(c,d,u)},isVolatileBinding(c){return t.test(c.toString())}})});function U(t,e){ue.defineProperty(t,e)}function wf(t,e,n){return Object.assign({},n,{get:function(){return ue.trackVolatile(),n.get.apply(this)}})}const $a=Ni.getById(3,()=>{let t=null;return{get(){return t},set(e){t=e}}});class Vi{constructor(){this.index=0,this.length=0,this.parent=null,this.parentContext=null}get event(){return $a.get()}get isEven(){return this.index%2===0}get isOdd(){return this.index%2!==0}get isFirst(){return this.index===0}get isInMiddle(){return!this.isFirst&&!this.isLast}get isLast(){return this.index===this.length-1}static setEvent(e){$a.set(e)}}ue.defineProperty(Vi.prototype,"index");ue.defineProperty(Vi.prototype,"length");const Si=Object.seal(new Vi);class js{constructor(){this.targetIndex=0}}class Rc extends js{constructor(){super(...arguments),this.createPlaceholder=he.createInterpolationPlaceholder}}class vr extends js{constructor(e,n,i){super(),this.name=e,this.behavior=n,this.options=i}createPlaceholder(e){return he.createCustomAttributePlaceholder(this.name,e)}createBehavior(e){return new this.behavior(e,this.options)}}function $f(t,e){this.source=t,this.context=e,this.bindingObserver===null&&(this.bindingObserver=ue.binding(this.binding,this,this.isBindingVolatile)),this.updateTarget(this.bindingObserver.observe(t,e))}function Cf(t,e){this.source=t,this.context=e,this.target.addEventListener(this.targetName,this)}function kf(){this.bindingObserver.disconnect(),this.source=null,this.context=null}function Tf(){this.bindingObserver.disconnect(),this.source=null,this.context=null;const t=this.target.$fastView;t!==void 0&&t.isComposed&&(t.unbind(),t.needsBindOnly=!0)}function Sf(){this.target.removeEventListener(this.targetName,this),this.source=null,this.context=null}function If(t){he.setAttribute(this.target,this.targetName,t)}function _f(t){he.setBooleanAttribute(this.target,this.targetName,t)}function Ef(t){if(t==null&&(t=""),t.create){this.target.textContent="";let e=this.target.$fastView;e===void 0?e=t.create():this.target.$fastTemplate!==t&&(e.isComposed&&(e.remove(),e.unbind()),e=t.create()),e.isComposed?e.needsBindOnly&&(e.needsBindOnly=!1,e.bind(this.source,this.context)):(e.isComposed=!0,e.bind(this.source,this.context),e.insertBefore(this.target),this.target.$fastView=e,this.target.$fastTemplate=t)}else{const e=this.target.$fastView;e!==void 0&&e.isComposed&&(e.isComposed=!1,e.remove(),e.needsBindOnly?e.needsBindOnly=!1:e.unbind()),this.target.textContent=t}}function Of(t){this.target[this.targetName]=t}function Af(t){const e=this.classVersions||Object.create(null),n=this.target;let i=this.version||0;if(t!=null&&t.length){const s=t.split(/\s+/);for(let o=0,r=s.length;o<r;++o){const a=s[o];a!==""&&(e[a]=i,n.classList.add(a))}}if(this.classVersions=e,this.version=i+1,i!==0){i-=1;for(const s in e)e[s]===i&&n.classList.remove(s)}}class yr extends Rc{constructor(e){super(),this.binding=e,this.bind=$f,this.unbind=kf,this.updateTarget=If,this.isBindingVolatile=ue.isVolatileBinding(this.binding)}get targetName(){return this.originalTargetName}set targetName(e){if(this.originalTargetName=e,e!==void 0)switch(e[0]){case":":if(this.cleanedTargetName=e.substr(1),this.updateTarget=Of,this.cleanedTargetName==="innerHTML"){const n=this.binding;this.binding=(i,s)=>he.createHTML(n(i,s))}break;case"?":this.cleanedTargetName=e.substr(1),this.updateTarget=_f;break;case"@":this.cleanedTargetName=e.substr(1),this.bind=Cf,this.unbind=Sf;break;default:this.cleanedTargetName=e,e==="class"&&(this.updateTarget=Af);break}}targetAtContent(){this.updateTarget=Ef,this.unbind=Tf}createBehavior(e){return new Rf(e,this.binding,this.isBindingVolatile,this.bind,this.unbind,this.updateTarget,this.cleanedTargetName)}}class Rf{constructor(e,n,i,s,o,r,a){this.source=null,this.context=null,this.bindingObserver=null,this.target=e,this.binding=n,this.isBindingVolatile=i,this.bind=s,this.unbind=o,this.updateTarget=r,this.targetName=a}handleChange(){this.updateTarget(this.bindingObserver.observe(this.source,this.context))}handleEvent(e){Vi.setEvent(e);const n=this.binding(this.source,this.context);Vi.setEvent(null),n!==!0&&e.preventDefault()}}let co=null;class xr{addFactory(e){e.targetIndex=this.targetIndex,this.behaviorFactories.push(e)}captureContentBinding(e){e.targetAtContent(),this.addFactory(e)}reset(){this.behaviorFactories=[],this.targetIndex=-1}release(){co=this}static borrow(e){const n=co||new xr;return n.directives=e,n.reset(),co=null,n}}function Df(t){if(t.length===1)return t[0];let e;const n=t.length,i=t.map(r=>typeof r=="string"?()=>r:(e=r.targetName||e,r.binding)),s=(r,a)=>{let l="";for(let c=0;c<n;++c)l+=i[c](r,a);return l},o=new yr(s);return o.targetName=e,o}const Pf=br.length;function Dc(t,e){const n=e.split(Oc);if(n.length===1)return null;const i=[];for(let s=0,o=n.length;s<o;++s){const r=n[s],a=r.indexOf(br);let l;if(a===-1)l=r;else{const c=parseInt(r.substring(0,a));i.push(t.directives[c]),l=r.substring(a+Pf)}l!==""&&i.push(l)}return i}function Ca(t,e,n=!1){const i=e.attributes;for(let s=0,o=i.length;s<o;++s){const r=i[s],a=r.value,l=Dc(t,a);let c=null;l===null?n&&(c=new yr(()=>a),c.targetName=r.name):c=Df(l),c!==null&&(e.removeAttributeNode(r),s--,o--,t.addFactory(c))}}function Mf(t,e,n){const i=Dc(t,e.textContent);if(i!==null){let s=e;for(let o=0,r=i.length;o<r;++o){const a=i[o],l=o===0?e:s.parentNode.insertBefore(document.createTextNode(""),s.nextSibling);typeof a=="string"?l.textContent=a:(l.textContent=" ",t.captureContentBinding(a)),s=l,t.targetIndex++,l!==e&&n.nextNode()}t.targetIndex--}}function Bf(t,e){const n=t.content;document.adoptNode(n);const i=xr.borrow(e);Ca(i,t,!0);const s=i.behaviorFactories;i.reset();const o=he.createTemplateWalker(n);let r;for(;r=o.nextNode();)switch(i.targetIndex++,r.nodeType){case 1:Ca(i,r);break;case 3:Mf(i,r,o);break;case 8:he.isMarker(r)&&i.addFactory(e[he.extractDirectiveIndexFromMarker(r)])}let a=0;(he.isMarker(n.firstChild)||n.childNodes.length===1&&e.length)&&(n.insertBefore(document.createComment(""),n.firstChild),a=-1);const l=i.behaviorFactories;return i.release(),{fragment:n,viewBehaviorFactories:l,hostBehaviorFactories:s,targetOffset:a}}const uo=document.createRange();class Pc{constructor(e,n){this.fragment=e,this.behaviors=n,this.source=null,this.context=null,this.firstChild=e.firstChild,this.lastChild=e.lastChild}appendTo(e){e.appendChild(this.fragment)}insertBefore(e){if(this.fragment.hasChildNodes())e.parentNode.insertBefore(this.fragment,e);else{const n=this.lastChild;if(e.previousSibling===n)return;const i=e.parentNode;let s=this.firstChild,o;for(;s!==n;)o=s.nextSibling,i.insertBefore(s,e),s=o;i.insertBefore(n,e)}}remove(){const e=this.fragment,n=this.lastChild;let i=this.firstChild,s;for(;i!==n;)s=i.nextSibling,e.appendChild(i),i=s;e.appendChild(n)}dispose(){const e=this.firstChild.parentNode,n=this.lastChild;let i=this.firstChild,s;for(;i!==n;)s=i.nextSibling,e.removeChild(i),i=s;e.removeChild(n);const o=this.behaviors,r=this.source;for(let a=0,l=o.length;a<l;++a)o[a].unbind(r)}bind(e,n){const i=this.behaviors;if(this.source!==e)if(this.source!==null){const s=this.source;this.source=e,this.context=n;for(let o=0,r=i.length;o<r;++o){const a=i[o];a.unbind(s),a.bind(e,n)}}else{this.source=e,this.context=n;for(let s=0,o=i.length;s<o;++s)i[s].bind(e,n)}}unbind(){if(this.source===null)return;const e=this.behaviors,n=this.source;for(let i=0,s=e.length;i<s;++i)e[i].unbind(n);this.source=null}static disposeContiguousBatch(e){if(e.length!==0){uo.setStartBefore(e[0].firstChild),uo.setEndAfter(e[e.length-1].lastChild),uo.deleteContents();for(let n=0,i=e.length;n<i;++n){const s=e[n],o=s.behaviors,r=s.source;for(let a=0,l=o.length;a<l;++a)o[a].unbind(r)}}}}class ka{constructor(e,n){this.behaviorCount=0,this.hasHostBehaviors=!1,this.fragment=null,this.targetOffset=0,this.viewBehaviorFactories=null,this.hostBehaviorFactories=null,this.html=e,this.directives=n}create(e){if(this.fragment===null){let c;const d=this.html;if(typeof d=="string"){c=document.createElement("template"),c.innerHTML=he.createHTML(d);const f=c.content.firstElementChild;f!==null&&f.tagName==="TEMPLATE"&&(c=f)}else c=d;const u=Bf(c,this.directives);this.fragment=u.fragment,this.viewBehaviorFactories=u.viewBehaviorFactories,this.hostBehaviorFactories=u.hostBehaviorFactories,this.targetOffset=u.targetOffset,this.behaviorCount=this.viewBehaviorFactories.length+this.hostBehaviorFactories.length,this.hasHostBehaviors=this.hostBehaviorFactories.length>0}const n=this.fragment.cloneNode(!0),i=this.viewBehaviorFactories,s=new Array(this.behaviorCount),o=he.createTemplateWalker(n);let r=0,a=this.targetOffset,l=o.nextNode();for(let c=i.length;r<c;++r){const d=i[r],u=d.targetIndex;for(;l!==null;)if(a===u){s[r]=d.createBehavior(l);break}else l=o.nextNode(),a++}if(this.hasHostBehaviors){const c=this.hostBehaviorFactories;for(let d=0,u=c.length;d<u;++d,++r)s[r]=c[d].createBehavior(e)}return new Pc(n,s)}render(e,n,i){typeof n=="string"&&(n=document.getElementById(n)),i===void 0&&(i=n);const s=this.create(i);return s.bind(e,Si),s.appendTo(n),s}}const Ff=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function ye(t,...e){const n=[];let i="";for(let s=0,o=t.length-1;s<o;++s){const r=t[s];let a=e[s];if(i+=r,a instanceof ka){const l=a;a=()=>l}if(typeof a=="function"&&(a=new yr(a)),a instanceof Rc){const l=Ff.exec(r);l!==null&&(a.targetName=l[2])}a instanceof js?(i+=a.createPlaceholder(n.length),n.push(a)):i+=a}return i+=t[t.length-1],new ka(i,n)}class it{constructor(){this.targets=new WeakSet}addStylesTo(e){this.targets.add(e)}removeStylesFrom(e){this.targets.delete(e)}isAttachedTo(e){return this.targets.has(e)}withBehaviors(...e){return this.behaviors=this.behaviors===null?e:this.behaviors.concat(e),this}}it.create=(()=>{if(he.supportsAdoptedStyleSheets){const t=new Map;return e=>new Lf(e,t)}return t=>new Vf(t)})();function wr(t){return t.map(e=>e instanceof it?wr(e.styles):[e]).reduce((e,n)=>e.concat(n),[])}function Mc(t){return t.map(e=>e instanceof it?e.behaviors:null).reduce((e,n)=>n===null?e:(e===null&&(e=[]),e.concat(n)),null)}class Lf extends it{constructor(e,n){super(),this.styles=e,this.styleSheetCache=n,this._styleSheets=void 0,this.behaviors=Mc(e)}get styleSheets(){if(this._styleSheets===void 0){const e=this.styles,n=this.styleSheetCache;this._styleSheets=wr(e).map(i=>{if(i instanceof CSSStyleSheet)return i;let s=n.get(i);return s===void 0&&(s=new CSSStyleSheet,s.replaceSync(i),n.set(i,s)),s})}return this._styleSheets}addStylesTo(e){e.adoptedStyleSheets=[...e.adoptedStyleSheets,...this.styleSheets],super.addStylesTo(e)}removeStylesFrom(e){const n=this.styleSheets;e.adoptedStyleSheets=e.adoptedStyleSheets.filter(i=>n.indexOf(i)===-1),super.removeStylesFrom(e)}}let Hf=0;function Nf(){return`fast-style-class-${++Hf}`}class Vf extends it{constructor(e){super(),this.styles=e,this.behaviors=null,this.behaviors=Mc(e),this.styleSheets=wr(e),this.styleClass=Nf()}addStylesTo(e){const n=this.styleSheets,i=this.styleClass;e=this.normalizeTarget(e);for(let s=0;s<n.length;s++){const o=document.createElement("style");o.innerHTML=n[s],o.className=i,e.append(o)}super.addStylesTo(e)}removeStylesFrom(e){e=this.normalizeTarget(e);const n=e.querySelectorAll(`.${this.styleClass}`);for(let i=0,s=n.length;i<s;++i)e.removeChild(n[i]);super.removeStylesFrom(e)}isAttachedTo(e){return super.isAttachedTo(this.normalizeTarget(e))}normalizeTarget(e){return e===document?document.body:e}}const $s=Object.freeze({locate:_c()}),Bc={toView(t){return t?"true":"false"},fromView(t){return!(t==null||t==="false"||t===!1||t===0)}},St={toView(t){if(t==null)return null;const e=t*1;return isNaN(e)?null:e.toString()},fromView(t){if(t==null)return null;const e=t*1;return isNaN(e)?null:e}};class Cs{constructor(e,n,i=n.toLowerCase(),s="reflect",o){this.guards=new Set,this.Owner=e,this.name=n,this.attribute=i,this.mode=s,this.converter=o,this.fieldName=`_${n}`,this.callbackName=`${n}Changed`,this.hasCallback=this.callbackName in e.prototype,s==="boolean"&&o===void 0&&(this.converter=Bc)}setValue(e,n){const i=e[this.fieldName],s=this.converter;s!==void 0&&(n=s.fromView(n)),i!==n&&(e[this.fieldName]=n,this.tryReflectToAttribute(e),this.hasCallback&&e[this.callbackName](i,n),e.$fastController.notify(this.name))}getValue(e){return ue.track(e,this.name),e[this.fieldName]}onAttributeChangedCallback(e,n){this.guards.has(e)||(this.guards.add(e),this.setValue(e,n),this.guards.delete(e))}tryReflectToAttribute(e){const n=this.mode,i=this.guards;i.has(e)||n==="fromView"||he.queueUpdate(()=>{i.add(e);const s=e[this.fieldName];switch(n){case"reflect":const o=this.converter;he.setAttribute(e,this.attribute,o!==void 0?o.toView(s):s);break;case"boolean":he.setBooleanAttribute(e,this.attribute,s);break}i.delete(e)})}static collect(e,...n){const i=[];n.push($s.locate(e));for(let s=0,o=n.length;s<o;++s){const r=n[s];if(r!==void 0)for(let a=0,l=r.length;a<l;++a){const c=r[a];typeof c=="string"?i.push(new Cs(e,c)):i.push(new Cs(e,c.property,c.attribute,c.mode,c.converter))}}return i}}function $(t,e){let n;function i(s,o){arguments.length>1&&(n.property=o),$s.locate(s.constructor).push(n)}if(arguments.length>1){n={},i(t,e);return}return n=t===void 0?{}:t,i}const Ta={mode:"open"},Sa={},No=Ni.getById(4,()=>{const t=new Map;return Object.freeze({register(e){return t.has(e.type)?!1:(t.set(e.type,e),!0)},getByType(e){return t.get(e)}})});class zs{constructor(e,n=e.definition){typeof n=="string"&&(n={name:n}),this.type=e,this.name=n.name,this.template=n.template;const i=Cs.collect(e,n.attributes),s=new Array(i.length),o={},r={};for(let a=0,l=i.length;a<l;++a){const c=i[a];s[a]=c.attribute,o[c.name]=c,r[c.attribute]=c}this.attributes=i,this.observedAttributes=s,this.propertyLookup=o,this.attributeLookup=r,this.shadowOptions=n.shadowOptions===void 0?Ta:n.shadowOptions===null?void 0:Object.assign(Object.assign({},Ta),n.shadowOptions),this.elementOptions=n.elementOptions===void 0?Sa:Object.assign(Object.assign({},Sa),n.elementOptions),this.styles=n.styles===void 0?void 0:Array.isArray(n.styles)?it.create(n.styles):n.styles instanceof it?n.styles:it.create([n.styles])}get isDefined(){return!!No.getByType(this.type)}define(e=customElements){const n=this.type;if(No.register(this)){const i=this.attributes,s=n.prototype;for(let o=0,r=i.length;o<r;++o)ue.defineProperty(s,i[o]);Reflect.defineProperty(n,"observedAttributes",{value:this.observedAttributes,enumerable:!0})}return e.get(this.name)||e.define(this.name,n,this.elementOptions),this}}zs.forType=No.getByType;const Fc=new WeakMap,jf={bubbles:!0,composed:!0,cancelable:!0};function ho(t){return t.shadowRoot||Fc.get(t)||null}class $r extends Ac{constructor(e,n){super(e),this.boundObservables=null,this.behaviors=null,this.needsInitialization=!0,this._template=null,this._styles=null,this._isConnected=!1,this.$fastController=this,this.view=null,this.element=e,this.definition=n;const i=n.shadowOptions;if(i!==void 0){const o=e.attachShadow(i);i.mode==="closed"&&Fc.set(e,o)}const s=ue.getAccessors(e);if(s.length>0){const o=this.boundObservables=Object.create(null);for(let r=0,a=s.length;r<a;++r){const l=s[r].name,c=e[l];c!==void 0&&(delete e[l],o[l]=c)}}}get isConnected(){return ue.track(this,"isConnected"),this._isConnected}setIsConnected(e){this._isConnected=e,ue.notify(this,"isConnected")}get template(){return this._template}set template(e){this._template!==e&&(this._template=e,this.needsInitialization||this.renderTemplate(e))}get styles(){return this._styles}set styles(e){this._styles!==e&&(this._styles!==null&&this.removeStyles(this._styles),this._styles=e,!this.needsInitialization&&e!==null&&this.addStyles(e))}addStyles(e){const n=ho(this.element)||this.element.getRootNode();if(e instanceof HTMLStyleElement)n.append(e);else if(!e.isAttachedTo(n)){const i=e.behaviors;e.addStylesTo(n),i!==null&&this.addBehaviors(i)}}removeStyles(e){const n=ho(this.element)||this.element.getRootNode();if(e instanceof HTMLStyleElement)n.removeChild(e);else if(e.isAttachedTo(n)){const i=e.behaviors;e.removeStylesFrom(n),i!==null&&this.removeBehaviors(i)}}addBehaviors(e){const n=this.behaviors||(this.behaviors=new Map),i=e.length,s=[];for(let o=0;o<i;++o){const r=e[o];n.has(r)?n.set(r,n.get(r)+1):(n.set(r,1),s.push(r))}if(this._isConnected){const o=this.element;for(let r=0;r<s.length;++r)s[r].bind(o,Si)}}removeBehaviors(e,n=!1){const i=this.behaviors;if(i===null)return;const s=e.length,o=[];for(let r=0;r<s;++r){const a=e[r];if(i.has(a)){const l=i.get(a)-1;l===0||n?i.delete(a)&&o.push(a):i.set(a,l)}}if(this._isConnected){const r=this.element;for(let a=0;a<o.length;++a)o[a].unbind(r)}}onConnectedCallback(){if(this._isConnected)return;const e=this.element;this.needsInitialization?this.finishInitialization():this.view!==null&&this.view.bind(e,Si);const n=this.behaviors;if(n!==null)for(const[i]of n)i.bind(e,Si);this.setIsConnected(!0)}onDisconnectedCallback(){if(!this._isConnected)return;this.setIsConnected(!1);const e=this.view;e!==null&&e.unbind();const n=this.behaviors;if(n!==null){const i=this.element;for(const[s]of n)s.unbind(i)}}onAttributeChangedCallback(e,n,i){const s=this.definition.attributeLookup[e];s!==void 0&&s.onAttributeChangedCallback(this.element,i)}emit(e,n,i){return this._isConnected?this.element.dispatchEvent(new CustomEvent(e,Object.assign(Object.assign({detail:n},jf),i))):!1}finishInitialization(){const e=this.element,n=this.boundObservables;if(n!==null){const s=Object.keys(n);for(let o=0,r=s.length;o<r;++o){const a=s[o];e[a]=n[a]}this.boundObservables=null}const i=this.definition;this._template===null&&(this.element.resolveTemplate?this._template=this.element.resolveTemplate():i.template&&(this._template=i.template||null)),this._template!==null&&this.renderTemplate(this._template),this._styles===null&&(this.element.resolveStyles?this._styles=this.element.resolveStyles():i.styles&&(this._styles=i.styles||null)),this._styles!==null&&this.addStyles(this._styles),this.needsInitialization=!1}renderTemplate(e){const n=this.element,i=ho(n)||n;this.view!==null?(this.view.dispose(),this.view=null):this.needsInitialization||he.removeChildNodes(i),e&&(this.view=e.render(n,i,n))}static forCustomElement(e){const n=e.$fastController;if(n!==void 0)return n;const i=zs.forType(e.constructor);if(i===void 0)throw new Error("Missing FASTElement definition.");return e.$fastController=new $r(e,i)}}function Ia(t){return class extends t{constructor(){super(),$r.forCustomElement(this)}$emit(e,n,i){return this.$fastController.emit(e,n,i)}connectedCallback(){this.$fastController.onConnectedCallback()}disconnectedCallback(){this.$fastController.onDisconnectedCallback()}attributeChangedCallback(e,n,i){this.$fastController.onAttributeChangedCallback(e,n,i)}}}const Us=Object.assign(Ia(HTMLElement),{from(t){return Ia(t)},define(t,e){return new zs(t,e).define().type}});class Lc{createCSS(){return""}createBehavior(){}}function zf(t,e){const n=[];let i="";const s=[];for(let o=0,r=t.length-1;o<r;++o){i+=t[o];let a=e[o];if(a instanceof Lc){const l=a.createBehavior();a=a.createCSS(),l&&s.push(l)}a instanceof it||a instanceof CSSStyleSheet?(i.trim()!==""&&(n.push(i),i=""),n.push(a)):i+=a}return i+=t[t.length-1],i.trim()!==""&&n.push(i),{styles:n,behaviors:s}}function De(t,...e){const{styles:n,behaviors:i}=zf(t,e),s=it.create(n);return i.length&&s.withBehaviors(...i),s}function wt(t,e,n){return{index:t,removed:e,addedCount:n}}const Hc=0,Nc=1,Vo=2,jo=3;function Uf(t,e,n,i,s,o){const r=o-s+1,a=n-e+1,l=new Array(r);let c,d;for(let u=0;u<r;++u)l[u]=new Array(a),l[u][0]=u;for(let u=0;u<a;++u)l[0][u]=u;for(let u=1;u<r;++u)for(let f=1;f<a;++f)t[e+f-1]===i[s+u-1]?l[u][f]=l[u-1][f-1]:(c=l[u-1][f]+1,d=l[u][f-1]+1,l[u][f]=c<d?c:d);return l}function qf(t){let e=t.length-1,n=t[0].length-1,i=t[e][n];const s=[];for(;e>0||n>0;){if(e===0){s.push(Vo),n--;continue}if(n===0){s.push(jo),e--;continue}const o=t[e-1][n-1],r=t[e-1][n],a=t[e][n-1];let l;r<a?l=r<o?r:o:l=a<o?a:o,l===o?(o===i?s.push(Hc):(s.push(Nc),i=o),e--,n--):l===r?(s.push(jo),e--,i=r):(s.push(Vo),n--,i=a)}return s.reverse(),s}function Wf(t,e,n){for(let i=0;i<n;++i)if(t[i]!==e[i])return i;return n}function Gf(t,e,n){let i=t.length,s=e.length,o=0;for(;o<n&&t[--i]===e[--s];)o++;return o}function Yf(t,e,n,i){return e<n||i<t?-1:e===n||i===t?0:t<n?e<i?e-n:i-n:i<e?i-t:e-t}function Vc(t,e,n,i,s,o){let r=0,a=0;const l=Math.min(n-e,o-s);if(e===0&&s===0&&(r=Wf(t,i,l)),n===t.length&&o===i.length&&(a=Gf(t,i,l-r)),e+=r,s+=r,n-=a,o-=a,n-e===0&&o-s===0)return In;if(e===n){const v=wt(e,[],0);for(;s<o;)v.removed.push(i[s++]);return[v]}else if(s===o)return[wt(e,[],n-e)];const c=qf(Uf(t,e,n,i,s,o)),d=[];let u,f=e,m=s;for(let v=0;v<c.length;++v)switch(c[v]){case Hc:u!==void 0&&(d.push(u),u=void 0),f++,m++;break;case Nc:u===void 0&&(u=wt(f,[],0)),u.addedCount++,f++,u.removed.push(i[m]),m++;break;case Vo:u===void 0&&(u=wt(f,[],0)),u.addedCount++,f++;break;case jo:u===void 0&&(u=wt(f,[],0)),u.removed.push(i[m]),m++;break}return u!==void 0&&d.push(u),d}const _a=Array.prototype.push;function Qf(t,e,n,i){const s=wt(e,n,i);let o=!1,r=0;for(let a=0;a<t.length;a++){const l=t[a];if(l.index+=r,o)continue;const c=Yf(s.index,s.index+s.removed.length,l.index,l.index+l.addedCount);if(c>=0){t.splice(a,1),a--,r-=l.addedCount-l.removed.length,s.addedCount+=l.addedCount-c;const d=s.removed.length+l.removed.length-c;if(!s.addedCount&&!d)o=!0;else{let u=l.removed;if(s.index<l.index){const f=s.removed.slice(0,l.index-s.index);_a.apply(f,u),u=f}if(s.index+s.removed.length>l.index+l.addedCount){const f=s.removed.slice(l.index+l.addedCount-s.index);_a.apply(u,f)}s.removed=u,l.index<s.index&&(s.index=l.index)}}else if(s.index<l.index){o=!0,t.splice(a,0,s),a++;const d=s.addedCount-s.removed.length;l.index+=d,r+=d}}o||t.push(s)}function Jf(t){const e=[];for(let n=0,i=t.length;n<i;n++){const s=t[n];Qf(e,s.index,s.removed,s.addedCount)}return e}function Xf(t,e){let n=[];const i=Jf(e);for(let s=0,o=i.length;s<o;++s){const r=i[s];if(r.addedCount===1&&r.removed.length===1){r.removed[0]!==t[r.index]&&n.push(r);continue}n=n.concat(Vc(t,r.index,r.index+r.addedCount,r.removed,0,r.removed.length))}return n}let Ea=!1;function fo(t,e){let n=t.index;const i=e.length;return n>i?n=i-t.addedCount:n<0&&(n=i+t.removed.length+n-t.addedCount),n<0&&(n=0),t.index=n,t}class Zf extends ws{constructor(e){super(e),this.oldCollection=void 0,this.splices=void 0,this.needsQueue=!0,this.call=this.flush,Reflect.defineProperty(e,"$fastController",{value:this,enumerable:!1})}subscribe(e){this.flush(),super.subscribe(e)}addSplice(e){this.splices===void 0?this.splices=[e]:this.splices.push(e),this.needsQueue&&(this.needsQueue=!1,he.queueUpdate(this))}reset(e){this.oldCollection=e,this.needsQueue&&(this.needsQueue=!1,he.queueUpdate(this))}flush(){const e=this.splices,n=this.oldCollection;if(e===void 0&&n===void 0)return;this.needsQueue=!0,this.splices=void 0,this.oldCollection=void 0;const i=n===void 0?Xf(this.source,e):Vc(this.source,0,this.source.length,n,0,n.length);this.notify(i)}}function Kf(){if(Ea)return;Ea=!0,ue.setArrayObserverFactory(l=>new Zf(l));const t=Array.prototype;if(t.$fastPatch)return;Reflect.defineProperty(t,"$fastPatch",{value:1,enumerable:!1});const e=t.pop,n=t.push,i=t.reverse,s=t.shift,o=t.sort,r=t.splice,a=t.unshift;t.pop=function(){const l=this.length>0,c=e.apply(this,arguments),d=this.$fastController;return d!==void 0&&l&&d.addSplice(wt(this.length,[c],0)),c},t.push=function(){const l=n.apply(this,arguments),c=this.$fastController;return c!==void 0&&c.addSplice(fo(wt(this.length-arguments.length,[],arguments.length),this)),l},t.reverse=function(){let l;const c=this.$fastController;c!==void 0&&(c.flush(),l=this.slice());const d=i.apply(this,arguments);return c!==void 0&&c.reset(l),d},t.shift=function(){const l=this.length>0,c=s.apply(this,arguments),d=this.$fastController;return d!==void 0&&l&&d.addSplice(wt(0,[c],0)),c},t.sort=function(){let l;const c=this.$fastController;c!==void 0&&(c.flush(),l=this.slice());const d=o.apply(this,arguments);return c!==void 0&&c.reset(l),d},t.splice=function(){const l=r.apply(this,arguments),c=this.$fastController;return c!==void 0&&c.addSplice(fo(wt(+arguments[0],l,arguments.length>2?arguments.length-2:0),this)),l},t.unshift=function(){const l=a.apply(this,arguments),c=this.$fastController;return c!==void 0&&c.addSplice(fo(wt(0,[],arguments.length),this)),l}}class ep{constructor(e,n){this.target=e,this.propertyName=n}bind(e){e[this.propertyName]=this.target}unbind(){}}function Ke(t){return new vr("fast-ref",ep,t)}function ks(t,e){const n=typeof e=="function"?e:()=>e;return(i,s)=>t(i,s)?n(i,s):null}function tp(t,e,n,i){t.bind(e[n],i)}function np(t,e,n,i){const s=Object.create(i);s.index=n,s.length=e.length,t.bind(e[n],s)}class ip{constructor(e,n,i,s,o,r){this.location=e,this.itemsBinding=n,this.templateBinding=s,this.options=r,this.source=null,this.views=[],this.items=null,this.itemsObserver=null,this.originalContext=void 0,this.childContext=void 0,this.bindView=tp,this.itemsBindingObserver=ue.binding(n,this,i),this.templateBindingObserver=ue.binding(s,this,o),r.positioning&&(this.bindView=np)}bind(e,n){this.source=e,this.originalContext=n,this.childContext=Object.create(n),this.childContext.parent=e,this.childContext.parentContext=this.originalContext,this.items=this.itemsBindingObserver.observe(e,this.originalContext),this.template=this.templateBindingObserver.observe(e,this.originalContext),this.observeItems(!0),this.refreshAllViews()}unbind(){this.source=null,this.items=null,this.itemsObserver!==null&&this.itemsObserver.unsubscribe(this),this.unbindAllViews(),this.itemsBindingObserver.disconnect(),this.templateBindingObserver.disconnect()}handleChange(e,n){e===this.itemsBinding?(this.items=this.itemsBindingObserver.observe(this.source,this.originalContext),this.observeItems(),this.refreshAllViews()):e===this.templateBinding?(this.template=this.templateBindingObserver.observe(this.source,this.originalContext),this.refreshAllViews(!0)):this.updateViews(n)}observeItems(e=!1){if(!this.items){this.items=In;return}const n=this.itemsObserver,i=this.itemsObserver=ue.getNotifier(this.items),s=n!==i;s&&n!==null&&n.unsubscribe(this),(s||e)&&i.subscribe(this)}updateViews(e){const n=this.childContext,i=this.views,s=this.bindView,o=this.items,r=this.template,a=this.options.recycle,l=[];let c=0,d=0;for(let u=0,f=e.length;u<f;++u){const m=e[u],v=m.removed;let b=0,A=m.index;const _=A+m.addedCount,F=i.splice(m.index,v.length),D=d=l.length+F.length;for(;A<_;++A){const J=i[A],Y=J?J.firstChild:this.location;let te;a&&d>0?(b<=D&&F.length>0?(te=F[b],b++):(te=l[c],c++),d--):te=r.create(),i.splice(A,0,te),s(te,o,A,n),te.insertBefore(Y)}F[b]&&l.push(...F.slice(b))}for(let u=c,f=l.length;u<f;++u)l[u].dispose();if(this.options.positioning)for(let u=0,f=i.length;u<f;++u){const m=i[u].context;m.length=f,m.index=u}}refreshAllViews(e=!1){const n=this.items,i=this.childContext,s=this.template,o=this.location,r=this.bindView;let a=n.length,l=this.views,c=l.length;if((a===0||e||!this.options.recycle)&&(Pc.disposeContiguousBatch(l),c=0),c===0){this.views=l=new Array(a);for(let d=0;d<a;++d){const u=s.create();r(u,n,d,i),l[d]=u,u.insertBefore(o)}}else{let d=0;for(;d<a;++d)if(d<c){const f=l[d];r(f,n,d,i)}else{const f=s.create();r(f,n,d,i),l.push(f),f.insertBefore(o)}const u=l.splice(d,c-d);for(d=0,a=u.length;d<a;++d)u[d].dispose()}}unbindAllViews(){const e=this.views;for(let n=0,i=e.length;n<i;++n)e[n].unbind()}}class jc extends js{constructor(e,n,i){super(),this.itemsBinding=e,this.templateBinding=n,this.options=i,this.createPlaceholder=he.createBlockPlaceholder,Kf(),this.isItemsBindingVolatile=ue.isVolatileBinding(e),this.isTemplateBindingVolatile=ue.isVolatileBinding(n)}createBehavior(e){return new ip(e,this.itemsBinding,this.isItemsBindingVolatile,this.templateBinding,this.isTemplateBindingVolatile,this.options)}}function Cr(t){return t?function(e,n,i){return e.nodeType===1&&e.matches(t)}:function(e,n,i){return e.nodeType===1}}class zc{constructor(e,n){this.target=e,this.options=n,this.source=null}bind(e){const n=this.options.property;this.shouldUpdate=ue.getAccessors(e).some(i=>i.name===n),this.source=e,this.updateTarget(this.computeNodes()),this.shouldUpdate&&this.observe()}unbind(){this.updateTarget(In),this.source=null,this.shouldUpdate&&this.disconnect()}handleEvent(){this.updateTarget(this.computeNodes())}computeNodes(){let e=this.getNodes();return this.options.filter!==void 0&&(e=e.filter(this.options.filter)),e}updateTarget(e){this.source[this.options.property]=e}}class sp extends zc{constructor(e,n){super(e,n)}observe(){this.target.addEventListener("slotchange",this)}disconnect(){this.target.removeEventListener("slotchange",this)}getNodes(){return this.target.assignedNodes(this.options)}}function mt(t){return typeof t=="string"&&(t={property:t}),new vr("fast-slotted",sp,t)}class op extends zc{constructor(e,n){super(e,n),this.observer=null,n.childList=!0}observe(){this.observer===null&&(this.observer=new MutationObserver(this.handleEvent.bind(this))),this.observer.observe(this.target,this.options)}disconnect(){this.observer.disconnect()}getNodes(){return"subtree"in this.options?Array.from(this.target.querySelectorAll(this.options.selector)):Array.from(this.target.childNodes)}}function Uc(t){return typeof t=="string"&&(t={property:t}),new vr("fast-children",op,t)}class oi{handleStartContentChange(){this.startContainer.classList.toggle("start",this.start.assignedNodes().length>0)}handleEndContentChange(){this.endContainer.classList.toggle("end",this.end.assignedNodes().length>0)}}const ri=(t,e)=>ye`
    <span
        part="end"
        ${Ke("endContainer")}
...
`;function g(t,e,n,i){var s=arguments.length,o=s<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,n):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,n,i);else for(var a=t.length-1;a>=0;a--)(r=t[a])&&(o=(s<3?r(o):s>3?r(e,n,o):r(e,n))||o);return s>3&&o&&Object.defineProperty(e,n,o),o}const po=new Map;"metadata"in Reflect||(Reflect.metadata=function(t,e){return function(n){Reflect.defineMetadata(t,e,n)}},Reflect.defineMetadata=function(t,e,n){let i=po.get(n);i===void 0&&po.set(n,i=new Map),i.set(t,e)},Reflect.getOwnMetadata=function(t,e){const n=po.get(e);if(n!==void 0)return n.get(t)});class rp{constructor(e,n){this.container=e,this.key=n}instance(e){return this.registerResolver(0,e)}singleton(e){return this.registerResolver(1,e)}transient(e){return this.registerResolver(2,e)}callback(e){return this.registerResolver(3,e)}cachedCallback(e){return this.registerResolver(3,Wc(e))}aliasTo(e){return this.registerResolver(5,e)}registerResolver(e,n){const{container:i,key:s}=this;return this.container=this.key=void 0,i.registerResolver(s,new ft(s,e,n))}}function pi(t){const e=t.slice(),n=Object.keys(t),i=n.length;let s;for(let o=0;o<i;++o)s=n[o],Gc(s)||(e[s]=t[s]);return e}const ap=Object.freeze({none(t){throw Error(`${t.toString()} not registered, did you forget to add @singleton()?`)},singleton(t){return new ft(t,1,t)},transient(t){return new ft(t,2,t)}}),go=Object.freeze({default:Object.freeze({parentLocator:()=>null,responsibleForOwnerRequests:!1,defaultResolver:ap.singleton})}),Oa=new Map;function Aa(t){return e=>Reflect.getOwnMetadata(t,e)}let Ra=null;const Re=Object.freeze({createContainer(t){return new Ii(null,Object.assign({},go.default,t))},findResponsibleContainer(t){const e=t.$$container$$;return e&&e.responsibleForOwnerRequests?e:Re.findParentContainer(t)},findParentContainer(t){const e=new CustomEvent(qc,{bubbles:!0,composed:!0,cancelable:!0,detail:{container:void 0}});return t.dispatchEvent(e),e.detail.container||Re.getOrCreateDOMContainer()},getOrCreateDOMContainer(t,e){return t?t.$$container$$||new Ii(t,Object.assign({},go.default,e,{parentLocator:Re.findParentContainer})):Ra||(Ra=new Ii(null,Object.assign({},go.default,e,{parentLocator:()=>null})))},getDesignParamtypes:Aa("design:paramtypes"),getAnnotationParamtypes:Aa("di:paramtypes"),getOrCreateAnnotationParamTypes(t){let e=this.getAnnotationParamtypes(t);return e===void 0&&Reflect.defineMetadata("di:paramtypes",e=[],t),e},getDependencies(t){let e=Oa.get(t);if(e===void 0){const n=t.inject;if(n===void 0){const i=Re.getDesignParamtypes(t),s=Re.getAnnotationParamtypes(t);if(i===void 0)if(s===void 0){const o=Object.getPrototypeOf(t);typeof o=="function"&&o!==Function.prototype?e=pi(Re.getDependencies(o)):e=[]}else e=pi(s);else if(s===void 0)e=pi(i);else{e=pi(i);let o=s.length,r;for(let c=0;c<o;++c)r=s[c],r!==void 0&&(e[c]=r);const a=Object.keys(s);o=a.length;let l;for(let c=0;c<o;++c)l=a[c],Gc(l)||(e[l]=s[l])}}else e=pi(n);Oa.set(t,e)}return e},defineProperty(t,e,n,i=!1){const s=`$di_${e}`;Reflect.defineProperty(t,e,{get:function(){let o=this[s];if(o===void 0&&(o=(this instanceof HTMLElement?Re.findResponsibleContainer(this):Re.getOrCreateDOMContainer()).get(n),this[s]=o,i&&this instanceof Us)){const a=this.$fastController,l=()=>{const d=Re.findResponsibleContainer(this).get(n),u=this[s];d!==u&&(this[s]=o,a.notify(e))};a.subscribe({handleChange:l},"isConnected")}return o}})},createInterface(t,e){const n=typeof t=="function"?t:e,i=typeof t=="string"?t:t&&"friendlyName"in t&&t.friendlyName||Ba,s=typeof t=="string"?!1:t&&"respectConnection"in t&&t.respectConnection||!1,o=function(r,a,l){if(r==null||new.target!==void 0)throw new Error(`No registration for interface: '${o.friendlyName}'`);if(a)Re.defineProperty(r,a,o,s);else{const c=Re.getOrCreateAnnotationParamTypes(r);c[l]=o}};return o.$isInterface=!0,o.friendlyName=i??"(anonymous)",n!=null&&(o.register=function(r,a){return n(new rp(r,a??o))}),o.toString=function(){return`InterfaceSymbol<${o.friendlyName}>`},o},inject(...t){return function(e,n,i){if(typeof i=="number"){const s=Re.getOrCreateAnnotationParamTypes(e),o=t[0];o!==void 0&&(s[i]=o)}else if(n)Re.defineProperty(e,n,t[0]);else{const s=i?Re.getOrCreateAnnotationParamTypes(i.value):Re.getOrCreateAnnotationParamTypes(e);let o;for(let r=0;r<t.length;++r)o=t[r],o!==void 0&&(s[r]=o)}}},transient(t){return t.register=function(n){return ji.transient(t,t).register(n)},t.registerInRequestor=!1,t},singleton(t,e=cp){return t.register=function(i){return ji.singleton(t,t).register(i)},t.registerInRequestor=e.scoped,t}}),lp=Re.createInterface("Container");Re.inject;const cp={scoped:!1};class ft{constructor(e,n,i){this.key=e,this.strategy=n,this.state=i,this.resolving=!1}get $isResolver(){return!0}register(e){return e.registerResolver(this.key,this)}resolve(e,n){switch(this.strategy){case 0:return this.state;case 1:{if(this.resolving)throw new Error(`Cyclic dependency found: ${this.state.name}`);return this.resolving=!0,this.state=e.getFactory(this.state).construct(n),this.strategy=0,this.resolving=!1,this.state}case 2:{const i=e.getFactory(this.state);if(i===null)throw new Error(`Resolver for ${String(this.key)} returned a null factory`);return i.construct(n)}case 3:return this.state(e,n,this);case 4:return this.state[0].resolve(e,n);case 5:return n.get(this.state);default:throw new Error(`Invalid resolver strategy specified: ${this.strategy}.`)}}getFactory(e){var n,i,s;switch(this.strategy){case 1:case 2:return e.getFactory(this.state);case 5:return(s=(i=(n=e.getResolver(this.state))===null||n===void 0?void 0:n.getFactory)===null||i===void 0?void 0:i.call(n,e))!==null&&s!==void 0?s:null;default:return null}}}function Da(t){return this.get(t)}function dp(t,e){return e(t)}class up{constructor(e,n){this.Type=e,this.dependencies=n,this.transformers=null}construct(e,n){let i;return n===void 0?i=new this.Type(...this.dependencies.map(Da,e)):i=new this.Type(...this.dependencies.map(Da,e),...n),this.transformers==null?i:this.transformers.reduce(dp,i)}registerTransformer(e){(this.transformers||(this.transformers=[])).push(e)}}const hp={$isResolver:!0,resolve(t,e){return e}};function fs(t){return typeof t.register=="function"}function fp(t){return fs(t)&&typeof t.registerInRequestor=="boolean"}function Pa(t){return fp(t)&&t.registerInRequestor}function pp(t){return t.prototype!==void 0}const gp=new Set(["Array","ArrayBuffer","Boolean","DataView","Date","Error","EvalError","Float32Array","Float64Array","Function","Int8Array","Int16Array","Int32Array","Map","Number","Object","Promise","RangeError","ReferenceError","RegExp","Set","SharedArrayBuffer","String","SyntaxError","TypeError","Uint8Array","Uint8ClampedArray","Uint16Array","Uint32Array","URIError","WeakMap","WeakSet"]),qc="__DI_LOCATE_PARENT__",mo=new Map;class Ii{constructor(e,n){this.owner=e,this.config=n,this._parent=void 0,this.registerDepth=0,this.context=null,e!==null&&(e.$$container$$=this),this.resolvers=new Map,this.resolvers.set(lp,hp),e instanceof Node&&e.addEventListener(qc,i=>{i.composedPath()[0]!==this.owner&&(i.detail.container=this,i.stopImmediatePropagation())})}get parent(){return this._parent===void 0&&(this._parent=this.config.parentLocator(this.owner)),this._parent}get depth(){return this.parent===null?0:this.parent.depth+1}get responsibleForOwnerRequests(){return this.config.responsibleForOwnerRequests}registerWithContext(e,...n){return this.context=e,this.register(...n),this.context=null,this}register(...e){if(++this.registerDepth===100)throw new Error("Unable to autoregister dependency");let n,i,s,o,r;const a=this.context;for(let l=0,c=e.length;l<c;++l)if(n=e[l],!!Fa(n))if(fs(n))n.register(this,a);else if(pp(n))ji.singleton(n,n).register(this);else for(i=Object.keys(n),o=0,r=i.length;o<r;++o)s=n[i[o]],Fa(s)&&(fs(s)?s.register(this,a):this.register(s));return--this.registerDepth,this}registerResolver(e,n){is(e);const i=this.resolvers,s=i.get(e);return s==null?i.set(e,n):s instanceof ft&&s.strategy===4?s.state.push(n):i.set(e,new ft(e,4,[s,n])),n}registerTransformer(e,n){const i=this.getResolver(e);if(i==null)return!1;if(i.getFactory){const s=i.getFactory(this);return s==null?!1:(s.registerTransformer(n),!0)}return!1}getResolver(e,n=!0){if(is(e),e.resolve!==void 0)return e;let i=this,s;for(;i!=null;)if(s=i.resolvers.get(e),s==null){if(i.parent==null){const o=Pa(e)?this:i;return n?this.jitRegister(e,o):null}i=i.parent}else return s;return null}has(e,n=!1){return this.resolvers.has(e)?!0:n&&this.parent!=null?this.parent.has(e,!0):!1}get(e){if(is(e),e.$isResolver)return e.resolve(this,this);let n=this,i;for(;n!=null;)if(i=n.resolvers.get(e),i==null){if(n.parent==null){const s=Pa(e)?this:n;return i=this.jitRegister(e,s),i.resolve(n,this)}n=n.parent}else return i.resolve(n,this);throw new Error(`Unable to resolve key: ${e}`)}getAll(e,n=!1){is(e);const i=this;let s=i,o;if(n){let r=In;for(;s!=null;)o=s.resolvers.get(e),o!=null&&(r=r.concat(Ma(o,s,i))),s=s.parent;return r}else for(;s!=null;)if(o=s.resolvers.get(e),o==null){if(s=s.parent,s==null)return In}else return Ma(o,s,i);return In}getFactory(e){let n=mo.get(e);if(n===void 0){if(mp(e))throw new Error(`${e.name} is a native function and therefore cannot be safely constructed by DI. If this is intentional, please use a callback or cachedCallback resolver.`);mo.set(e,n=new up(e,Re.getDependencies(e)))}return n}registerFactory(e,n){mo.set(e,n)}createChild(e){return new Ii(null,Object.assign({},this.config,e,{parentLocator:()=>this}))}jitRegister(e,n){if(typeof e!="function")throw new Error(`Attempted to jitRegister something that is not a constructor: '${e}'. Did you forget to register this dependency?`);if(gp.has(e.name))throw new Error(`Attempted to jitRegister an intrinsic type: ${e.name}. Did you forget to add @inject(Key)`);if(fs(e)){const i=e.register(n);if(!(i instanceof Object)||i.resolve==null){const s=n.resolvers.get(e);if(s!=null)return s;throw new Error("A valid resolver was not returned from the static register method")}return i}else{if(e.$isInterface)throw new Error(`Attempted to jitRegister an interface: ${e.friendlyName}`);{const i=this.config.defaultResolver(e,n);return n.resolvers.set(e,i),i}}}}const bo=new WeakMap;function Wc(t){return function(e,n,i){if(bo.has(i))return bo.get(i);const s=t(e,n,i);return bo.set(i,s),s}}const ji=Object.freeze({instance(t,e){return new ft(t,0,e)},singleton(t,e){return new ft(t,1,e)},transient(t,e){return new ft(t,2,e)},callback(t,e){return new ft(t,3,e)},cachedCallback(t,e){return new ft(t,3,Wc(e))},aliasTo(t,e){return new ft(e,5,t)}});function is(t){if(t==null)throw new Error("key/value cannot be null or undefined. Are you trying to inject/register something that doesn't exist with DI?")}function Ma(t,e,n){if(t instanceof ft&&t.strategy===4){const i=t.state;let s=i.length;const o=new Array(s);for(;s--;)o[s]=i[s].resolve(e,n);return o}return[t.resolve(e,n)]}const Ba="(anonymous)";function Fa(t){return typeof t=="object"&&t!==null||typeof t=="function"}const mp=function(){const t=new WeakMap;let e=!1,n="",i=0;return function(s){return e=t.get(s),e===void 0&&(n=s.toString(),i=n.length,e=i>=29&&i<=100&&n.charCodeAt(i-1)===125&&n.charCodeAt(i-2)<=32&&n.charCodeAt(i-3)===93&&n.charCodeAt(i-4)===101&&n.charCodeAt(i-5)===100&&n.charCodeAt(i-6)===111&&n.charCodeAt(i-7)===99&&n.charCodeAt(i-8)===32&&n.charCodeAt(i-9)===101&&n.charCodeAt(i-10)===118&&n.charCodeAt(i-11)===105&&n.charCodeAt(i-12)===116&&n.charCodeAt(i-13)===97&&n.charCodeAt(i-14)===110&&n.charCodeAt(i-15)===88,t.set(s,e)),e}}(),ss={};function Gc(t){switch(typeof t){case"number":return t>=0&&(t|0)===t;case"string":{const e=ss[t];if(e!==void 0)return e;const n=t.length;if(n===0)return ss[t]=!1;let i=0;for(let s=0;s<n;++s)if(i=t.charCodeAt(s),s===0&&i===48&&n>1||i<48||i>57)return ss[t]=!1;return ss[t]=!0}default:return!1}}function La(t){return`${t.toLowerCase()}:presentation`}const os=new Map,Yc=Object.freeze({define(t,e,n){const i=La(t);os.get(i)===void 0?os.set(i,e):os.set(i,!1),n.register(ji.instance(i,e))},forTag(t,e){const n=La(t),i=os.get(n);return i===!1?Re.findResponsibleContainer(e).get(n):i||null}});class bp{constructor(e,n){this.template=e||null,this.styles=n===void 0?null:Array.isArray(n)?it.create(n):n instanceof it?n:it.create([n])}applyTo(e){const n=e.$fastController;n.template===null&&(n.template=this.template),n.styles===null&&(n.styles=this.styles)}}class Ee extends Us{constructor(){super(...arguments),this._presentation=void 0}get $presentation(){return this._presentation===void 0&&(this._presentation=Yc.forTag(this.tagName,this)),this._presentation}templateChanged(){this.template!==void 0&&(this.$fastController.template=this.template)}stylesChanged(){this.styles!==void 0&&(this.$fastController.styles=this.styles)}connectedCallback(){this.$presentation!==null&&this.$presentation.applyTo(this),super.connectedCallback()}static compose(e){return(n={})=>new vp(this===Ee?class extends Ee{}:this,e,n)}}g([U],Ee.prototype,"template",void 0);g([U],Ee.prototype,"styles",void 0);function gi(t,e,n){return typeof t=="function"?t(e,n):t}class vp{constructor(e,n,i){this.type=e,this.elementDefinition=n,this.overrideDefinition=i,this.definition=Object.assign(Object.assign({},this.elementDefinition),this.overrideDefinition)}register(e,n){const i=this.definition,s=this.overrideDefinition,r=`${i.prefix||n.elementPrefix}-${i.baseName}`;n.tryDefineElement({name:r,type:this.type,baseClass:this.elementDefinition.baseClass,callback:a=>{const l=new bp(gi(i.template,a,i),gi(i.styles,a,i));a.definePresentation(l);let c=gi(i.shadowOptions,a,i);a.shadowRootMode&&(c?s.shadowOptions||(c.mode=a.shadowRootMode):c!==null&&(c={mode:a.shadowRootMode})),a.defineElement({elementOptions:gi(i.elementOptions,a,i),shadowOptions:c,attributes:gi(i.attributes,a,i)})}})}}function ot(t,...e){const n=$s.locate(t);e.forEach(i=>{Object.getOwnPropertyNames(i.prototype).forEach(o=>{o!=="constructor"&&Object.defineProperty(t.prototype,o,Object.getOwnPropertyDescriptor(i.prototype,o))}),$s.locate(i).forEach(o=>n.push(o))})}const kr={horizontal:"horizontal",vertical:"vertical"};function yp(t,e){let n=t.length;for(;n--;)if(e(t[n],n,t))return n;return-1}function xp(){return!!(typeof window<"u"&&window.document&&window.document.createElement)}function wp(...t){return t.every(e=>e instanceof HTMLElement)}function $p(){const t=document.querySelector('meta[property="csp-nonce"]');return t?t.getAttribute("content"):null}let vn;function Cp(){if(typeof vn=="boolean")return vn;if(!xp())return vn=!1,vn;const t=document.createElement("style"),e=$p();e!==null&&t.setAttribute("nonce",e),document.head.appendChild(t);try{t.sheet.insertRule("foo:focus-visible {color:inherit}",0),vn=!0}catch{vn=!1}finally{document.head.removeChild(t)}return vn}const Ha="focus",Na="focusin",Qn="focusout",Jn="keydown";var Va;(function(t){t[t.alt=18]="alt",t[t.arrowDown=40]="arrowDown",t[t.arrowLeft=37]="arrowLeft",t[t.arrowRight=39]="arrowRight",t[t.arrowUp=38]="arrowUp",t[t.back=8]="back",t[t.backSlash=220]="backSlash",t[t.break=19]="break",t[t.capsLock=20]="capsLock",t[t.closeBracket=221]="closeBracket",t[t.colon=186]="colon",t[t.colon2=59]="colon2",t[t.comma=188]="comma",t[t.ctrl=17]="ctrl",t[t.delete=46]="delete",t[t.end=35]="end",t[t.enter=13]="enter",t[t.equals=187]="equals",t[t.equals2=61]="equals2",t[t.equals3=107]="equals3",t[t.escape=27]="escape",t[t.forwardSlash=191]="forwardSlash",t[t.function1=112]="function1",t[t.function10=121]="function10",t[t.function11=122]="function11",t[t.function12=123]="function12",t[t.function2=113]="function2",t[t.function3=114]="function3",t[t.function4=115]="function4",t[t.function5=116]="function5",t[t.function6=117]="function6",t[t.function7=118]="function7",t[t.function8=119]="function8",t[t.function9=120]="function9",t[t.home=36]="home",t[t.insert=45]="insert",t[t.menu=93]="menu",t[t.minus=189]="minus",t[t.minus2=109]="minus2",t[t.numLock=144]="numLock",t[t.numPad0=96]="numPad0",t[t.numPad1=97]="numPad1",t[t.numPad2=98]="numPad2",t[t.numPad3=99]="numPad3",t[t.numPad4=100]="numPad4",t[t.numPad5=101]="numPad5",t[t.numPad6=102]="numPad6",t[t.numPad7=103]="numPad7",t[t.numPad8=104]="numPad8",t[t.numPad9=105]="numPad9",t[t.numPadDivide=111]="numPadDivide",t[t.numPadDot=110]="numPadDot",t[t.numPadMinus=109]="numPadMinus",t[t.numPadMultiply=106]="numPadMultiply",t[t.numPadPlus=107]="numPadPlus",t[t.openBracket=219]="openBracket",t[t.pageDown=34]="pageDown",t[t.pageUp=33]="pageUp",t[t.period=190]="period",t[t.print=44]="print",t[t.quote=222]="quote",t[t.scrollLock=145]="scrollLock",t[t.shift=16]="shift",t[t.space=32]="space",t[t.tab=9]="tab",t[t.tilde=192]="tilde",t[t.windowsLeft=91]="windowsLeft",t[t.windowsOpera=219]="windowsOpera",t[t.windowsRight=92]="windowsRight"})(Va||(Va={}));const _n="ArrowDown",zi="ArrowLeft",Ui="ArrowRight",En="ArrowUp",Gi="Enter",qs="Escape",li="Home",ci="End",kp="F2",Tp="PageDown",Sp="PageUp",Yi=" ",Tr="Tab",Ip={ArrowDown:_n,ArrowLeft:zi,ArrowRight:Ui,ArrowUp:En};var Xn;(function(t){t.ltr="ltr",t.rtl="rtl"})(Xn||(Xn={}));function _p(t,e,n){return n<t?e:n>e?t:n}function rs(t,e,n=0){return[e,n]=[e,n].sort((i,s)=>i-s),e<=t&&t<n}let Ep=0;function Ts(t=""){return`${t}${Ep++}`}const Op=(t,e)=>ye`
    <a
        class="control"
        part="control"
...
`;let hn=class extends Ee{constructor(){super(...arguments),this.cellType=Qt.default,this.rowData=null,this.columnDefinition=null,this.isActiveCell=!1,this.customCellView=null,this.updateCellStyle=()=>{this.style.gridColumn=this.gridColumn}}cellTypeChanged(){this.$fastController.isConnected&&this.updateCellView()}gridColumnChanged(){this.$fastController.isConnected&&this.updateCellStyle()}columnDefinitionChanged(e,n){this.$fastController.isConnected&&this.updateCellView()}connectedCallback(){var e;super.connectedCallback(),this.addEventListener(Na,this.handleFocusin),this.addEventListener(Qn,this.handleFocusout),this.addEventListener(Jn,this.handleKeydown),this.style.gridColumn=`${((e=this.columnDefinition)===null||e===void 0?void 0:e.gridColumn)===void 0?0:this.columnDefinition.gridColumn}`,this.updateCellView(),this.updateCellStyle()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(Na,this.handleFocusin),this.removeEventListener(Qn,this.handleFocusout),this.removeEventListener(Jn,this.handleKeydown),this.disconnectCellView()}handleFocusin(e){if(!this.isActiveCell){switch(this.isActiveCell=!0,this.cellType){case Qt.columnHeader:if(this.columnDefinition!==null&&this.columnDefinition.headerCellInternalFocusQueue!==!0&&typeof this.columnDefinition.headerCellFocusTargetCallback=="function"){const n=this.columnDefinition.headerCellFocusTargetCallback(this);n!==null&&n.focus()}break;default:if(this.columnDefinition!==null&&this.columnDefinition.cellInternalFocusQueue!==!0&&typeof this.columnDefinition.cellFocusTargetCallback=="function"){const n=this.columnDefinition.cellFocusTargetCallback(this);n!==null&&n.focus()}break}this.$emit("cell-focused",this)}}handleFocusout(e){this!==document.activeElement&&!this.contains(document.activeElement)&&(this.isActiveCell=!1)}handleKeydown(e){if(!(e.defaultPrevented||this.columnDefinition===null||this.cellType===Qt.default&&this.columnDefinition.cellInternalFocusQueue!==!0||this.cellType===Qt.columnHeader&&this.columnDefinition.headerCellInternalFocusQueue!==!0))switch(e.key){case Gi:case kp:if(this.contains(document.activeElement)&&document.activeElement!==this)return;switch(this.cellType){case Qt.columnHeader:if(this.columnDefinition.headerCellFocusTargetCallback!==void 0){const n=this.columnDefinition.headerCellFocusTargetCallback(this);n!==null&&n.focus(),e.preventDefault()}break;default:if(this.columnDefinition.cellFocusTargetCallback!==void 0){const n=this.columnDefinition.cellFocusTargetCallback(this);n!==null&&n.focus(),e.preventDefault()}break}break;case qs:this.contains(document.activeElement)&&document.activeElement!==this&&(this.focus(),e.preventDefault());break}}updateCellView(){if(this.disconnectCellView(),this.columnDefinition!==null)switch(this.cellType){case Qt.columnHeader:this.columnDefinition.headerCellTemplate!==void 0?this.customCellView=this.columnDefinition.headerCellTemplate.render(this,this):this.customCellView=Lp.render(this,this);break;case void 0:case Qt.rowHeader:case Qt.default:this.columnDefinition.cellTemplate!==void 0?this.customCellView=this.columnDefinition.cellTemplate.render(this,this):this.customCellView=Fp.render(this,this);break}}disconnectCellView(){this.customCellView!==null&&(this.customCellView.dispose(),this.customCellView=null)}};g([$({attribute:"cell-type"})],hn.prototype,"cellType",void 0);g([$({attribute:"grid-column"})],hn.prototype,"gridColumn",void 0);g([U],hn.prototype,"rowData",void 0);g([U],hn.prototype,"columnDefinition",void 0);function Hp(t){const e=t.tagFor(hn);return ye`
    ...
    ></${e}>
`}function Np(t){const e=t.tagFor(hn);return ye`
    <${e}
        cell-type="columnheader"
        grid-column="${(n,i)=>i.index+1}"
        :columnDefinition="${n=>n}"
    ></${e}>
`}const Vp=(t,e)=>{const n=Hp(t),i=Np(t);return ye`
        <template
            role="row"
...
`;class ui extends Ee{constructor(){super(...arguments),this.percentComplete=0}valueChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}minChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}maxChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}connectedCallback(){super.connectedCallback(),this.updatePercentComplete()}updatePercentComplete(){const e=typeof this.min=="number"?this.min:0,n=typeof this.max=="number"?this.max:100,i=typeof this.value=="number"?this.value:0,s=n-e;this.percentComplete=s===0?0:Math.fround((i-e)/s*100)}}g([$({converter:St})],ui.prototype,"value",void 0);g([$({converter:St})],ui.prototype,"min",void 0);g([$({converter:St})],ui.prototype,"max",void 0);g([$({mode:"boolean"})],ui.prototype,"paused",void 0);g([U],ui.prototype,"percentComplete",void 0);const hg=(t,e)=>ye`
    <template
        role="radiogroup"
        aria-disabled="${n=>n.disabled}"
        aria-readonly="${n=>n.readOnly}"
...
`;class wg extends Ee{}const $g=(t,e)=>ye`
    <template slot="tab" role="tab" aria-disabled="${n=>n.disabled}">
        <slot></slot>
    </template>
`;class nd extends Ee{}g([$({mode:"boolean"})],nd.prototype,"disabled",void 0);const Cg=(t,e)=>ye`
...
`,Ig=(t,e)=>ye`
    ...
    >
        ...
        >
            <slot
                ${mt({property:"defaultSlottedNodes",filter:mg})}
            ></slot>
        </label>
...
`,dn="not-allowed",_g=":host([hidden]){display:none}";function Qe(t){return`${_g}:host{display:${t}}`}const Ge=Cp()?"focus-visible":"focus";function Ar(t){return ed.getOrCreate(t).withPrefix("vscode")}function Eg(t){window.addEventListener("load",()=>{new MutationObserver(()=>{Ga(t)}).observe(document.body,{attributes:!0,attributeFilter:["class"]}),Ga(t)})}function Ga(t){const e=getComputedStyle(document.body),n=document.querySelector("body");if(n){const i=n.getAttribute("data-vscode-theme-kind");for(const[s,o]of t){let r=e.getPropertyValue(s).toString();i==="vscode-high-contrast"?(r.length===0&&o.name.includes("background")&&(r="transparent"),o.name==="button-icon-hover-background"&&(r="transparent")):o.name==="contrast-active-border"&&(r="transparent"),o.setValueFor(n,r)}}}const Ya=new Map;let Qa=!1;function j(t,e){const n=Kc.create(t);if(e){if(e.includes("--fake-vscode-token")){const i="id"+Math.random().toString(16).slice(2);e=`${e}-${i}`}Ya.set(e,n)}return Qa||(Eg(Ya),Qa=!0),n}const Og=j("background","--vscode-editor-background").withDefault("#1e1e1e"),pe=j("border-width").withDefault(1),sd=j("contrast-active-border","--vscode-contrastActiveBorder").withDefault("#f38518");j("contrast-border","--vscode-contrastBorder").withDefault("#6fc3df");const zt=j("corner-radius").withDefault(0),ie=j("design-unit").withDefault(4),An=j("disabled-opacity").withDefault(.4),_e=j("focus-border","--vscode-focusBorder").withDefault("#007fd4"),bt=j("font-family","--vscode-font-family").withDefault("-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol");j("font-weight","--vscode-font-weight").withDefault("400");const We=j("foreground","--vscode-foreground").withDefault("#cccccc"),gs=j("input-height").withDefault("26"),Rr=j("input-min-width").withDefault("100px"),et=j("type-ramp-base-font-size","--vscode-font-size").withDefault("13px"),st=j("type-ramp-base-line-height").withDefault("normal"),od=j("type-ramp-minus1-font-size").withDefault("11px"),rd=j("type-ramp-minus1-line-height").withDefault("16px");j("type-ramp-minus2-font-size").withDefault("9px");j("type-ramp-minus2-line-height").withDefault("16px");j("type-ramp-plus1-font-size").withDefault("16px");j("type-ramp-plus1-line-height").withDefault("24px");const Ag=j("scrollbarWidth").withDefault("10px"),Rg=j("scrollbarHeight").withDefault("10px"),Dg=j("scrollbar-slider-background","--vscode-scrollbarSlider-background").withDefault("#79797966"),Pg=j("scrollbar-slider-hover-background","--vscode-scrollbarSlider-hoverBackground").withDefault("#646464b3"),Mg=j("scrollbar-slider-active-background","--vscode-scrollbarSlider-activeBackground").withDefault("#bfbfbf66"),ad=j("badge-background","--vscode-badge-background").withDefault("#4d4d4d"),ld=j("badge-foreground","--vscode-badge-foreground").withDefault("#ffffff"),Dr=j("button-border","--vscode-button-border").withDefault("transparent"),Ja=j("button-icon-background").withDefault("transparent"),Bg=j("button-icon-corner-radius").withDefault("5px"),Fg=j("button-icon-outline-offset").withDefault(0),Xa=j("button-icon-hover-background","--fake-vscode-token").withDefault("rgba(90, 93, 94, 0.31)"),Lg=j("button-icon-padding").withDefault("3px"),Un=j("button-primary-background","--vscode-button-background").withDefault("#0e639c"),cd=j("button-primary-foreground","--vscode-button-foreground").withDefault("#ffffff"),dd=j("button-primary-hover-background","--vscode-button-hoverBackground").withDefault("#1177bb"),$o=j("button-secondary-background","--vscode-button-secondaryBackground").withDefault("#3a3d41"),Hg=j("button-secondary-foreground","--vscode-button-secondaryForeground").withDefault("#ffffff"),Ng=j("button-secondary-hover-background","--vscode-button-secondaryHoverBackground").withDefault("#45494e"),Vg=j("button-padding-horizontal").withDefault("11px"),jg=j("button-padding-vertical").withDefault("4px"),Ht=j("checkbox-background","--vscode-checkbox-background").withDefault("#3c3c3c"),Hn=j("checkbox-border","--vscode-checkbox-border").withDefault("#3c3c3c"),zg=j("checkbox-corner-radius").withDefault(3);j("checkbox-foreground","--vscode-checkbox-foreground").withDefault("#f0f0f0");const Cn=j("list-active-selection-background","--vscode-list-activeSelectionBackground").withDefault("#094771"),qn=j("list-active-selection-foreground","--vscode-list-activeSelectionForeground").withDefault("#ffffff"),Ug=j("list-hover-background","--vscode-list-hoverBackground").withDefault("#2a2d2e"),qg=j("divider-background","--vscode-settings-dropdownListBorder").withDefault("#454545"),ls=j("dropdown-background","--vscode-dropdown-background").withDefault("#3c3c3c"),rn=j("dropdown-border","--vscode-dropdown-border").withDefault("#3c3c3c");j("dropdown-foreground","--vscode-dropdown-foreground").withDefault("#f0f0f0");const Wg=j("dropdown-list-max-height").withDefault("200px"),kn=j("input-background","--vscode-input-background").withDefault("#3c3c3c"),ud=j("input-foreground","--vscode-input-foreground").withDefault("#cccccc");j("input-placeholder-foreground","--vscode-input-placeholderForeground").withDefault("#cccccc");const Za=j("link-active-foreground","--vscode-textLink-activeForeground").withDefault("#3794ff"),Gg=j("link-foreground","--vscode-textLink-foreground").withDefault("#3794ff"),Yg=j("progress-background","--vscode-progressBar-background").withDefault("#0e70c0"),Qg=j("panel-tab-active-border","--vscode-panelTitle-activeBorder").withDefault("#e7e7e7"),Mn=j("panel-tab-active-foreground","--vscode-panelTitle-activeForeground").withDefault("#e7e7e7"),Jg=j("panel-tab-foreground","--vscode-panelTitle-inactiveForeground").withDefault("#e7e7e799");j("panel-view-background","--vscode-panel-background").withDefault("#1e1e1e");j("panel-view-border","--vscode-panel-border").withDefault("#80808059");const Xg=j("tag-corner-radius").withDefault("2px"),Zg=(t,e)=>De`
...
`;class Kg extends Qi{connectedCallback(){super.connectedCallback(),this.circular||(this.circular=!0)}}const oy=Kg.compose({baseName:"badge",template:Qc,styles:Zg}),em=De`
	${Qe("inline-flex")} :host {
		outline: none;
		font-family: ${bt};
		font-size: ${et};
...
`;class rm extends Gs{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const am=rm.compose({baseName:"checkbox",template:zp,styles:om,checkedIndicator:`
		<svg 
...
`;class um extends ze{connectedCallback(){super.connectedCallback(),this.getAttribute("aria-label")||this.setAttribute("aria-label","Data Grid")}}const ry=um.compose({baseName:"data-grid",baseClass:ze,template:Bp,styles:lm});class hm extends Ye{}const ay=hm.compose({baseName:"data-grid-row",baseClass:Ye,template:Vp,styles:cm});class fm extends hn{}const ly=fm.compose({baseName:"data-grid-cell",baseClass:hn,template:jp,styles:dm}),pm=(t,e)=>De`
	${Qe("block")} :host {
		border: none;
		border-top: calc(${pe} * 1px) solid ${qg};
		box-sizing: content-box;
		height: 0;
		margin: calc(${ie} * 1px) 0;
		width: 100%;
	}
`;class gm extends _r{}const cy=gm.compose({baseName:"divider",template:og,styles:pm}),mm=(t,e)=>De`
	${Qe("inline-flex")} :host {
		background: ${ls};
		box-sizing: border-box;
		color: ${We};
...
`;class bm extends pn{}const dy=bm.compose({baseName:"dropdown",template:yg,styles:mm,indicator:`
		<svg 
...
`;class ym extends It{}const uy=ym.compose({baseName:"link",template:Op,styles:vm,shadowOptions:{delegatesFocus:!0}}),xm=(t,e)=>De`
	${Qe("inline-flex")} :host {
...
`;let wm=class extends qt{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}};const fy=wm.compose({baseName:"option",template:ag,styles:xm}),$m=(t,e)=>De`
	${Qe("grid")} :host {
		box-sizing: border-box;
		font-family: ${bt};
		font-size: ${et};
...
`;class Tm extends Wt{connectedCallback(){super.connectedCallback(),this.orientation&&(this.orientation=Uo.horizontal),this.getAttribute("aria-label")||this.setAttribute("aria-label","Panels")}}const py=Tm.compose({baseName:"panels",template:Cg,styles:$m});class Sm extends nd{connectedCallback(){super.connectedCallback(),this.disabled&&(this.disabled=!1),this.textContent&&this.setAttribute("aria-label",this.textContent)}}const gy=Sm.compose({baseName:"panel-tab",template:$g,styles:Cm});class Im extends wg{}const my=Im.compose({baseName:"panel-view",template:xg,styles:km}),_m=(t,e)=>De`
	${Qe("flex")} :host {
		align-items: center;
		outline: none;
		height: calc(${ie} * 7px);
...
`;class Em extends ui{connectedCallback(){super.connectedCallback(),this.paused&&(this.paused=!1),this.setAttribute("aria-label","Loading"),this.setAttribute("aria-live","assertive"),this.setAttribute("role","alert")}attributeChangedCallback(e,n,i){e==="value"&&this.removeAttribute("value")}}const Om=Em.compose({baseName:"progress-ring",template:ug,styles:_m,indeterminateIndicator:`
...
`;class Rm extends fn{connectedCallback(){super.connectedCallback();const e=this.querySelector("label");if(e){const n="radio-group-"+Math.random().toString(16).slice(2);e.setAttribute("id",n),this.setAttribute("aria-labelledby",n)}}}const by=Rm.compose({baseName:"radio-group",template:hg,styles:Am}),Dm=(t,e)=>De`
	${Qe("inline-flex")} :host {
		align-items: center;
		flex-direction: row;
		font-size: ${et};
...
`;class Pm extends Qs{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Radio")}}const vy=Pm.compose({baseName:"radio",template:fg,styles:Dm,checkedIndicator:`
...
`;class Bm extends Qi{connectedCallback(){super.connectedCallback(),this.circular&&(this.circular=!1)}}const yy=Bm.compose({baseName:"tag",template:Qc,styles:Mm}),Fm=(t,e)=>De`
	${Qe("inline-block")} :host {
		font-family: ${bt};
		outline: none;
		user-select: none;
...
`;class Lm extends tt{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const xy=Lm.compose({baseName:"text-area",template:Sg,styles:Fm,shadowOptions:{delegatesFocus:!0}}),Hm=(t,e)=>De`
	${Qe("inline-block")} :host {
		font-family: ${bt};
		outline: none;
		user-select: none;
...
`;class Nm extends dt{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const Vm=Nm.compose({baseName:"text-field",template:Ig,styles:Hm,shadowOptions:{delegatesFocus:!0}}),jm={key:0,id:"notifications"},zm={class:"message"},Um={class:"level"},qm={class:"message"},Wm={class:"buttons"},Gm=un({__name:"Notifications",setup(t){Ar().register(fd());const e=["Error","Warning","Info"],n=si(),i=Me(()=>n.notifications[0]),s=Me(()=>e[i.value.level]),o=Me(()=>i.value.message);return(r,a)=>$e(i)?(Ne(),Ue("div",jm,[fe("div",null,[fe("div",zm,[fe("div",Um,Dt($e(s)),1),fe("div",qm,Dt($e(o)),1)]),fe("div",Wm,[fe("vscode-button",{onClick:a[0]||(a[0]=l=>$e(n).notifications.splice(0,1))}," Okay "),fe("vscode-button",{appearance:"secondary",onClick:a[1]||(a[1]=l=>$e(xt).postMessage("openLog"))}," Open Log ")])])])):tn("",!0)}});const Ym="carsakiller",Qm="LLS-Addons",Jm="addons",Xm="https://github.com/LuaLS/vscode-lua-webvue/discussions",Zm={class:"content"},Km={key:0,id:"dev-warn"},eb={class:"versions"},tb={title:"WebVue Version"},nb={title:"Lua Extension Version"},ib=["href"],sb=un({__name:"App",setup(t){const e=si(),n=!1,i="0.1.1",s=()=>xt.postMessage("openLog");return(o,r)=>{const a=Ku("RouterView");return Ne(),Ue("div",Zm,[ke(a),ke(Gm),fe("footer",null,[$e(n)?(Ne(),Ue("div",Km,"Development Mode Active")):tn("",!0),fe("span",eb,[fe("span",tb,[ke(Nt,{icon:"preview"}),xs(" v"+Dt($e(i)),1)]),fe("span",nb,[ke(Nt,{icon:"server"}),xs("v"+Dt($e(e).clientVersion),1)])]),fe("span",null,[fe("a",{href:$e(Xm),target:"_blank",rel:"nofollow noreferrer noopener external",title:"Feedback"},[ke(Nt,{icon:"feedback"})],8,ib),fe("button",{onClick:s,title:"Open Log File",role:"Open Log File"},[ke(Nt,{icon:"output"})])])])])}}});const Bn=typeof window<"u";function ob(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const we=Object.assign;function Co(t,e){const n={};for(const i in e){const s=e[i];n[i]=Tt(s)?s.map(t):t(s)}return n}const Ei=()=>{},Tt=Array.isArray,rb=/\/$/,ab=t=>t.replace(rb,"");function ko(t,e,n="/"){let i,s={},o="",r="";const a=e.indexOf("#");let l=e.indexOf("?");return a<l&&a>=0&&(l=-1),l>-1&&(i=e.slice(0,l),o=e.slice(l+1,a>-1?a:e.length),s=t(o)),a>-1&&(i=i||e.slice(0,a),r=e.slice(a,e.length)),i=ub(i??e,n),{fullPath:i+(o&&"?")+o+r,path:i,query:s,hash:r}}function lb(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Ka(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function cb(t,e,n){const i=e.matched.length-1,s=n.matched.length-1;return i>-1&&i===s&&Zn(e.matched[i],n.matched[s])&&pd(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Zn(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function pd(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!db(t[n],e[n]))return!1;return!0}function db(t,e){return Tt(t)?el(t,e):Tt(e)?el(e,t):t===e}function el(t,e){return Tt(e)?t.length===e.length&&t.every((n,i)=>n===e[i]):t.length===1&&t[0]===e}function ub(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),i=t.split("/");let s=n.length-1,o,r;for(o=0;o<i.length;o++)if(r=i[o],r!==".")if(r==="..")s>1&&s--;else break;return n.slice(0,s).join("/")+"/"+i.slice(o-(o===i.length?1:0)).join("/")}var qi;(function(t){t.pop="pop",t.push="push"})(qi||(qi={}));var Oi;(function(t){t.back="back",t.forward="forward",t.unknown=""})(Oi||(Oi={}));function hb(t){if(!t)if(Bn){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),ab(t)}const fb=/^[^#]+#/;function pb(t,e){return t.replace(fb,"#")+e}function gb(t,e){const n=document.documentElement.getBoundingClientRect(),i=t.getBoundingClientRect();return{behavior:e.behavior,left:i.left-n.left-(e.left||0),top:i.top-n.top-(e.top||0)}}const Js=()=>({left:window.pageXOffset,top:window.pageYOffset});function mb(t){let e;if("el"in t){const n=t.el,i=typeof n=="string"&&n.startsWith("#"),s=typeof n=="string"?i?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!s)return;e=gb(s,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function tl(t,e){return(history.state?history.state.position-e:-1)+t}const qo=new Map;function bb(t,e){qo.set(t,e)}function vb(t){const e=qo.get(t);return qo.delete(t),e}let yb=()=>location.protocol+"//"+location.host;function gd(t,e){const{pathname:n,search:i,hash:s}=e,o=t.indexOf("#");if(o>-1){let a=s.includes(t.slice(o))?t.slice(o).length:1,l=s.slice(a);return l[0]!=="/"&&(l="/"+l),Ka(l,"")}return Ka(n,t)+i+s}function xb(t,e,n,i){let s=[],o=[],r=null;const a=({state:f})=>{const m=gd(t,location),v=n.value,b=e.value;let A=0;if(f){if(n.value=m,e.value=f,r&&r===v){r=null;return}A=b?f.position-b.position:0}else i(m);s.forEach(_=>{_(n.value,v,{delta:A,type:qi.pop,direction:A?A>0?Oi.forward:Oi.back:Oi.unknown})})};function l(){r=n.value}function c(f){s.push(f);const m=()=>{const v=s.indexOf(f);v>-1&&s.splice(v,1)};return o.push(m),m}function d(){const{history:f}=window;!f.state||f.replaceState(we({},f.state,{scroll:Js()}),"")}function u(){for(const f of o)f();o=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",d)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",d),{pauseListeners:l,listen:c,destroy:u}}function nl(t,e,n,i=!1,s=!1){return{back:t,current:e,forward:n,replaced:i,position:window.history.length,scroll:s?Js():null}}function wb(t){const{history:e,location:n}=window,i={value:gd(t,n)},s={value:e.state};s.value||o(i.value,{back:null,current:i.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function o(l,c,d){const u=t.indexOf("#"),f=u>-1?(n.host&&document.querySelector("base")?t:t.slice(u))+l:yb()+t+l;try{e[d?"replaceState":"pushState"](c,"",f),s.value=c}catch(m){console.error(m),n[d?"replace":"assign"](f)}}function r(l,c){const d=we({},e.state,nl(s.value.back,l,s.value.forward,!0),c,{position:s.value.position});o(l,d,!0),i.value=l}function a(l,c){const d=we({},s.value,e.state,{forward:l,scroll:Js()});o(d.current,d,!0);const u=we({},nl(i.value,l,null),{position:d.position+1},c);o(l,u,!1),i.value=l}return{location:i,state:s,push:a,replace:r}}function $b(t){t=hb(t);const e=wb(t),n=xb(t,e.state,e.location,e.replace);function i(o,r=!0){r||n.pauseListeners(),history.go(o)}const s=we({location:"",base:t,go:i,createHref:pb.bind(null,t)},e,n);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>e.state.value}),s}function Cb(t){return t=location.host?t||location.pathname+location.search:"",t.includes("#")||(t+="#"),$b(t)}function kb(t){return typeof t=="string"||t&&typeof t=="object"}function md(t){return typeof t=="string"||typeof t=="symbol"}const Jt={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},bd=Symbol("");var il;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(il||(il={}));function Kn(t,e){return we(new Error,{type:t,[bd]:!0},e)}function Bt(t,e){return t instanceof Error&&bd in t&&(e==null||!!(t.type&e))}const sl="[^/]+?",Tb={sensitive:!1,strict:!1,start:!0,end:!0},Sb=/[.+*?^${}()[\]/\\]/g;function Ib(t,e){const n=we({},Tb,e),i=[];let s=n.start?"^":"";const o=[];for(const c of t){const d=c.length?[]:[90];n.strict&&!c.length&&(s+="/");for(let u=0;u<c.length;u++){const f=c[u];let m=40+(n.sensitive?.25:0);if(f.type===0)u||(s+="/"),s+=f.value.replace(Sb,"\\$&"),m+=40;else if(f.type===1){const{value:v,repeatable:b,optional:A,regexp:_}=f;o.push({name:v,repeatable:b,optional:A});const F=_||sl;if(F!==sl){m+=10;try{new RegExp(`(${F})`)}catch(J){throw new Error(`Invalid custom RegExp for param "${v}" (${F}): `+J.message)}}let D=b?`((?:${F})(?:/(?:${F}))*)`:`(${F})`;u||(D=A&&c.length<2?`(?:/${D})`:"/"+D),A&&(D+="?"),s+=D,m+=20,A&&(m+=-8),b&&(m+=-20),F===".*"&&(m+=-50)}d.push(m)}i.push(d)}if(n.strict&&n.end){const c=i.length-1;i[c][i[c].length-1]+=.7000000000000001}n.strict||(s+="/?"),n.end?s+="$":n.strict&&(s+="(?:/|$)");const r=new RegExp(s,n.sensitive?"":"i");function a(c){const d=c.match(r),u={};if(!d)return null;for(let f=1;f<d.length;f++){const m=d[f]||"",v=o[f-1];u[v.name]=m&&v.repeatable?m.split("/"):m}return u}function l(c){let d="",u=!1;for(const f of t){(!u||!d.endsWith("/"))&&(d+="/"),u=!1;for(const m of f)if(m.type===0)d+=m.value;else if(m.type===1){const{value:v,repeatable:b,optional:A}=m,_=v in c?c[v]:"";if(Tt(_)&&!b)throw new Error(`Provided param "${v}" is an array but it is not repeatable (* or + modifiers)`);const F=Tt(_)?_.join("/"):_;if(!F)if(A)f.length<2&&(d.endsWith("/")?d=d.slice(0,-1):u=!0);else throw new Error(`Missing required param "${v}"`);d+=F}}return d||"/"}return{re:r,score:i,keys:o,parse:a,stringify:l}}function _b(t,e){let n=0;for(;n<t.length&&n<e.length;){const i=e[n]-t[n];if(i)return i;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function Eb(t,e){let n=0;const i=t.score,s=e.score;for(;n<i.length&&n<s.length;){const o=_b(i[n],s[n]);if(o)return o;n++}if(Math.abs(s.length-i.length)===1){if(ol(i))return 1;if(ol(s))return-1}return s.length-i.length}function ol(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const Ob={type:0,value:""},Ab=/[a-zA-Z0-9_]/;function Rb(t){if(!t)return[[]];if(t==="/")return[[Ob]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(m){throw new Error(`ERR (${n})/"${c}": ${m}`)}let n=0,i=n;const s=[];let o;function r(){o&&s.push(o),o=[]}let a=0,l,c="",d="";function u(){!c||(n===0?o.push({type:0,value:c}):n===1||n===2||n===3?(o.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),o.push({type:1,value:c,regexp:d,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),c="")}function f(){c+=l}for(;a<t.length;){if(l=t[a++],l==="\\"&&n!==2){i=n,n=4;continue}switch(n){case 0:l==="/"?(c&&u(),r()):l===":"?(u(),n=1):f();break;case 4:f(),n=i;break;case 1:l==="("?n=2:Ab.test(l)?f():(u(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?d[d.length-1]=="\\"?d=d.slice(0,-1)+l:n=3:d+=l;break;case 3:u(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,d="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${c}"`),u(),r(),s}function Db(t,e,n){const i=Ib(Rb(t.path),n),s=we(i,{record:t,parent:e,children:[],alias:[]});return e&&!s.record.aliasOf==!e.record.aliasOf&&e.children.push(s),s}function Pb(t,e){const n=[],i=new Map;e=ll({strict:!1,end:!0,sensitive:!1},e);function s(d){return i.get(d)}function o(d,u,f){const m=!f,v=Mb(d);v.aliasOf=f&&f.record;const b=ll(e,d),A=[v];if("alias"in d){const D=typeof d.alias=="string"?[d.alias]:d.alias;for(const J of D)A.push(we({},v,{components:f?f.record.components:v.components,path:J,aliasOf:f?f.record:v}))}let _,F;for(const D of A){const{path:J}=D;if(u&&J[0]!=="/"){const Y=u.record.path,te=Y[Y.length-1]==="/"?"":"/";D.path=u.record.path+(J&&te+J)}if(_=Db(D,u,b),f?f.alias.push(_):(F=F||_,F!==_&&F.alias.push(_),m&&d.name&&!al(_)&&r(d.name)),v.children){const Y=v.children;for(let te=0;te<Y.length;te++)o(Y[te],_,f&&f.children[te])}f=f||_,(_.record.components&&Object.keys(_.record.components).length||_.record.name||_.record.redirect)&&l(_)}return F?()=>{r(F)}:Ei}function r(d){if(md(d)){const u=i.get(d);u&&(i.delete(d),n.splice(n.indexOf(u),1),u.children.forEach(r),u.alias.forEach(r))}else{const u=n.indexOf(d);u>-1&&(n.splice(u,1),d.record.name&&i.delete(d.record.name),d.children.forEach(r),d.alias.forEach(r))}}function a(){return n}function l(d){let u=0;for(;u<n.length&&Eb(d,n[u])>=0&&(d.record.path!==n[u].record.path||!vd(d,n[u]));)u++;n.splice(u,0,d),d.record.name&&!al(d)&&i.set(d.record.name,d)}function c(d,u){let f,m={},v,b;if("name"in d&&d.name){if(f=i.get(d.name),!f)throw Kn(1,{location:d});b=f.record.name,m=we(rl(u.params,f.keys.filter(F=>!F.optional).map(F=>F.name)),d.params&&rl(d.params,f.keys.map(F=>F.name))),v=f.stringify(m)}else if("path"in d)v=d.path,f=n.find(F=>F.re.test(v)),f&&(m=f.parse(v),b=f.record.name);else{if(f=u.name?i.get(u.name):n.find(F=>F.re.test(u.path)),!f)throw Kn(1,{location:d,currentLocation:u});b=f.record.name,m=we({},u.params,d.params),v=f.stringify(m)}const A=[];let _=f;for(;_;)A.unshift(_.record),_=_.parent;return{name:b,path:v,params:m,matched:A,meta:Fb(A)}}return t.forEach(d=>o(d)),{addRoute:o,resolve:c,removeRoute:r,getRoutes:a,getRecordMatcher:s}}function rl(t,e){const n={};for(const i of e)i in t&&(n[i]=t[i]);return n}function Mb(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:Bb(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function Bb(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const i in t.components)e[i]=typeof n=="boolean"?n:n[i];return e}function al(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function Fb(t){return t.reduce((e,n)=>we(e,n.meta),{})}function ll(t,e){const n={};for(const i in t)n[i]=i in e?e[i]:t[i];return n}function vd(t,e){return e.children.some(n=>n===t||vd(t,n))}const yd=/#/g,Lb=/&/g,Hb=/\//g,Nb=/=/g,Vb=/\?/g,xd=/\+/g,jb=/%5B/g,zb=/%5D/g,wd=/%5E/g,Ub=/%60/g,$d=/%7B/g,qb=/%7C/g,Cd=/%7D/g,Wb=/%20/g;function Pr(t){return encodeURI(""+t).replace(qb,"|").replace(jb,"[").replace(zb,"]")}function Gb(t){return Pr(t).replace($d,"{").replace(Cd,"}").replace(wd,"^")}function Wo(t){return Pr(t).replace(xd,"%2B").replace(Wb,"+").replace(yd,"%23").replace(Lb,"%26").replace(Ub,"`").replace($d,"{").replace(Cd,"}").replace(wd,"^")}function Yb(t){return Wo(t).replace(Nb,"%3D")}function Qb(t){return Pr(t).replace(yd,"%23").replace(Vb,"%3F")}function Jb(t){return t==null?"":Qb(t).replace(Hb,"%2F")}function Ss(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function Xb(t){const e={};if(t===""||t==="?")return e;const i=(t[0]==="?"?t.slice(1):t).split("&");for(let s=0;s<i.length;++s){const o=i[s].replace(xd," "),r=o.indexOf("="),a=Ss(r<0?o:o.slice(0,r)),l=r<0?null:Ss(o.slice(r+1));if(a in e){let c=e[a];Tt(c)||(c=e[a]=[c]),c.push(l)}else e[a]=l}return e}function cl(t){let e="";for(let n in t){const i=t[n];if(n=Yb(n),i==null){i!==void 0&&(e+=(e.length?"&":"")+n);continue}(Tt(i)?i.map(o=>o&&Wo(o)):[i&&Wo(i)]).forEach(o=>{o!==void 0&&(e+=(e.length?"&":"")+n,o!=null&&(e+="="+o))})}return e}function Zb(t){const e={};for(const n in t){const i=t[n];i!==void 0&&(e[n]=Tt(i)?i.map(s=>s==null?null:""+s):i==null?i:""+i)}return e}const Kb=Symbol(""),dl=Symbol(""),Mr=Symbol(""),kd=Symbol(""),Go=Symbol("");function yi(){let t=[];function e(i){return t.push(i),()=>{const s=t.indexOf(i);s>-1&&t.splice(s,1)}}function n(){t=[]}return{add:e,list:()=>t,reset:n}}function en(t,e,n,i,s){const o=i&&(i.enterCallbacks[s]=i.enterCallbacks[s]||[]);return()=>new Promise((r,a)=>{const l=u=>{u===!1?a(Kn(4,{from:n,to:e})):u instanceof Error?a(u):kb(u)?a(Kn(2,{from:e,to:u})):(o&&i.enterCallbacks[s]===o&&typeof u=="function"&&o.push(u),r())},c=t.call(i&&i.instances[s],e,n,l);let d=Promise.resolve(c);t.length<3&&(d=d.then(l)),d.catch(u=>a(u))})}function To(t,e,n,i){const s=[];for(const o of t)for(const r in o.components){let a=o.components[r];if(!(e!=="beforeRouteEnter"&&!o.instances[r]))if(ev(a)){const c=(a.__vccOpts||a)[e];c&&s.push(en(c,n,i,o,r))}else{let l=a();s.push(()=>l.then(c=>{if(!c)return Promise.reject(new Error(`Couldn't resolve component "${r}" at "${o.path}"`));const d=ob(c)?c.default:c;o.components[r]=d;const f=(d.__vccOpts||d)[e];return f&&en(f,n,i,o,r)()}))}}return s}function ev(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function ul(t){const e=Pt(Mr),n=Pt(kd),i=Me(()=>e.resolve($e(t.to))),s=Me(()=>{const{matched:l}=i.value,{length:c}=l,d=l[c-1],u=n.matched;if(!d||!u.length)return-1;const f=u.findIndex(Zn.bind(null,d));if(f>-1)return f;const m=hl(l[c-2]);return c>1&&hl(d)===m&&u[u.length-1].path!==m?u.findIndex(Zn.bind(null,l[c-2])):f}),o=Me(()=>s.value>-1&&sv(n.params,i.value.params)),r=Me(()=>s.value>-1&&s.value===n.matched.length-1&&pd(n.params,i.value.params));function a(l={}){return iv(l)?e[$e(t.replace)?"replace":"push"]($e(t.to)).catch(Ei):Promise.resolve()}return{route:i,href:Me(()=>i.value.href),isActive:o,isExactActive:r,navigate:a}}const tv=un({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:ul,setup(t,{slots:e}){const n=ii(ul(t)),{options:i}=Pt(Mr),s=Me(()=>({[fl(t.activeClass,i.linkActiveClass,"router-link-active")]:n.isActive,[fl(t.exactActiveClass,i.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const o=e.default&&e.default(n);return t.custom?o:mc("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},o)}}}),nv=tv;function iv(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function sv(t,e){for(const n in e){const i=e[n],s=t[n];if(typeof i=="string"){if(i!==s)return!1}else if(!Tt(s)||s.length!==i.length||i.some((o,r)=>o!==s[r]))return!1}return!0}function hl(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const fl=(t,e,n)=>t??e??n,ov=un({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const i=Pt(Go),s=Me(()=>t.route||i.value),o=Pt(dl,0),r=Me(()=>{let c=$e(o);const{matched:d}=s.value;let u;for(;(u=d[c])&&!u.components;)c++;return c}),a=Me(()=>s.value.matched[r.value]);ds(dl,Me(()=>r.value+1)),ds(Kb,a),ds(Go,s);const l=Di();return wi(()=>[l.value,a.value,t.name],([c,d,u],[f,m,v])=>{d&&(d.instances[u]=c,m&&m!==d&&c&&c===f&&(d.leaveGuards.size||(d.leaveGuards=m.leaveGuards),d.updateGuards.size||(d.updateGuards=m.updateGuards))),c&&d&&(!m||!Zn(d,m)||!f)&&(d.enterCallbacks[u]||[]).forEach(b=>b(c))},{flush:"post"}),()=>{const c=s.value,d=t.name,u=a.value,f=u&&u.components[d];if(!f)return pl(n.default,{Component:f,route:c});const m=u.props[d],v=m?m===!0?c.params:typeof m=="function"?m(c):m:null,A=mc(f,we({},v,e,{onVnodeUnmounted:_=>{_.component.isUnmounted&&(u.instances[d]=null)},ref:l}));return pl(n.default,{Component:A,route:c})||A}}});function pl(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const rv=ov;function av(t){const e=Pb(t.routes,t),n=t.parseQuery||Xb,i=t.stringifyQuery||cl,s=t.history,o=yi(),r=yi(),a=yi(),l=yu(Jt);let c=Jt;Bn&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const d=Co.bind(null,x=>""+x),u=Co.bind(null,Jb),f=Co.bind(null,Ss);function m(x,B){let R,W;return md(x)?(R=e.getRecordMatcher(x),W=B):W=x,e.addRoute(W,R)}function v(x){const B=e.getRecordMatcher(x);B&&e.removeRoute(B)}function b(){return e.getRoutes().map(x=>x.record)}function A(x){return!!e.getRecordMatcher(x)}function _(x,B){if(B=we({},B||l.value),typeof x=="string"){const h=ko(n,x,B.path),p=e.resolve({path:h.path},B),y=s.createHref(h.fullPath);return we(h,p,{params:f(p.params),hash:Ss(h.hash),redirectedFrom:void 0,href:y})}let R;if("path"in x)R=we({},x,{path:ko(n,x.path,B.path).path});else{const h=we({},x.params);for(const p in h)h[p]==null&&delete h[p];R=we({},x,{params:u(x.params)}),B.params=u(B.params)}const W=e.resolve(R,B),ne=x.hash||"";W.params=d(f(W.params));const ve=lb(i,we({},x,{hash:Gb(ne),path:W.path})),re=s.createHref(ve);return we({fullPath:ve,hash:ne,query:i===cl?Zb(x.query):x.query||{}},W,{redirectedFrom:void 0,href:re})}function F(x){return typeof x=="string"?ko(n,x,l.value.path):we({},x)}function D(x,B){if(c!==x)return Kn(8,{from:B,to:x})}function J(x){return ee(x)}function Y(x){return J(we(F(x),{replace:!0}))}function te(x){const B=x.matched[x.matched.length-1];if(B&&B.redirect){const{redirect:R}=B;let W=typeof R=="function"?R(x):R;return typeof W=="string"&&(W=W.includes("?")||W.includes("#")?W=F(W):{path:W},W.params={}),we({query:x.query,hash:x.hash,params:"path"in W?{}:x.params},W)}}function ee(x,B){const R=c=_(x),W=l.value,ne=x.state,ve=x.force,re=x.replace===!0,h=te(R);if(h)return ee(we(F(h),{state:typeof h=="object"?we({},ne,h.state):ne,force:ve,replace:re}),B||R);const p=R;p.redirectedFrom=B;let y;return!ve&&cb(i,W,R)&&(y=Kn(16,{to:p,from:W}),ce(W,W,!0,!1)),(y?Promise.resolve(y):Q(p,W)).catch(w=>Bt(w)?Bt(w,2)?w:X(w):S(w,p,W)).then(w=>{if(w){if(Bt(w,2))return ee(we({replace:re},F(w.to),{state:typeof w.to=="object"?we({},ne,w.to.state):ne,force:ve}),B||p)}else w=xe(p,W,!0,re,ne);return q(p,W,w),w})}function M(x,B){const R=D(x,B);return R?Promise.reject(R):Promise.resolve()}function Q(x,B){let R;const[W,ne,ve]=lv(x,B);R=To(W.reverse(),"beforeRouteLeave",x,B);for(const h of W)h.leaveGuards.forEach(p=>{R.push(en(p,x,B))});const re=M.bind(null,x,B);return R.push(re),Pn(R).then(()=>{R=[];for(const h of o.list())R.push(en(h,x,B));return R.push(re),Pn(R)}).then(()=>{R=To(ne,"beforeRouteUpdate",x,B);for(const h of ne)h.updateGuards.forEach(p=>{R.push(en(p,x,B))});return R.push(re),Pn(R)}).then(()=>{R=[];for(const h of x.matched)if(h.beforeEnter&&!B.matched.includes(h))if(Tt(h.beforeEnter))for(const p of h.beforeEnter)R.push(en(p,x,B));else R.push(en(h.beforeEnter,x,B));return R.push(re),Pn(R)}).then(()=>(x.matched.forEach(h=>h.enterCallbacks={}),R=To(ve,"beforeRouteEnter",x,B),R.push(re),Pn(R))).then(()=>{R=[];for(const h of r.list())R.push(en(h,x,B));return R.push(re),Pn(R)}).catch(h=>Bt(h,8)?h:Promise.reject(h))}function q(x,B,R){for(const W of a.list())W(x,B,R)}function xe(x,B,R,W,ne){const ve=D(x,B);if(ve)return ve;const re=B===Jt,h=Bn?history.state:{};R&&(W||re?s.replace(x.fullPath,we({scroll:re&&h&&h.scroll},ne)):s.push(x.fullPath,ne)),l.value=x,ce(x,B,R,re),X()}let z;function L(){z||(z=s.listen((x,B,R)=>{if(!rt.listening)return;const W=_(x),ne=te(W);if(ne){ee(we(ne,{replace:!0}),W).catch(Ei);return}c=W;const ve=l.value;Bn&&bb(tl(ve.fullPath,R.delta),Js()),Q(W,ve).catch(re=>Bt(re,12)?re:Bt(re,2)?(ee(re.to,W).then(h=>{Bt(h,20)&&!R.delta&&R.type===qi.pop&&s.go(-1,!1)}).catch(Ei),Promise.reject()):(R.delta&&s.go(-R.delta,!1),S(re,W,ve))).then(re=>{re=re||xe(W,ve,!1),re&&(R.delta&&!Bt(re,8)?s.go(-R.delta,!1):R.type===qi.pop&&Bt(re,20)&&s.go(-1,!1)),q(W,ve,re)}).catch(Ei)}))}let I=yi(),T=yi(),V;function S(x,B,R){X(x);const W=T.list();return W.length?W.forEach(ne=>ne(x,B,R)):console.error(x),Promise.reject(x)}function N(){return V&&l.value!==Jt?Promise.resolve():new Promise((x,B)=>{I.add([x,B])})}function X(x){return V||(V=!x,L(),I.list().forEach(([B,R])=>x?R(x):B()),I.reset()),x}function ce(x,B,R,W){const{scrollBehavior:ne}=t;if(!Bn||!ne)return Promise.resolve();const ve=!R&&vb(tl(x.fullPath,0))||(W||!R)&&history.state&&history.state.scroll||null;return lr().then(()=>ne(x,B,ve)).then(re=>re&&mb(re)).catch(re=>S(re,x,B))}const be=x=>s.go(x);let le;const Ae=new Set,rt={currentRoute:l,listening:!0,addRoute:m,removeRoute:v,hasRoute:A,getRoutes:b,resolve:_,options:t,push:J,replace:Y,go:be,back:()=>be(-1),forward:()=>be(1),beforeEach:o.add,beforeResolve:r.add,afterEach:a.add,onError:T.add,isReady:N,install(x){const B=this;x.component("RouterLink",nv),x.component("RouterView",rv),x.config.globalProperties.$router=B,Object.defineProperty(x.config.globalProperties,"$route",{enumerable:!0,get:()=>$e(l)}),Bn&&!le&&l.value===Jt&&(le=!0,J(s.location).catch(ne=>{}));const R={};for(const ne in Jt)R[ne]=Me(()=>l.value[ne]);x.provide(Mr,B),x.provide(kd,ii(R)),x.provide(Go,l);const W=x.unmount;Ae.add(x),x.unmount=function(){Ae.delete(x),Ae.size<1&&(c=Jt,z&&z(),z=null,l.value=Jt,le=!1,V=!1),W()}}};return rt}function Pn(t){return t.reduce((e,n)=>e.then(()=>n()),Promise.resolve())}function lv(t,e){const n=[],i=[],s=[],o=Math.max(e.matched.length,t.matched.length);for(let r=0;r<o;r++){const a=e.matched[r];a&&(t.matched.find(c=>Zn(c,a))?i.push(a):n.push(a));const l=t.matched[r];l&&(e.matched.find(c=>Zn(c,l))||s.push(l))}return[n,i,s]}const Xs=Sc("addons",{state:()=>({loading:!0,addons:[],page:1,total:null}),getters:{sortedByName(t){return[...t.addons].sort((e,n)=>{var o,r;if(e.hasUpdate)return-1;const i=e.displayName??e.name,s=n.displayName??n.name;return Number((o=n.enabled)==null?void 0:o.some(a=>a))-Number((r=e.enabled)==null?void 0:r.some(a=>a))+Number(n.installed)-Number(e.installed)+i.localeCompare(s)*.9})}},actions:{getPage(){xt.postMessage("getAddons",{page:this.page}),this.page++},refresh(){this.page=1,xt.postMessage("refreshAddons"),this.getPage()},getAddon(t){return this.addons.find(e=>e.name===t)}}});var Br=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},Td={exports:{}};(function(t,e){(function(n,i){t.exports=i()})(Br,function(){var n=1e3,i=6e4,s=36e5,o="millisecond",r="second",a="minute",l="hour",c="day",d="week",u="month",f="quarter",m="year",v="date",b="Invalid Date",A=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,_=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,F={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(L){var I=["th","st","nd","rd"],T=L%100;return"["+L+(I[(T-20)%10]||I[T]||I[0])+"]"}},D=function(L,I,T){var V=String(L);return!V||V.length>=I?L:""+Array(I+1-V.length).join(T)+L},J={s:D,z:function(L){var I=-L.utcOffset(),T=Math.abs(I),V=Math.floor(T/60),S=T%60;return(I<=0?"+":"-")+D(V,2,"0")+":"+D(S,2,"0")},m:function L(I,T){if(I.date()<T.date())return-L(T,I);var V=12*(T.year()-I.year())+(T.month()-I.month()),S=I.clone().add(V,u),N=T-S<0,X=I.clone().add(V+(N?-1:1),u);return+(-(V+(T-S)/(N?S-X:X-S))||0)},a:function(L){return L<0?Math.ceil(L)||0:Math.floor(L)},p:function(L){return{M:u,y:m,w:d,d:c,D:v,h:l,m:a,s:r,ms:o,Q:f}[L]||String(L||"").toLowerCase().replace(/s$/,"")},u:function(L){return L===void 0}},Y="en",te={};te[Y]=F;var ee=function(L){return L instanceof xe},M=function L(I,T,V){var S;if(!I)return Y;if(typeof I=="string"){var N=I.toLowerCase();te[N]&&(S=N),T&&(te[N]=T,S=N);var X=I.split("-");if(!S&&X.length>1)return L(X[0])}else{var ce=I.name;te[ce]=I,S=ce}return!V&&S&&(Y=S),S||!V&&Y},Q=function(L,I){if(ee(L))return L.clone();var T=typeof I=="object"?I:{};return T.date=L,T.args=arguments,new xe(T)},q=J;q.l=M,q.i=ee,q.w=function(L,I){return Q(L,{locale:I.$L,utc:I.$u,x:I.$x,$offset:I.$offset})};var xe=function(){function L(T){this.$L=M(T.locale,null,!0),this.parse(T)}var I=L.prototype;return I.parse=function(T){this.$d=function(V){var S=V.date,N=V.utc;if(S===null)return new Date(NaN);if(q.u(S))return new Date;if(S instanceof Date)return new Date(S);if(typeof S=="string"&&!/Z$/i.test(S)){var X=S.match(A);if(X){var ce=X[2]-1||0,be=(X[7]||"0").substring(0,3);return N?new Date(Date.UTC(X[1],ce,X[3]||1,X[4]||0,X[5]||0,X[6]||0,be)):new Date(X[1],ce,X[3]||1,X[4]||0,X[5]||0,X[6]||0,be)}}return new Date(S)}(T),this.$x=T.x||{},this.init()},I.init=function(){var T=this.$d;this.$y=T.getFullYear(),this.$M=T.getMonth(),this.$D=T.getDate(),this.$W=T.getDay(),this.$H=T.getHours(),this.$m=T.getMinutes(),this.$s=T.getSeconds(),this.$ms=T.getMilliseconds()},I.$utils=function(){return q},I.isValid=function(){return this.$d.toString()!==b},I.isSame=function(T,V){var S=Q(T);return this.startOf(V)<=S&&S<=this.endOf(V)},I.isAfter=function(T,V){return Q(T)<this.startOf(V)},I.isBefore=function(T,V){return this.endOf(V)<Q(T)},I.$g=function(T,V,S){return q.u(T)?this[V]:this.set(S,T)},I.unix=function(){return Math.floor(this.valueOf()/1e3)},I.valueOf=function(){return this.$d.getTime()},I.startOf=function(T,V){var S=this,N=!!q.u(V)||V,X=q.p(T),ce=function(W,ne){var ve=q.w(S.$u?Date.UTC(S.$y,ne,W):new Date(S.$y,ne,W),S);return N?ve:ve.endOf(c)},be=function(W,ne){return q.w(S.toDate()[W].apply(S.toDate("s"),(N?[0,0,0,0]:[23,59,59,999]).slice(ne)),S)},le=this.$W,Ae=this.$M,rt=this.$D,x="set"+(this.$u?"UTC":"");switch(X){case m:return N?ce(1,0):ce(31,11);case u:return N?ce(1,Ae):ce(0,Ae+1);case d:var B=this.$locale().weekStart||0,R=(le<B?le+7:le)-B;return ce(N?rt-R:rt+(6-R),Ae);case c:case v:return be(x+"Hours",0);case l:return be(x+"Minutes",1);case a:return be(x+"Seconds",2);case r:return be(x+"Milliseconds",3);default:return this.clone()}},I.endOf=function(T){return this.startOf(T,!1)},I.$set=function(T,V){var S,N=q.p(T),X="set"+(this.$u?"UTC":""),ce=(S={},S[c]=X+"Date",S[v]=X+"Date",S[u]=X+"Month",S[m]=X+"FullYear",S[l]=X+"Hours",S[a]=X+"Minutes",S[r]=X+"Seconds",S[o]=X+"Milliseconds",S)[N],be=N===c?this.$D+(V-this.$W):V;if(N===u||N===m){var le=this.clone().set(v,1);le.$d[ce](be),le.init(),this.$d=le.set(v,Math.min(this.$D,le.daysInMonth())).$d}else ce&&this.$d[ce](be);return this.init(),this},I.set=function(T,V){return this.clone().$set(T,V)},I.get=function(T){return this[q.p(T)]()},I.add=function(T,V){var S,N=this;T=Number(T);var X=q.p(V),ce=function(Ae){var rt=Q(N);return q.w(rt.date(rt.date()+Math.round(Ae*T)),N)};if(X===u)return this.set(u,this.$M+T);if(X===m)return this.set(m,this.$y+T);if(X===c)return ce(1);if(X===d)return ce(7);var be=(S={},S[a]=i,S[l]=s,S[r]=n,S)[X]||1,le=this.$d.getTime()+T*be;return q.w(le,this)},I.subtract=function(T,V){return this.add(-1*T,V)},I.format=function(T){var V=this,S=this.$locale();if(!this.isValid())return S.invalidDate||b;var N=T||"YYYY-MM-DDTHH:mm:ssZ",X=q.z(this),ce=this.$H,be=this.$m,le=this.$M,Ae=S.weekdays,rt=S.months,x=function(ne,ve,re,h){return ne&&(ne[ve]||ne(V,N))||re[ve].slice(0,h)},B=function(ne){return q.s(ce%12||12,ne,"0")},R=S.meridiem||function(ne,ve,re){var h=ne<12?"AM":"PM";return re?h.toLowerCase():h},W={YY:String(this.$y).slice(-2),YYYY:this.$y,M:le+1,MM:q.s(le+1,2,"0"),MMM:x(S.monthsShort,le,rt,3),MMMM:x(rt,le),D:this.$D,DD:q.s(this.$D,2,"0"),d:String(this.$W),dd:x(S.weekdaysMin,this.$W,Ae,2),ddd:x(S.weekdaysShort,this.$W,Ae,3),dddd:Ae[this.$W],H:String(ce),HH:q.s(ce,2,"0"),h:B(1),hh:B(2),a:R(ce,be,!0),A:R(ce,be,!1),m:String(be),mm:q.s(be,2,"0"),s:String(this.$s),ss:q.s(this.$s,2,"0"),SSS:q.s(this.$ms,3,"0"),Z:X};return N.replace(_,function(ne,ve){return ve||W[ne]||X.replace(":","")})},I.utcOffset=function(){return 15*-Math.round(this.$d.getTimezoneOffset()/15)},I.diff=function(T,V,S){var N,X=q.p(V),ce=Q(T),be=(ce.utcOffset()-this.utcOffset())*i,le=this-ce,Ae=q.m(this,ce);return Ae=(N={},N[m]=Ae/12,N[u]=Ae,N[f]=Ae/3,N[d]=(le-be)/6048e5,N[c]=(le-be)/864e5,N[l]=le/s,N[a]=le/i,N[r]=le/n,N)[X]||le,S?Ae:q.a(Ae)},I.daysInMonth=function(){return this.endOf(u).$D},I.$locale=function(){return te[this.$L]},I.locale=function(T,V){if(!T)return this.$L;var S=this.clone(),N=M(T,V,!0);return N&&(S.$L=N),S},I.clone=function(){return q.w(this.$d,this)},I.toDate=function(){return new Date(this.valueOf())},I.toJSON=function(){return this.isValid()?this.toISOString():null},I.toISOString=function(){return this.$d.toISOString()},I.toString=function(){return this.$d.toUTCString()},L}(),z=xe.prototype;return Q.prototype=z,[["$ms",o],["$s",r],["$m",a],["$H",l],["$W",c],["$M",u],["$y",m],["$D",v]].forEach(function(L){z[L[1]]=function(I){return this.$g(I,L[0],L[1])}}),Q.extend=function(L,I){return L.$i||(L(I,xe,Q),L.$i=!0),Q},Q.locale=M,Q.isDayjs=ee,Q.unix=function(L){return Q(1e3*L)},Q.en=te[Y],Q.Ls=te,Q.p={},Q})})(Td);const Sd=Td.exports;var Id={exports:{}};(function(t,e){(function(n,i){t.exports=i()})(Br,function(){return function(n,i,s){n=n||{};var o=i.prototype,r={future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"};function a(c,d,u,f){return o.fromToBase(c,d,u,f)}s.en.relativeTime=r,o.fromToBase=function(c,d,u,f,m){for(var v,b,A,_=u.$locale().relativeTime||r,F=n.thresholds||[{l:"s",r:44,d:"second"},{l:"m",r:89},{l:"mm",r:44,d:"minute"},{l:"h",r:89},{l:"hh",r:21,d:"hour"},{l:"d",r:35},{l:"dd",r:25,d:"day"},{l:"M",r:45},{l:"MM",r:10,d:"month"},{l:"y",r:17},{l:"yy",d:"year"}],D=F.length,J=0;J<D;J+=1){var Y=F[J];Y.d&&(v=f?s(c).diff(u,Y.d,!0):u.diff(c,Y.d,!0));var te=(n.rounding||Math.round)(Math.abs(v));if(A=v>0,te<=Y.r||!Y.r){te<=1&&J>0&&(Y=F[J-1]);var ee=_[Y.l];m&&(te=m(""+te)),b=typeof ee=="string"?ee.replace("%d",te):ee(te,d,Y.l,A);break}}if(d)return b;var M=A?_.future:_.past;return typeof M=="function"?M(b):M.replace("%s",b)},o.to=function(c,d){return a(c,d,this,!0)},o.from=function(c,d){return a(c,d,this)};var l=function(c){return c.$u?s.utc():s()};o.toNow=function(c){return this.to(l(this),c)},o.fromNow=function(c){return this.from(l(this),c)}}})})(Id);const cv=Id.exports;var _d={exports:{}};(function(t,e){(function(n,i){t.exports=i()})(Br,function(){var n="minute",i=/[+-]\d\d(?::?\d\d)?/g,s=/([+-]|\d\d)/g;return function(o,r,a){var l=r.prototype;a.utc=function(b){var A={date:b,utc:!0,args:arguments};return new r(A)},l.utc=function(b){var A=a(this.toDate(),{locale:this.$L,utc:!0});return b?A.add(this.utcOffset(),n):A},l.local=function(){return a(this.toDate(),{locale:this.$L,utc:!1})};var c=l.parse;l.parse=function(b){b.utc&&(this.$u=!0),this.$utils().u(b.$offset)||(this.$offset=b.$offset),c.call(this,b)};var d=l.init;l.init=function(){if(this.$u){var b=this.$d;this.$y=b.getUTCFullYear(),this.$M=b.getUTCMonth(),this.$D=b.getUTCDate(),this.$W=b.getUTCDay(),this.$H=b.getUTCHours(),this.$m=b.getUTCMinutes(),this.$s=b.getUTCSeconds(),this.$ms=b.getUTCMilliseconds()}else d.call(this)};var u=l.utcOffset;l.utcOffset=function(b,A){var _=this.$utils().u;if(_(b))return this.$u?0:_(this.$offset)?u.call(this):this.$offset;if(typeof b=="string"&&(b=function(Y){Y===void 0&&(Y="");var te=Y.match(i);if(!te)return null;var ee=(""+te[0]).match(s)||["-",0,0],M=ee[0],Q=60*+ee[1]+ +ee[2];return Q===0?0:M==="+"?Q:-Q}(b),b===null))return this;var F=Math.abs(b)<=16?60*b:b,D=this;if(A)return D.$offset=F,D.$u=b===0,D;if(b!==0){var J=this.$u?this.toDate().getTimezoneOffset():-1*this.utcOffset();(D=this.local().add(F+J,n)).$offset=F,D.$x.$localOffset=J}else D=this.utc();return D};var f=l.format;l.format=function(b){var A=b||(this.$u?"YYYY-MM-DDTHH:mm:ss[Z]":"");return f.call(this,A)},l.valueOf=function(){var b=this.$utils().u(this.$offset)?0:this.$offset+(this.$x.$localOffset||this.$d.getTimezoneOffset());return this.$d.valueOf()-6e4*b},l.isUTC=function(){return!!this.$u},l.toISOString=function(){return this.toDate().toISOString()},l.toString=function(){return this.toDate().toUTCString()};var m=l.toDate;l.toDate=function(b){return b==="s"&&this.$offset?a(this.format("YYYY-MM-DD HH:mm:ss:SSS")).toDate():m.call(this)};var v=l.diff;l.diff=function(b,A,_){if(b&&this.$u===b.$u)return v.call(this,b,A,_);var F=this.local(),D=a(b).local();return v.call(F,D,A,_)}}})})(_d);const dv=_d.exports;Sd.extend(cv);Sd.extend(dv);const uv=t=>{const e=["B","KB","MB","GB","TB","PB","EB","ZB","YB"];let n=0;if(t<=1024)return`${t}B`;for(;t>=1024&&n<e.length-1;)t/=1024,n++;return`${t.toFixed(2)} ${e[n]}`},hv={class:"addon"},fv={class:"top"},pv={class:"badges"},gv={key:0,class:"badge"},mv={class:"description truncate"},bv={class:"bottom"},vv={class:"right"},yv={class:"top"},xv={class:"quick-actions"},wv={class:"controls"},$v=["disabled"],Cv=["disabled"],kv=["disabled"],Tv=["disabled"],Sv=un({__name:"Addon",props:{addon:null},setup(t){const e=t;Ar().register(fd());const n=Xs(),i=`https://github.com/${Ym}/${Qm}/tree/main/${Jm}/${e.addon.name}`,s=Me(()=>e.addon.description??"No description"),o=Me(()=>e.addon.size?uv(e.addon.size):"? B"),r=Me(()=>{var v;return(v=e.addon.enabled)==null?void 0:v.some(b=>b===!1)}),a=Me(()=>{var v;return(v=e.addon.enabled)==null?void 0:v.some(b=>b===!0)}),l=()=>{const v=n.getAddon(e.addon.name);if(!v){console.warn(`Could not lock "${e.addon.name}" addon during operation`);return}v.processing=!0},c=()=>{xt.postMessage("open",{name:e.addon.name})},d=()=>{l(),xt.postMessage("update",{name:e.addon.name})},u=()=>{l(),xt.postMessage("enable",{name:e.addon.name})},f=()=>{l(),xt.postMessage("disable",{name:e.addon.name})},m=()=>{l(),xt.postMessage("uninstall",{name:e.addon.name})};return(v,b)=>(Ne(),Ue("div",hv,[fe("div",null,[fe("div",fv,[fe("h1",null,Dt(t.addon.displayName??t.addon.name),1),fe("span",pv,[t.addon.hasPlugin?(Ne(),Ue("span",gv,[ke(Nt,{icon:"plug"}),xs("Has Plugin")])):tn("",!0)])]),fe("p",mv,Dt($e(s)),1),fe("div",bv,Dt($e(o)),1)]),fe("div",vv,[fe("div",yv,[fe("div",xv,[fe("button",{onClick:c},[ke(Nt,{icon:"folder"})]),fe("a",{href:i,target:"_blank",rel:"nofollow noreferrer noopener external",title:"View on GitHub",class:"github-link"},[ke(Nt,{icon:"github"})])])]),fe("div",wv,[t.addon.hasUpdate?(Ne(),Ue("vscode-button",{key:0,onClick:d,disabled:t.addon.processing}," Update ",8,$v)):tn("",!0),$e(r)?(Ne(),Ue("vscode-button",{key:1,onClick:u,disabled:t.addon.processing}," Enable ",8,Cv)):tn("",!0),$e(a)?(Ne(),Ue("vscode-button",{key:2,onClick:f,appearance:"secondary",disabled:t.addon.processing}," Disable ",8,kv)):tn("",!0),t.addon.installed?(Ne(),Ue("vscode-button",{key:3,appearance:"secondary",onClick:m,disabled:t.addon.processing}," Uninstall ",8,Tv)):tn("",!0)])])]))}});const Iv=t=>(Du("data-v-75aa3714"),t=t(),Pu(),t),_v={id:"browse"},Ev={class:"controls"},Ov=["disabled"],Av={key:0},Rv=Iv(()=>fe("h2",{class:"text-center"},"Nothing to show 🕳️",-1)),Dv=[Rv],Pv={key:2},Mv={id:"addon-list-count"},Bv=un({__name:"Addons",setup(t){Ar().register(Om(),Vm(),am());const e=Xs(),n=Me(()=>e.sortedByName.filter(d=>{if(i.value.installed&&!d.installed||i.value.enabled&&!(d.enabled??[]).some(u=>u))return!1;if(i.value.regex){const u=new RegExp(`.*${i.value.regex.split("").join(".*")}.*`,"gi");if(!u.test(d.displayName??d.name)&&!u.test(d.name))return!1}return!0})),i=Di({enabled:!1,installed:!1,regex:""}),s=(l,c)=>{r.value=!1,i.value[c]=l.target.checked},o=()=>{e.loading||(e.addons=[],e.refresh())},r=Di(!1),a=l=>{r.value=!0;let d=l.target.value;i.value.regex=d.trim()};return ur(()=>e.getPage()),(l,c)=>(Ne(),Ue("div",_v,[fe("div",Ev,[fe("vscode-text-field",{type:"search",name:"search",autofocus:"true",id:"search",placeholder:"Search",onInput:a},[ke(Nt,{slot:"start",icon:"search"})],32),fe("vscode-checkbox",{onChange:c[0]||(c[0]=d=>s(d,"enabled"))}," Enabled ",32),fe("vscode-checkbox",{onChange:c[1]||(c[1]=d=>s(d,"installed"))},"Installed",32),fe("button",{class:"refresh",disabled:$e(e).loading,onClick:o},[ke(Nt,{icon:"refresh"})],8,Ov)]),$e(n).length===0?(Ne(),Ue("div",Av,Dv)):(Ne(),Ue("div",{key:1,class:Wi(["addons",r.value?"noAnimate":""])},[ke(of,{name:"fade"},{default:Gl(()=>[(Ne(!0),Ue(ht,null,nh($e(n),(d,u)=>(Ne(),hc(Sv,{key:d.name,addon:d,style:_s(`--duration: ${($e(n).length-u)/$e(n).length/3}s
          ;--reverse-duration: ${(u+1)/$e(n).length/3}s`)},null,8,["addon","style"]))),128))]),_:1})],2)),$e(e).loading?(Ne(),Ue("vscode-progress-ring",Pv)):tn("",!0),fe("div",Mv,Dt($e(n).length)+" / "+Dt($e(e).addons.length)+" / "+Dt($e(e).total),1)]))}});const Fv=(t,e)=>{const n=t.__vccOpts||t;for(const[i,s]of e)n[i]=s;return n},Lv=Fv(Bv,[["__scopeId","data-v-75aa3714"]]),Hv=un({__name:"HomeView",setup(t){return(e,n)=>(Ne(),Ue("main",null,[ke(Lv)]))}}),Nv=av({history:Cb(),routes:[{path:"/",name:"home",component:Hv}]});const Vv=t=>{const e=si();console.log(t.data),e.workspaceOpen=t.data},gl=t=>{const e=Xs(),{property:n,value:i}=t.data;e[n]=i},jv=t=>{const e=si(),n=t.data.property,i=t.data.value;switch(n){case"workspaceState":e.workspaceOpen=i;break;case"clientVersion":e.clientVersion=i;break;default:console.warn(`Unsupported appStore property "${n}"`);break}},zv=t=>{const e=Xs(),n=Array.isArray(t.data.addons)?t.data.addons:[t.data.addons];e.$patch(i=>{for(const s of n){const o=i.addons.findIndex(r=>r.name===s.name);o>-1?Object.assign(i.addons[o],s):i.addons.push(s)}})},Uv=t=>{si().notifications.push(t.data)},qv={workspaceOpen:Vv,localAddonStore:gl,appStore:jv,addAddon:zv,addonStore:gl,notify:Uv},Fr=hf(sb);Fr.use(gf());Fr.use(Nv);Fr.mount("#app");window.addEventListener("message",t=>{const e=t.data,n=e.command;if(!n){console.error("Command field not found in message");return}const i=qv[n];if(!i){console.error(`"${n}" could not be found!`);return}i(e)});const Is=si(),ml=xt.getState();ml&&(Is.$state=ml.appStore,Is.notifications=[]);const Wv=()=>{const t={appStore:Is.$state};xt.setState(t)};Is.$subscribe(()=>Wv());
